...
const App = (() => {
  ...
  function _updateTimer() {
    ...
    setUrgentMode(urgent && S.turnPid === S.myId);
...
;(function(){ window.BUILD_VERSION='0.3.838-beta'; try{ var b=document.getElementById('cf-build'); if(b) b.textContent='\u00b7 build '+window.BUILD_VERSION; }catch(e){} })();
