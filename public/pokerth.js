...
const App = (() => {
  ...
  function _otherPlayerInfoHtml(pid) {
    ...
    if (!isBot(pid) && pid !== S.myId && (S._playerRights[S.myId] || 0) === 3) {
  ...
  window._renderProfileStats = function(){ _renderProfileStats(); }; // pont requis par game/stats.mjs (9f-4)
  ...
  window.send = send; // pont requis par net/petitions.mjs (9f-5)
  ...
  window.addChat = addChat; // pont requis par net/petitions.mjs (9f-5)
...
;(function(){ window.BUILD_VERSION='0.3.841-beta'; try{ var b=document.getElementById('cf-build'); if(b) b.textContent='\u00b7 build '+window.BUILD_VERSION; }catch(e){} })();
