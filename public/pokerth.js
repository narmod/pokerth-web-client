...
const App = (() => {
  ...
  window.renderMyTurnActions = renderMyTurnActions; // pont requis par ui/table-cards.mjs (9g-B3)
...
;(function(){ window.BUILD_VERSION='0.3.853-beta'; try{ var b=document.getElementById('cf-build'); if(b) b.textContent='\u00b7 build '+window.BUILD_VERSION; }catch(e){} })();
