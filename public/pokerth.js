...
function openAdvancedOptions() {
  ...
  sync('adv-chatclearlogin', 'chat_clear_login', true); // vider le chat lobby au login (parité QML 2.1.5)
...
window._chatTranslate = function (btn) {
  ...
  window._gtxTranslate(forTr, tgt).then(function (res) {
    ...
    // meme message. Cle existante (deja traduite en 46 langues).
    try {
      var _now = Date.now();
...
window.maybeShowAuthNotice = maybeShowAuthNotice;
...
const App = (() => {
  ...
  window._defaultNameForMode = _defaultNameForMode; // pont requis par net/msg-lobby.mjs (9g-C3)
  ...
  window.setPot = setPot; // pont requis par net/msg-game-join.mjs (9g-C4)
  ...
  function handleMsg(buf) {
    ...
    switch (type) {
      ...
      case T.Announce: { onAnnounce(sub); break; } // [9g-C3] → net/msg-lobby.mjs

      // Connexion acceptée
      case T.InitAck: { onInitAck(sub); break; } // [9g-C3] → net/msg-lobby.mjs
      ...
      case T.PlayerList: { onPlayerList(sub); break; } // [9g-C3] → net/msg-lobby.mjs

      // Statistiques (nombre de joueurs connectés)
      case T.Statistics: { onStatistics(sub); break; } // [9g-C3] → net/msg-lobby.mjs

      // Profil d'un joueur reçu
      case T.PlayerInfoReply: { onPlayerInfoReply(sub); break; } // [9g-C3] → net/msg-lobby.mjs
      ...
      case T.AvatarRequest: { onAvatarRequest(sub); break; } // [9g-C1] → net/msg-avatars.mjs

      case T.AvatarHeader: { onAvatarHeader(sub); break; } // [9g-C1] → net/msg-avatars.mjs
      case T.AvatarData: { onAvatarData(sub); break; } // [9g-C1] → net/msg-avatars.mjs
      case T.AvatarEnd: { onAvatarEnd(sub); break; } // [9g-C1] → net/msg-avatars.mjs
      case T.UnknownAvatar: { onUnknownAvatar(sub); break; } // [9g-C1] → net/msg-avatars.mjs

      // Nouvelle table dans la liste
      case T.GameListNew: { onGameListNew(sub); break; } // [9g-C3] → net/msg-lobby.mjs

      // Mise à jour d'une table (état)
      case T.GameListUpdate: { onGameListUpdate(sub); break; } // [9g-C3] → net/msg-lobby.mjs

      // Un joueur rejoint / quitte une table
      case T.GameListPlayerJoined: { onGameListPlayerJoined(sub); break; } // [9g-C3] → net/msg-lobby.mjs
      ...
      case T.GameSpectatorJoined: { onGameSpectatorJoined(sub); break; } // [9g-C4] → net/msg-game-join.mjs
      case T.GameSpectatorLeft: { onGameSpectatorLeft(sub); break; } // [9g-C4] → net/msg-game-join.mjs
      ...
      case T.GamePlayerJoined: { onGamePlayerJoined(sub); break; } // [9g-C4] → net/msg-game-join.mjs
      ...
      case T.PlayersTurn: { onPlayersTurn(sub); break; } // [9g-C5b] → game/msg-hand.mjs

      case T.PlayersActionDone: { onPlayersActionDone(sub); break; } // [9g-C5b] → game/msg-hand.mjs
      case T.DealFlop: { onDealFlop(sub); break; } // [9g-C5b] → game/msg-hand.mjs

      case T.DealTurn: { onDealTurn(sub); break; } // [9g-C5b] → game/msg-hand.mjs

      case T.DealRiver: { onDealRiver(sub); break; } // [9g-C5b] → game/msg-hand.mjs

      case T.AllInShowCards: { onAllInShowCards(sub); break; } // [9g-C5b] → game/msg-hand.mjs

      case T.EndOfHandShow: { onEndOfHandShow(sub); break; } // [9g-C5b] → game/msg-hand.mjs

      case T.EndOfHandHide: { onEndOfHandHide(sub); break; } // [9g-C5b] → game/msg-hand.mjs

      case T.GameAdminChanged: { onGameAdminChanged(sub); break; } // [9g-C4] → net/msg-game-join.mjs

      case T.YourActionRejected: { onYourActionRejected(sub); break; } // [9g-C5b] → game/msg-hand.mjs

      case T.AfterHandShowCards: { onAfterHandShowCards(sub); break; } // [9g-C5b] → game/msg-hand.mjs

      case T.EndOfGame: { onEndOfGame(sub); break; } // [9g-C5b] → game/msg-hand.mjs
    }
  }
  ...
  window._tableHasPid = _tableHasPid; // pont requis par net/msg-lobby.mjs (9g-C3)
  ...
  // [9g-C6] getPlayerName déplacé dans public/modules/game/seat-render.mjs
  // (toujours global via window.*).
  ...
  // [9g-C6] isBot / getPlayerInitial / getPlayerTypeBadge déplacé dans public/modules/game/seat-render.mjs
  // (toujours global via window.*).
  ...
  // [9g-C6] renderSeatsImmediate déplacé dans public/modules/game/seat-render.mjs
  // (toujours global via window.*).


  // ── Coalesced public entry point ──
  // [9g-C6] renderSeats (débounce rAF) déplacé dans public/modules/game/seat-render.mjs
  // (toujours global via window.*).
  ...
  window.renderWaitingPanel = renderWaitingPanel; // pont requis par net/msg-lobby.mjs (9g-C3)
  ...
  window.logEliminations = logEliminations; // pont requis par game/msg-hand.mjs (9g-C5b)
...
window.BUILD_VERSION='2.1.8-web.144'; try{ var b=document.getElementById('cf-build'); if(b) b.textContent='\u00b7 build '+window.BUILD_VERSION; }catch(e){} })();
...
;(function lobby3col(){
  ...
  function sync(){
    reparent();   // auto-reparation : le chat/joueurs DOIVENT etre dans la grille (mode docke QML)
    var pp=document.getElementById('players-panel');
    var cp=document.getElementById('lobby-chat-panel');
    var lb=document.querySelector('#s-lobby .lobby-body');
