...
const TABLES = [
  { id: '',             name: "PokerTH default QML table style", key: 'tablePokerthOfficial', fallback: 'PokerTH default QML table style',      swatch: '#1d222b', feltUrl: '/table/pokerth-official-fs/felt.png', preview: '/table/pokerth-official-fs/preview.png', previewPortrait: '/table/pokerth-official-fs/preview_portrait.png', mode: 'fs',   dir: 'pokerth-official-fs', skin: true, puck: 'pokerth', btn: 'glossy' },
  { id: 'casino',       name: "Green Casino", key: 'tableCasino',          fallback: 'Green Casino', swatch: '#1e6b1e', feltUrl: '/table/casino/felt.png', preview: '/table/casino/preview.png', previewPortrait: '/table/casino/preview_portrait.png', mode: 'fs', skin: true, align: 'center', puck: 'casino',  btn: 'casino' },
  // Tapis par defaut du client QML (data/gfx/qml/table/*, AGPL-3.0) — plein ecran.
  { id: 'danuxi', name: "Danuxi Blue QML table style", key: 'tableDanuxi', fallback: "Danuxi Blue", swatch: '#1f3a5c', feltUrl: '/table/danuxi/felt.png', preview: '/table/danuxi/preview.png', previewPortrait: '/table/danuxi/preview_portrait.png', radius: 6.5, mode: 'fs', skin: true, align: 'center', zoom: 1.3 },
  { id: 'mute', name: "Mute QML table style", key: 'tableMute', fallback: "Mute", swatch: '#2a2f38', feltUrl: '/table/mute/felt.png', preview: '/table/mute/preview.png', previewPortrait: '/table/mute/preview_portrait.png', radius: 6.5, mode: 'fs', skin: true, align: 'center' },
  { id: 'mute2', name: "Mute 02 QML table style", key: 'tableMute2', fallback: "Mute 02", swatch: '#1f6aa8', feltUrl: '/table/mute2/felt.png', preview: '/table/mute2/preview.png', previewPortrait: '/table/mute2/preview_portrait.png', radius: 6.5, mode: 'fs', skin: true, align: 'center' },
  { id: 'teal', name: "Teal QML table style", key: 'tableTeal', fallback: "Teal", swatch: '#0e5c5c', feltUrl: '/table/teal/felt.png', preview: '/table/teal/preview.png', previewPortrait: '/table/teal/preview_portrait.png', radius: 6.5, mode: 'fs', skin: true, align: 'center bottom' },
  { id: 'lemming', name: "Lemming TA01-MC QML table style", key: 'tableLemming', fallback: "Lemming", swatch: '#2e6b2e', feltUrl: '/table/lemming/felt.png', preview: '/table/lemming/preview.png', previewPortrait: '/table/lemming/preview_portrait.png', radius: 6.5, mode: 'fs', skin: true, align: 'center bottom' },
  { id: 'matrix', name: "Matrix QML table style", key: 'tableMatrix', fallback: "Matrix", swatch: '#0b2b12', feltUrl: '/table/matrix/felt.png', preview: '/table/matrix/preview.png', previewPortrait: '/table/matrix/preview_portrait.png', mode: 'fs', skin: true, align: 'center', zoom: 1.25 },
  { id: 'star_trek', name: "Star Trek QML table style", key: 'tableStarTrek', fallback: "Star Trek", swatch: '#101826', feltUrl: '/table/star_trek/felt.png', preview: '/table/star_trek/preview.png', previewPortrait: '/table/star_trek/preview_portrait.png', radius: 21.5, mode: 'fs', skin: true, align: 'center', zoom: 1.3 },
  { id: 'tripsixes', name: "TripSixes QML table style", key: 'tableTripSixes', fallback: "TripSixes", swatch: '#5a1010', feltUrl: '/table/tripsixes/felt.png', preview: '/table/tripsixes/preview.png', previewPortrait: '/table/tripsixes/preview_portrait.png', radius: 6.5, mode: 'fs', skin: true, align: 'center' },
  { id: 'wanted', name: "Wanted QML table style", key: 'tableWanted', fallback: "Wanted", swatch: '#6b4a1e', feltUrl: '/table/wanted/felt.png', preview: '/table/wanted/preview.png', previewPortrait: '/table/wanted/preview_portrait.png', radius: 6.5, mode: 'fs', skin: true, align: 'center' },
  { id: 'xanax', name: "Xanax 03 QML table style", key: 'tableXanax', fallback: "Xanax", swatch: '#394150', feltUrl: '/table/xanax/felt.png', preview: '/table/xanax/preview.png', previewPortrait: '/table/xanax/preview_portrait.png', radius: 6.5, mode: 'fs', skin: true, align: 'center' },
  { id: 'saloon', name: "Saloon QML table style", key: 'tableSaloon', fallback: "Saloon", swatch: '#c07f30', feltUrl: '/table/saloon/felt.png', preview: '/table/saloon/preview.png', previewPortrait: '/table/saloon/preview_portrait.png', radius: 7, mode: 'fs', skin: true, align: 'center' },
  { id: 'discworld', name: "Discworld QML table style", key: 'tableDiscworld', fallback: "Discworld", swatch: '#c98d49', feltUrl: '/table/discworld/felt.png', preview: '/table/discworld/preview.png', previewPortrait: '/table/discworld/preview_portrait.png', radius: 7, mode: 'fs', skin: true, align: 'center', zoom: 1.3 },
  // 2.1.5 : trois packs de plus. previewPortrait = PreviewPortrait du XML amont,
  // utilise quand l'ecran est en portrait (voir _tablePreview). Depuis 2.1.8-web.5
  // les 21 tapis integres ont les deux previews regenerees upstream (eee31d4).
...
var CASINO_BTN = { images:{ fold:'url(/themes/casino-vert/btn-fold.svg)', check:'url(/themes/casino-vert/btn-check.svg)', call:'url(/themes/casino-vert/btn-call.svg)', raise:'url(/themes/casino-vert/btn-raise.svg)', allin:'url(/themes/casino-vert/btn-allin.svg)' }, colors:{ 'btn-fold-fg':'#ffd0d0','btn-check-fg':'#c0ffc0','btn-call-fg':'#c0d8ff','btn-raise-fg':'#110900','btn-allin-fg':'var(--allin-hollow-fg)','btn-allin-fg-b':'var(--allin-hollow-fg-b)' } };
...
table.apply = function(id){
  ...
  try {
    ...
    if (tb) {
      ...
      // dans le pack, sinon les coins baillent. C'etait deja fait pour les
      // tapis importes (branche galerie plus bas) ; les tapis integres, eux,
      // restaient a 9 quel que soit leur XML amont.
      try{ if(tb.radius!=null && tb.radius!==9) document.documentElement.style.setProperty('--act-btn-radius', tb.radius+'px'); }catch(e){}
