  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Idioma',
          b: ['La interfície està disponible en 55 idiomes. Canvia\u2019l quan vulguis a les Opcions avançades (menú de l\u2019engranatge), categoria Interfície d\u2019usuari. Els termes d\u2019acció del pòquer (Fold, Check, Call, Bet, Raise, All-In) es mantenen en anglès per convenció, igual que al client d\u2019escriptori.'] },
