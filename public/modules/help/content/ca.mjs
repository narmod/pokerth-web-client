  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Idioma',
          b: ['La interfície està disponible en 46 idiomes. Canvia\u2019l quan vulguis a les Opcions avançades (menú de l\u2019engranatge), categoria Interfície d\u2019usuari. Els termes d\u2019acció del pòquer (Fold, Check, Call, Bet, Raise, All-In) es mantenen en anglès per convenció, igual que al client d\u2019escriptori.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'cfgxml', t: 'Intercanviar paràmetres amb el client d\u2019escriptori',
          b: ['Els teus paràmetres poden viatjar entre clients: la categoria Missatges de registre ofereix exportació/importació del fitxer oficial config.xml (aquell \u007e/.pokerth/config.xml que fan servir els clients d\u2019escriptori i QML). L\u2019exportació escriu els paràmetres compartits — nom, opcions de visualització, sons, preferències de taula, cegues, estils — i la importació aplica aquí un fitxer de l\u2019escriptori. Els paràmetres que aquest client no coneix es conserven intactes al fitxer.', 'Les teves notes de jugador també viatgen amb el fitxer: el text i la valoració amb estrelles, escrits tal com els llegeixen els clients d\u2019escriptori. Les etiquetes de color es queden en aquest client: el format oficial no hi té cap camp, així que una importació no les toca mai.'] },
