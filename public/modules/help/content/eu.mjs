  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: "language",
          t: "Hizkuntza",
          b: [
            "Interfazea 79 hizkuntzatan dago eskuragarri. Alda ezazu noiznahi Aukera aurreratuetan (engranaje-menua), Erabiltzaile-interfazea atalean. Pokerreko jokaldien terminoak (Fold, Check, Call, Bet, Raise, All-In) ingelesez geratzen dira ohituraz, mahaigaineko bezeroan bezala."] },
        { id: "pwa",
