// ── help/content/ms.mjs — Malay help corpus ─────────────────────────────────
//
  ...
  chapters: [
    {
      ...
      sections: [
        { id: 'modes', t: 'Tiga cara bermain',
          b: ['Dari skrin masuk, pilih cara Anda ingin bermain.'],
          list: [
        ...
        { id: 'platforms', t: 'Platform dan peskrin',
          ...
          list: [
            ...
            'Safari / iOS: instalasi lewat Bagikan \u2192 Tambah ke Skrin Utama; tanpa getaran; skrin penuh terbatas di iPhone; suara mulai setelah ketukan pertama Anda.',
            'Android: dukungan penuh di peskrin Chromium, termasuk getaran dan perilaku tombol Kembali.'] },
        { id: 'avatar', t: 'Nama panggilan dan avatar',
          b: ['Pilih nama panggilan dan avatar Anda di skrin masuk sebelum menyambungkan. Di pokerth.net, nama panggilan Anda adalah nama akun Anda; avatar dibagikan dengan pemain lain lewat server avatar.', 'Avatar Anda dikirim saat Anda terhubung, dan semua pemain melihat avatar yang sama. Jika Anda menggantinya saat terhubung, avatar baru berlaku mulai koneksi berikutnya. Huruf awal (Aa) tidak dikirim: pemain lain melihat avatar bawaan.'] }
      ]
    },
    {
      ...
      sections: [
        ...
        { id: 'actions', t: 'Yang boleh Anda lakukan pada giliran Anda',
          list: [
        ...
        { id: 'showdown', t: 'Showdown dan pot terbagi',
          b: ['Jika lebih dari satu pemain tersisa setelah ronde taruhan river, kartu dibuka dan tangan terbaik menang \u2014 kombinasi pemenang ditampilkan di bawah kartu komunitas. Saat seorang pemain all-in kurang dari taruhan penuh, side pot dibuat: setiap pemain hanya dapat memenangkan bagian pot yang ia kontribusikan. Tangan yang setara membagi pot.',
            'Tidak semua orang harus membuka: mulai dari pemain terakhir yang bet atau raise, sebuah tangan hanya diperlihatkan jika mengalahkan yang sudah terbuka. Siapa pun yang berhak membuang kartunya boleh tetap menyembunyikannya dan mendapat tombol Show untuk memperlihatkannya jika mau.'] },
    ...
    {
      id: 'game', icon: '\uD83C\uDFAE', title: 'Skrin permainan',
      sections: [
        ...
        { id: 'zoom', t: 'Zoom meja (ponsel)',
          b: ['Di skrin kecil, tombol pembesar memperbesar meja (2\u00d7) dan Anda dapat menggeser dengan jari \u2014 hanya bilah aksi yang tetap diam; kotak Anda sendiri ikut diperbesar dan tampilan kembali ke sana saat giliran Anda. Tampilan mengikuti kursi aktif secara otomatis dan memperkecil kembali saat showdown untuk tampilan menyeluruh. Ini boleh dimatikan di Opsi lanjutan. Saat giliran Anda, jika kartu komunitas berada di luar tampilan, salinan kecilnya muncul di bagian atas meja; ketuk untuk melompat ke kartu dan kembali.'],
          note: 'Di ponsel dan tablet, zoom cubit bawaan peskrin diblokir secara bawaan agar gestur zoom tidak pernah terjadi tanpa sengaja di tengah tangan; aktifkan kembali di Opsi lanjutan \u2192 Antarmuka pengguna jika Anda mau.' },
        { id: 'protections', t: 'Anti-intip dan perlindungan call tak sengaja',
          b: ['Dua perlindungan opsional: Anti-intip menjaga kartu Anda tetap tersembunyi sampai Anda mengetuknya (berguna saat seseorang boleh melihat skrin Anda), dan penjaga call tak sengaja memblokir sebentar tombol Call tepat setelah raise besar, sehingga ketukan yang ditujukan untuk call kecil tidak dapat mengenai jumlah yang dinaikkan secara tidak sengaja. Keduanya ada di Opsi lanjutan.'] }
      ]
    },
    {
      ...
      sections: [
        ...
        { id: 'journal', t: 'Log tangan dan jendela Log',
          b: ['Di luar log langsung, setiap tangan yang Anda mainkan direkam secara lokal di peskrin, dalam format yang sama dengan berkas log .pdb klien resmi. Jendela Log (Opsi lanjutan \u2192 Mesej log \u2192 Kelola log\u2026) mencantumkan sesi Anda dan memungkinkan Anda mengelolanya: pratinjau sesi dengan pencarian dan penyorotan, filter per permainan, ekspor sebagai HTML atau teks polos, simpan berkas .pdb mentah, atau impor .pdb yang direkam klien desktop. Sesi dapat dipadam satu per satu atau sekaligus (dengan konfirmasi), dan tetapan retensi otomatis dapat menyimpan hanya 7, 30, 90, 180, atau 365 hari terakhir. Log yang Anda impor sendiri tidak pernah dipadam otomatis. Tetapan kedua membatasi jumlah sesi yang disimpan, dan kolom daftar dapat diseret lebih lebar.',
              'Untuk membersihkan beberapa sesi sekaligus, tombol Pilih… menampilkan kotak centang pada setiap entri: centang yang tidak diperlukan lalu Padam mengpadam seluruh kelompok setelah satu konfirmasi. Di komputer, Ctrl (⌘) + klik menambahkan sesi satu per satu dan Shift + klik mengambil seluruh rentang.',
        ...
        { id: 'logopts', t: 'Opsi pencatatan',
          b: ['Di Opsi lanjutan \u2192 Mesej log Anda dapat mengaktifkan atau mematikan pencatatan dan memilih interval penulisan, dengan tiga tetapan yang sama seperti klien desktop: setelah setiap aksi, setelah setiap tangan (bawaan), atau setelah setiap permainan. Opsi lain menulis berkas .pdb ke folder pilihan Anda dan menjaganya tetap mutakhir pada interval itu, dan sekali lagi saat Anda meninggalkan halaman, sehingga alat lain dapat mengikuti permainan secara langsung.'],
          note: 'Menulis ke folder lokal memerlukan File System Access API: hanya Chrome, Edge, dan Opera desktop. Di tempat lain, opsi ini menjelaskan dirinya sendiri dan ekspor manual dari jendela Log tetap tersedia. Peskrin hanya boleh mengganti berkas, tidak pernah menambahkan; jadi alat yang membaca .pdb harus membukanya kembali setelah setiap perubahan.' },
        ...
        { id: 'hud', t: 'HUD statistik di kursi',
          b: ['HUD menempelkan kotak statistik kecil di sebelah kursi setiap pemain, dibangun dari tangan-tangan yang Anda rekam di log Anda: jumlah tangan yang diamati, lalu VPIP (seberapa sering mereka memasukkan uang secara sukarela pre-flop), PFR (raise pre-flop), dan AF (faktor agresi), diberi kode warna dari pasif hingga agresif. Di bawahnya, sebuah lencana merangkum pemain dengan kata-kata sederhana \u2014 Ketat-Pasif, Longgar-Agresif, dan seterusnya \u2014 di sebelah cakram kecil yang kuadran menyalanya terbaca kiri-ke-kanan untuk ketat ke longgar, dan bawah-ke-atas untuk pasif ke agresif. Lencana tampil sejak tangan pertama tetapi tetap redup sampai 25 tangan, saat mulai andal. Ketuk sebuah kotak untuk popover terperinci dengan set angka lengkap (3-bet, continuation bet, fold to 3-bet, upaya steal, tingkat showdown\u2026), dan seret kotak untuk memindahkannya jika menutupi sesuatu.',
              'HUD hanya tahu apa yang Anda lihat di meja Anda sendiri \u2014 ia membaca log tangan lokal Anda, jadi pencatatan harus aktif dan angkanya menjadi bermakna setelah cukup banyak tangan. Fitur ini mati secara bawaan: aktifkan di Opsi lanjutan \u2192 Bantuan.'] },
        { id: 'handsbtn', t: 'Ikhtisar kombinasi tangan',
          b: ['Ikon tangan poker di meja membuka ikhtisar cepat 10 kombinasi kapan saja \u2014 praktis saat belajar. Boleh disembunyikan di Opsi lanjutan.'] }
      ]
    },
    {
      id: 'chat', icon: '\uD83D\uDCAC', title: 'Sembang & sosial',
      sections: [
        { id: 'panels', t: 'Sembang lobi dan sembang permainan',
          b: ['Ada sembang di lobi dan satu lagi di meja. Di ponsel, sembang permainan mengambang di atas meja; di skrin lebih besar, ia berupa jendela yang dapat diseret dan diubah ukurannya. Lencana pada tombol sembang menghitung mesej yang belum dibaca.'] },
        { id: 'typing', t: 'Bantuan pengetikan',
          list: [
            'Tab melengkapi nama panggilan \u2014 tekan Tab lagi untuk menelusuri kecocokan.',
            '\u2191 / \u2193 menelusuri riwayat mesej Anda sendiri.',
            'Tombol emoji membuka pemilih lengkap; mengetik : juga menyarankan emote saat Anda mengetik.'] },
        { id: 'emotes', t: 'Emote dan smiley',
          b: ['Sembang mengubah kode emote persis seperti klien desktop resmi: ketik sebuah nama di antara titik dua dan ia menjadi emoji \u2014 :sunny: \u2192 \u2600, :+1: \u2192 \uD83D\uDC4D, :joy: \u2192 \uD83D\uDE02, :four_leaf_clover: \u2192 \uD83C\uDF40\u2026 lebih dari 1.900 kode didukung (set GitHub lengkap). Smiley teks klasik juga diubah: :-) ;) :D xD :P <3 dan sekitar delapan puluh lainnya.',
              'Mengetik : membuka popup saran yang melengkapi kode saat Anda mengetik (\u2191/\u2193 untuk memilih, Tab atau Enter untuk menerima). Konversi emoji dapat dinonaktifkan sepenuhnya di Opsi lanjutan \u2192 Sembang.'] },
        { id: 'commands', t: 'Perintah sembang',
          b: ['Sembang memahami perintah garis miring. Dua di antaranya terlihat oleh orang lain:'],
          keys: [
            ['/me <teks>', 'Mesej aksi, ditampilkan sebagai \u201c* namaanda teks\u201d'],
        ...
        { id: 'diagcmds', t: 'Perintah diagnostik',
          ...
          keys: [
            ...
            ['/clear', 'Bersihkan sembang secara lokal'],
        ...
        { id: 'privatemsg', t: 'Mesej peribadi',
          b: ['Tulis kepada seorang pemain sahaja tanpa seluruh lobi membaca sama. Sampul di sebelah nama dalam senarai pemain membuka perbualan dengannya; sampul di kepala lobi membuka semula perbualan terakhir. Perbualan disimpan pada peranti ini dan masih ada apabila anda kembali, jadi perbualan yang disambung beberapa hari kemudian membawa sejarahnya sendiri — bilangan merah pada sampul menunjukkan apa yang belum anda baca, dan tong sampah pada tajuk tetingkap memadam perbualan itu selama-lamanya.'],
          keys: [
            ['/msg <nama panggilan> <teks>', 'Hantar mesej peribadi dari sembang lobi'],
            ['/msg "<nama panggilan dengan ruang>" <teks>', 'Sama, apabila nama panggilan mengandungi ruang']],
          note: 'Mesej terhad kepada 128 aksara. Pelayan tidak menghantar mesej peribadi kepada pemain yang sedang duduk di meja yang berjalan, dan sejarah hanya disimpan dalam pelayar ini — ia tidak mengikuti anda ke peranti lain.' },
        ...
        { id: 'translate', t: 'Memahami semua orang',
          b: ['Dengan terjemahan sembang aktif, tombol terjemahan muncul pada baris di bawah penunjuk Anda \u2014 atau pada baris yang Anda ketuk, di skrin sentuh \u2014 dan menampilkan mesej itu dalam bahasa Anda memakai penerjemah bawaan peskrin. Ia dapat ditampilkan permanen di setiap baris di Opsi lanjutan \u2192 Sembang, tempat tooltip yang menjelaskan singkatan meja umum (gg, nh, utg\u2026) juga berada.'],
          note: 'Terjemahan memakai layanan Google Translate dan berfungsi di setiap peskrin \u2014 hanya perlu koneksi internet. Sebuah mesej hanya dikirim ke layanan terjemahan saat Anda mengetuk tombol terjemahannya, tidak pernah otomatis.' },
        { id: 'social', t: 'Pemain: profil, undang, abaikan',
          b: ['Ketuk pemain mana pun \u2014 di meja atau di daftar lobi \u2014 untuk membuka kartunya: profil dan statistik, undang mereka ke permainan Anda, atau abaikan mereka (mesej sembang mereka disembunyikan; pengabaian dapat dibatalkan kapan saja). Konfirmasi sebelum undang/abaikan dapat diaktifkan di opsi.'] }
      ]
    },
    {
      ...
      sections: [
        { id: 'list', t: 'Daftar permainan',
          b: ['Lobi mencantumkan setiap meja di server. Setiap entri menampilkan jumlah pemain, tipe permainan, gembok saat kata laluan atau undangan diperlukan, dan lencana status: \u201cMenunggu\u201d (hijau \u2014 permainan belum dimulai, Anda boleh bergabung jika ada kursi kosong), \u201cBerlangsung\u201d (warna hangat \u2014 boleh ditonton langsung saat penonton diizinkan) dan \u201cDitutup\u201d (redup). Meja penuh cukup menampilkan hitungan penuh, seperti 10/10; warna lencana mengikuti tema aktif.',
        ...
        { id: 'join', t: 'Bergabung dan menonton',
          b: ['Pilih permainan terbuka dan bergabunglah \u2014 gembok berarti kata laluan diperlukan. Permainan yang sedang berjalan dan mengizinkan penonton dapat ditonton langsung: Anda melihat meja dan sembang, tetapi hole cards tetap tersembunyi dan Anda tidak dapat beraksi.'] },
        ...
        { id: 'create', t: 'Membuat permainan',
          b: ['Buat meja Anda sendiri: nama, jumlah pemain, uang awal, small blind pertama dan jadwal kenaikan, batas waktu aksi, dan apakah penonton diizinkan. Ada empat tipe permainan: Normal (siapa saja), hanya pemain terdaftar, hanya undangan, dan Ranking (dihitung ke peringkat resmi \u2014 tanpa kata laluan di sana). Tetapan favorit Anda dapat disimpan dan dimuat ulang.'] },
        { id: 'invites', t: 'Undangan',
          b: ['Pemain dapat mengundang Anda ke meja mereka; Anda mendapat notifikasi yang boleh diterima atau ditolak. Diundang adalah satu-satunya jalan masuk ke permainan khusus undangan.'] }
      ]
    },
    {
      ...
      sections: [
        ...
        { id: 'rankings', t: 'Halaman peringkat',
          b: ['Entri peringkat membuka peringkat resmi PokerTH, dapat dicari per pemain, bersama peringkat komunitas (BBC, WEC). Jika Anda tidak peduli peringkat, entrinya boleh disembunyikan di Opsi lanjutan \u2192 Komunitas.'] },
        { id: 'cups', t: 'Piala komunitas: BBC dan WeCup',
          b: ['Dua komunitas menjalankan kompetisi mereka sendiri di pokerth.net, masing-masing dengan situs dan peringkatnya sendiri. Best Brainies Cup (BBC) adalah turnamen bertahap yang lahir tahun 2013: Anda naik dari Step 1 ke Step 4, dan musim baru dimulai setelah setiap permainan Step 4, saat piala diberikan. WeCup (WEC) punya skalanya sendiri, jauh lebih terbentang — 75 poin untuk juara pertama, lalu 45, 30, 20… — dan skornya menormalkan rata-rata Anda terhadap jumlah permainan yang Anda mainkan dibandingkan anggota lain.',
              'Kedua peringkat dibuka dari tombol trofi, di sebelah peringkat PokerTH. Tetapan meja kompetisi-kompetisi ini tersedia sebagai preset saat Anda membuat permainan (BBC Step 1 sampai 4, WEC, WEC Monthly Final dan WEC Grand Final), sehingga Anda boleh berlatih dalam kondisi yang sama. Ikut serta memerlukan pendaftaran di situs piala yang bersangkutan.'],
        ...
        { id: 'forumcups', t: 'Piala forum dan acara',
          b: ['Forum pokerth.net juga menjadi tuan rumah Monthly Cup, seri bulanan di mana pemain dibagi ke meja Emas, Perak, dan Perunggu sebelum juara bulan dimahkotai, plus piala khusus sekali jalan sepanjang tahun.',
              'Pendaftaran, jadwal, tetapan meja, dan hasil dipublikasikan di forum, dan permainannya dimainkan di server resmi seperti lainnya. Akun pokerth.net cukup untuk mengikuti hasil; mengikuti piala dilakukan lewat utas forum yang sesuai.'] },
        { id: 'forumnews', t: 'Berita forum di lobi',
          b: ['Tombol koran di kepala lobi membuka postingan terbaru dari forum pokerth.net, satu entri per topik, setiap forum dengan warnanya sendiri. Lencana pada tombol menghitung postingan belum dibaca; membuka postingan (tab baru) menandainya telah dibaca, dan “Tandai semua telah dibaca” membersihkan semuanya sekaligus.',
              'Ini tambahan web: tombolnya boleh disembunyikan di Opsi lanjutan (“Tombol forum di kepala lobi”).',
              'Tab “Acara” memaparkan permainan BBC akan datang dan Monthly Cup seterusnya berserta bilangan pemain yang berdaftar, serta pemenang terkini BBC, WEC dan Monthly Cup. Masa dipaparkan dalam waktu tempatan anda, dan ketikan membuka laman komuniti. Pilihan “Tampilkan konten komunitas (BBC / WEC)” menyembunyikan tab ini.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Pemutar musik',
          b: ['Entri musik di menu kepala halaman membuka pemutar musik lounge kecil: pilih trek dari daftar putar, putar/jeda, sebelumnya/berikutnya, acak, dan ulangi satu trek, seluruh daftar putar, atau tidak sama sekali. Volume, trek terpilih, dan mode ulang diingat. Pemutaran tidak pernah mulai sendiri \u2014 peskrin memerlukan ketukan \u2014 dan pemutar sepenuhnya independen dari efek suara permainan.', 'Dua jempol di bawah judul lagu menyatakan apakah kamu suka yang sedang diputar. Satu suara anonim per perangkat, termasuk radio, dan kamu boleh mengubah atau menariknya kapan saja; selama operator belum menampilkan totalnya, kamu hanya melihat jempolmu sendiri.', "Pada iPhone dan iPad pemain menggunakan main balik ringkas secara lalai supaya muzik terus berjalan dengan CarPlay, Bluetooth atau skrin berkunci; kelantangan kemudian dilaras dengan butang peranti atau kereta. Pilihan “Kelantangan dalam aplikasi” mengembalikan peluncur kelantangan, imbangan dan meter VU, tetapi bunyi mungkin tersekat-sekat di dalam kereta."] },
        { id: 'sounds', t: 'Efek suara',
          b: ['Suara permainan dikelompokkan dalam empat kategori yang dapat diaktifkan terpisah, persis seperti klien desktop: aksi permainan (kartu dibagikan, Check, Call, Raise, giliran Anda\u2026), notifikasi sembang lobi, notifikasi permainan jaringan (pemain bergabung, permainan siap), dan notifikasi kenaikan blind. Satu penggeser volume mengendalikan semuanya, di Opsi lanjutan \u2192 Suara.'],
          note: 'Semua peskrin \u2014 terutama iOS \u2014 menolak memutar audio sebelum Anda menyentuh halaman sekali. Jika permainan mulai tanpa suara, satu ketukan di mana saja menghidupkan suaranya; klien juga memperbaiki mesin audio secara otomatis saat iOS menangguhkannya (panggilan masuk, ke latar belakang\u2026).' },
        { id: 'voice', t: 'Suara dan getaran',
          b: ['Dua saluran tambahan dapat menjaga Anda tetap terinformasi tanpa melihat skrin: pengumuman suara membacakan peristiwa permainan memakai sintesis ucapan perangkat Anda, dan di ponsel getaran singkat dapat menandai giliran Anda. Keduanya adalah tambahan web, mati atau aktif secara bawaan tergantung perangkat, di Opsi lanjutan \u2192 Taruhan & giliran.'],
          note: 'Getaran berfungsi di Android (peskrin Chromium); Apple tidak menyediakan API getaran untuk situs web, jadi iPhone tidak dapat bergetar. Pengumuman suara berfungsi di mana saja, tetapi suara dan bahasa yang tersedia bergantung pada sistem Anda \u2014 klien memakai yang paling cocok yang ditemukannya.' }
      ]
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Di mana opsi berada',
          b: ['Opsi lanjutan dibuka dari entri roda gigi di menu kepala halaman mana pun. Opsi dikelompokkan seperti klien desktop: Antarmuka pengguna, Gaya, Suara, Permainan lokal, Permainan jaringan, Permainan internet, Nama panggilan / Avatar, Mesej log, dan Cadangan & reset. Setiap fitur khusus web punya sakelarnya sendiri di sana, jadi Anda dapat mematikan apa pun yang tidak Anda pakai.'] },
        { id: 'cfgxml', t: 'Bertukar tetapan dengan klien desktop',
          b: ['Tetapan Anda dapat berpindah antar klien: kategori Cadangan & reset menawarkan ekspor/impor berkas config.xml resmi (\u007e/.pokerth/config.xml yang dipakai klien desktop dan QML). Ekspor menulis tetapan bersama \u2014 nama, opsi tampilan, suara, preferensi meja, blind, gaya \u2014 dan impor menerapkan berkas desktop di sini. Tetapan yang tidak dikenal klien ini tetap utuh dalam berkas.', 'Catatan pemainmu ikut berjalan bersama berkas — teksnya dan penilaian bintang, ditulis persis seperti yang dibaca klien desktop. Label warna tetap di klien ini: format resmi tidak punya kolom untuknya, jadi impor tidak pernah menyentuhnya.'] },
        { id: 'sync', t: 'Tetapan yang mengikuti Anda',
        ...
        { id: 'fkeys', t: 'Pintasan keyboard resmi',
          ...
          keys: [
            ...
            ['Alt+C / Alt+L / Alt+I', 'Sembang \u00b7 Log permainan \u00b7 Panel peluang'],
            ['Alt+S', 'Tetapan \u2014 di mana saja dalam aplikasi, tidak hanya selama permainan'],
            ['F11', 'Skrin penuh']],
          note: 'Pintasan memerlukan keyboard fisik. Di Mac, tombol F secara bawaan menjadi kontrol media: tahan Fn (atau aktifkan \u201cUse F1, F2, etc. as standard function keys\u201d di tetapan macOS). Di iPhone, skrin penuh dibatasi iOS \u2014 menginstal aplikasi sebagai PWA memberi pengalaman skrin penuh yang sama.' },
