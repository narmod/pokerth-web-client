    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Di mana opsi berada',
          b: ['Opsi lanjutan dibuka dari entri roda gigi di menu kepala halaman mana pun. Opsi dikelompokkan seperti klien desktop: Antarmuka pengguna, Gaya, Suara, Permainan lokal, Permainan jaringan, Permainan internet, Nama panggilan / Avatar, Mesej log, dan Pulihkan bawaan. Setiap fitur khusus web punya sakelarnya sendiri di sana, jadi Anda dapat mematikan apa pun yang tidak Anda pakai.'] },
        { id: 'cfgxml', t: 'Bertukar tetapan dengan klien desktop',
          b: ['Tetapan Anda dapat berpindah antar klien: kategori Mesej log menawarkan ekspor/impor berkas config.xml resmi (\u007e/.pokerth/config.xml yang dipakai klien desktop dan QML). Ekspor menulis tetapan bersama \u2014 nama, opsi tampilan, suara, preferensi meja, blind, gaya \u2014 dan impor menerapkan berkas desktop di sini. Tetapan yang tidak dikenal klien ini tetap utuh dalam berkas.', 'Catatan pemainmu ikut berjalan bersama berkas — teksnya dan penilaian bintang, ditulis persis seperti yang dibaca klien desktop. Label warna tetap di klien ini: format resmi tidak punya kolom untuknya, jadi impor tidak pernah menyentuhnya.'] },
