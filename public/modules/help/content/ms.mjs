  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Bahasa',
          b: ['Antarmuka tersedia dalam 56 bahasa. Ubah kapan saja di Opsi lanjutan (menu roda gigi) di bawah Antarmuka pengguna. Istilah aksi poker (Fold, Check, Call, Bet, Raise, All-In) tetap dalam bahasa Inggris sesuai konvensi, persis seperti klien desktop.'] },
