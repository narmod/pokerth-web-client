  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Bahasa',
          b: ['Antarmuka tersedia dalam 57 bahasa. Ubah kapan saja di Opsi lanjutan (menu roda gigi) di bawah Antarmuka pengguna. Istilah aksi poker (Fold, Check, Call, Bet, Raise, All-In) tetap dalam bahasa Inggris sesuai konvensi, persis seperti klien desktop.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zoom meja (ponsel)',
          b: ['Di skrin kecil, tombol pembesar memperbesar meja (2\u00d7) dan Anda dapat menggeser dengan jari \u2014 kotak Anda sendiri dan bilah aksi tetap diam. Tampilan mengikuti kursi aktif secara otomatis dan memperkecil kembali saat showdown untuk tampilan menyeluruh. Ini boleh dimatikan di Opsi lanjutan.'],
