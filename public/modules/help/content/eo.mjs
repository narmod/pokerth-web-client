  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: "language",
          t: "Lingvo",
          b: [
            "La interfaco disponeblas en 75 lingvoj. Ŝanĝu ĝin iam ajn en Altnivelaj opcioj (dentrada menuo) sub Uzantinterfaco. La terminoj de pokeraj agoj (Fold, Check, Call, Bet, Raise, All-In) tradicie restas en la angla, ĝuste kiel en la labortabla kliento."] },
        { id: "pwa",
