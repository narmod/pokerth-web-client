  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: "language",
          t: "Èdè",
          b: [
            "Ojú olùlò wà ní èdè 79. Yí i padà nígbàkúùgbà nínú Àṣàyàn ìlọsíwájú (àkójọ gíà) lábẹ́ Ojú olùlò. Àwọn ọ̀rọ̀ ìgbésẹ̀ poker (Fold, Check, Call, Bet, Raise, All-In) máa ń wà ní èdè Gẹ̀ẹ́sì gẹ́gẹ́ bí àṣà, bí ó ti rí nínú oníbàárà kọ̀ǹpútà. Orúkọ àwọn ọwọ́ poker náà wà ní èdè Gẹ̀ẹ́sì."] },
        { id: "pwa",
