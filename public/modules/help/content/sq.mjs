  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Gjuha',
          b: ['Ndërfaqja është e disponueshme në 70 gjuhë. Ndryshoje kur të duash te Opsionet e avancuara (menyja me ingranazh) te Ndërfaqja e përdoruesit. Termat e veprimeve të pokerit (Fold, Check, Call, Bet, Raise, All-In) mbeten në anglisht sipas konventës, saktësisht si te klienti desktop.'] },
