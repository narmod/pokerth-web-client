  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Gjuha',
          b: ['Ndërfaqja është e disponueshme në 76 gjuhë. Ndryshoje kur të duash te Opsionet e avancuara (menyja me ingranazh) te Ndërfaqja e përdoruesit. Termat e veprimeve të pokerit (Fold, Check, Call, Bet, Raise, All-In) mbeten në anglisht sipas konventës, saktësisht si te klienti desktop.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zmadhimi i tavolinës (telefonat)',
          b: ['Në ekranet e vogla, butonat e lupës e zmadhojnë tavolinën (2×) dhe mund të lëvizësh me gisht — vetëm shiriti i veprimeve mbetet fiks; edhe kutia jote zmadhohet dhe pamja kthehet tek ajo kur është radha jote. Pamja ndjek automatikisht vendin aktiv dhe zvogëlohet sërish në showdown për pamjen e përgjithshme. Kjo mund të çaktivizohet te Opsionet e avancuara. Kur është radha jote dhe letrat e përbashkëta janë jashtë pamjes, një kopje e vogël e tyre shfaqet në krye të tavolinës; preke për të kaluar te letrat dhe mbrapsht.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Lexuesi i muzikës',
          b: ['Hyrja e muzikës te menytë e kokës hap një lexues të vogël muzike lounge: zgjidh një pjesë nga lista, luaj/pauzo, e mëparshmja/tjetra, rastësisht, dhe përsërit një pjesë të vetme, gjithë listën, ose asgjë. Volumi, pjesa e zgjedhur dhe modaliteti i përsëritjes mbahen mend. Luajtja kurrë nuk fillon vetë — shfletuesit kërkojnë një prekje — dhe lexuesi është plotësisht i pavarur nga efektet e zërit të lojës.', 'Dy gishtat e mëdhenj nën titullin e pjesës tregojnë nëse të pëlqen ajo që po luhet. Një votë anonime për pajisje, përfshirë radiot, dhe mund ta ndryshosh ose tërheqësh kurdo; përveç nëse operatori i zbulon totalet, sheh vetëm gishtin tënd.', "Në iPhone dhe iPad luajtësi përdor si parazgjedhje riprodhimin e thjeshtë, që muzika të vazhdojë me CarPlay, Bluetooth ose ekran të kyçur; volumi rregullohet atëherë me butonat e pajisjes ose të makinës. Opsioni “Volumi në aplikacion” rikthen rrëshqitësin e volumit, balancën dhe VU-metrin, por zëri mund të ndërpritet në makinë."] },
