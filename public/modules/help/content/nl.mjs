  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Taal',
          b: ['De interface is beschikbaar in 64 talen. Wijzig hem op elk moment in de Geavanceerde opties (tandwielmenu), categorie Gebruikersinterface. De pokeractietermen (Fold, Check, Call, Bet, Raise, All-In) blijven per conventie Engels, precies zoals in de desktopclient.'] },
