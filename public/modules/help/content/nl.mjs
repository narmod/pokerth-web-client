  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Familieranglijst',
          b: ['Alleen op privéservers en in LAN-spellen houdt de client langetermijnstatistieken per bijnaam bij — gespeelde en gewonnen handen en partijen, grootste winst, beste reeks — en deelt ze via de server, zodat elk apparaat rond de tafel dezelfde ranglijst ziet. pokerth.net-spellen worden nooit op deze manier bijgehouden, en de statistieken van de trainingsmodus blijven volledig gescheiden.', 'In deze spellen opent de trofeeknop het ranglijstvenster op het tabblad LAN: alle spelers, sorteerbaar op meerdere criteria.'] },
        { id: 'language', t: 'Taal',
          b: ['De interface is beschikbaar in 68 talen. Wijzig hem op elk moment in de Geavanceerde opties (tandwielmenu), categorie Gebruikersinterface. De pokeractietermen (Fold, Check, Call, Bet, Raise, All-In) blijven per conventie Engels, precies zoals in de desktopclient.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Tafelzoom (telefoons)',
          b: ['Op kleine schermen zoomen loepknoppen de tafel in (2\u00d7) en kun je met je vinger schuiven — alleen de actiebalk blijft vast; je eigen vak wordt mee vergroot en het beeld keert ernaar terug wanneer je aan de beurt bent. Het beeld volgt automatisch de actieve stoel en zoomt bij de showdown uit voor het overzicht. Uit te schakelen in de Geavanceerde opties. Ben je aan de beurt en vallen de gemeenschappelijke kaarten buiten beeld, dan verschijnt bovenaan de tafel een kleine kopie; tik erop om naar de kaarten en weer terug te gaan.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Handlogboeken en het venster \u201cLogs\u201d',
          b: ['Naast het live logboek wordt elke hand die je speelt lokaal in je browser vastgelegd, in hetzelfde formaat als de .pdb-logbestanden van de officiële client. Het Logs-venster (Geavanceerde opties \u2192 Logmeldingen \u2192 Logs beheren\u2026) toont je sessies en laat je ermee werken: een sessie bekijken met zoeken en markeren, filteren per spel, exporteren als HTML of platte tekst, het rauwe .pdb-bestand opslaan, of een door de desktopclient opgenomen .pdb importeren. Sessies verwijder je één voor één of allemaal tegelijk (met bevestiging), en een automatische bewaartermijn kan alleen de laatste 7, 30, 90, 180 of 365 dagen behouden. Logboeken die je zelf importeert, worden nooit automatisch verwijderd. Een tweede instelling beperkt hoeveel sessies worden bewaard, en de lijstkolom kan breder worden gesleept.',
              'Om meerdere sessies in één keer op te ruimen, zet de knop Selecteren… een vinkvakje bij elk item: vink aan wat weg mag en Verwijderen wist de hele reeks na één bevestiging. Op een computer voegt Ctrl (⌘) + klik sessies één voor één toe en selecteert Shift + klik een heel bereik.',
        ...
        { id: 'hud', t: 'Stats-HUD op de stoelen',
          b: ['De HUD hangt een klein statistiekvakje naast de stoel van elke speler, opgebouwd uit de handen die je in je logboeken hebt vastgelegd: aantal waargenomen handen, daarna VPIP (hoe vaak hij pre-flop vrijwillig geld inzet), PFR (pre-flop verhogingen) en AF (agressiefactor), met een kleurcode van passief naar agressief. Daaronder vat een badge de speler in woorden samen \u2014 Tight-Passief, Loose-Agressief enzovoort \u2014 naast een kleine wijzerplaat waarvan het oplichtende kwadrant van links naar rechts tight tot loose leest, en van onder naar boven passief tot agressief. De badge verschijnt vanaf de allereerste hand maar blijft gedimd tot 25 handen, vanaf waar hij betrouwbaar wordt. Tik op een vakje voor een uitgebreide popover met alle cijfers (3-bet, continuation bet, fold op 3-bet, steelpogingen, showdownpercentages\u2026), en sleep het weg als het iets bedekt.',
              'De HUD kent alleen wat je aan je eigen tafels hebt gezien — hij leest je lokale handlogboeken, dus het loggen moet aanstaan en de cijfers worden pas betekenisvol na genoeg handen. Het staat standaard uit: zet het aan in Geavanceerde opties \u2192 Assistentie.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Muziekspeler',
          b: ['De muziekknop in de headermenu\u2019s opent een kleine loungemuziekspeler: kies een nummer uit de afspeellijst, afspelen/pauzeren, vorige/volgende, willekeurig, en herhaling van één nummer, de hele lijst of niets. Volume, gekozen nummer en herhaalmodus worden onthouden. Het afspelen start nooit vanzelf — browsers vereisen een tik — en de speler staat volledig los van de spelgeluidseffecten.', 'Twee duimen onder de titel vertellen of je leuk vindt wat er speelt. Één anonieme stem per apparaat, radiozenders inbegrepen, en je kunt hem altijd wijzigen of intrekken; zolang de beheerder de totalen niet toont, zie je alleen je eigen duim.', "Op iPhone en iPad gebruikt de speler standaard eenvoudige weergave, zodat de muziek doorspeelt met CarPlay, Bluetooth of een vergrendeld scherm; het volume regel je dan met de knoppen van het toestel of de auto. De optie ‘Volume in de app’ brengt de volumeschuif, de balans en de VU-meter terug, maar het geluid kan in de auto haperen."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Waar de opties wonen',
          b: ['De Geavanceerde opties openen via de tandwielknop van elk headermenu. Ze zijn gegroepeerd zoals in de desktopclient: Gebruikersinterface, Stijl, Geluid, Lokaal spel, Netwerkspel, Internetspel, Bijnamen / Avatars, Logmeldingen, en Back-up en reset. Elke webspecifieke functie heeft daar zijn eigen schakelaar, zodat je alles kunt uitschakelen wat je niet gebruikt.'] },
        { id: 'cfgxml', t: 'Instellingen uitwisselen met de desktopclient',
          b: ['Je instellingen kunnen tussen clients reizen: de categorie Back-up en reset biedt export/import van het officiële config.xml-bestand (de \u007e/.pokerth/config.xml van de desktop- en QML-clients). De export schrijft de gedeelde instellingen — naam, weergaveopties, geluiden, tafelvoorkeuren, blinds, stijlen — en de import past hier een desktopbestand toe. Instellingen die deze client niet kent, blijven onaangetast in het bestand bewaard.', 'Je spelersnotities reizen ook mee met het bestand — de tekst en de sterrenwaardering, geschreven zoals de desktopclients ze lezen. De kleurlabels blijven in deze client: het officiële formaat heeft er geen veld voor, dus een import raakt ze nooit aan.'] },
