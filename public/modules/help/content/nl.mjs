    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Logopties',
          b: ['In Geavanceerde opties \u2192 Logmeldingen kun je het loggen aan- of uitzetten en het schrijfinterval kiezen (na elke actie, of één keer per hand), net als in de instellingen van de desktopclient. Een extra optie schrijft het .pdb-bestand rechtstreeks naar een map van je keuze en werkt het na elke hand bij — precies zoals de desktopclient doet, zodat andere tools het live kunnen lezen.'],
          note: 'Schrijven naar een lokale map vereist de File System Access-API: alleen desktop-Chrome en -Edge. Firefox, Safari en mobiele browsers kunnen het niet — de optie toont dan een korte uitleg, en handmatig exporteren vanuit het Logs-venster blijft overal beschikbaar.' },
