    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'journal', t: 'Registros de manos y la ventana «Logs»',
          b: ['Más allá del historial en vivo, cada mano que juegas se graba localmente en tu navegador, en el mismo formato que los archivos de registro .pdb del cliente oficial. La ventana Logs (Opciones avanzadas \u2192 Mensajes de registro \u2192 Gestionar registros\u2026) lista tus sesiones y te permite trabajar con ellas: previsualizar una sesión con búsqueda y resaltado, filtrar por partida, exportar en HTML o texto plano, guardar el archivo .pdb en bruto, o importar un .pdb grabado por el cliente de escritorio. Las sesiones se borran una a una o todas de golpe (con confirmación), y un ajuste de retención automática puede conservar solo los últimos 7, 30, 90, 180 o 365 días. Los registros que importas tú mismo nunca se eliminan automáticamente.',
