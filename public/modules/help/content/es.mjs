  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Idioma',
          b: ['La interfaz está disponible en 46 idiomas. Cámbialo en cualquier momento en Opciones avanzadas (menú del engranaje), categoría Interfaz de usuario. Los términos de acción del póker (Fold, Check, Call, Bet, Raise, All-In) permanecen en inglés por convención, exactamente como en el cliente de escritorio.'] },
