  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Idioma',
          b: ['La interfaz está disponible en 78 idiomas. Cámbialo en cualquier momento en Opciones avanzadas (menú del engranaje), categoría Interfaz de usuario. Los términos de acción del póker (Fold, Check, Call, Bet, Raise, All-In) permanecen en inglés por convención, exactamente como en el cliente de escritorio.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zoom de mesa (teléfonos)',
          b: ['En pantallas pequeñas, los botones de lupa amplían la mesa (2\u00d7) y puedes desplazarla con el dedo — solo la barra de acción permanece fija; tu propia caja también se amplía y la vista vuelve a ella cuando es tu turno. La vista sigue automáticamente al asiento activo y se aleja en el showdown para la vista general. Se desactiva en las Opciones avanzadas. En tu turno, si las cartas comunitarias quedan fuera de la vista, aparece una pequeña copia en la parte superior de la mesa; tócala para ir a las cartas y volver.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Opciones de registro',
          ...
          note: 'Escribir en una carpeta local necesita la API File System Access: solo Chrome, Edge y Opera de escritorio. En el resto la opción se explica sola y la exportación manual desde la ventana de registros sigue disponible. Un navegador solo puede reemplazar un archivo, nunca añadir al final, así que una herramienta que lea el .pdb debería reabrirlo tras cada cambio.' },
        ...
        { id: 'hud', t: 'HUD de estadísticas en los asientos',
          b: ['El HUD adjunta una pequeña caja de estadísticas junto al asiento de cada jugador, construida a partir de las manos que has registrado en tus registros: número de manos observadas, luego VPIP (con qué frecuencia pone dinero voluntariamente pre-flop), PFR (subidas pre-flop) y AF (factor de agresividad), con un código de color de pasivo a agresivo. Debajo, una insignia resume al jugador en palabras \u2014 Conservador-Pasivo, Suelto-Agresivo, etc. \u2014 junto a un pequeño cuadrante cuyo sector encendido se lee de izquierda a derecha de conservador a suelto, y de abajo arriba de pasivo a agresivo. La insignia aparece desde la primera mano pero queda atenuada hasta las 25 manos, umbral a partir del cual es fiable. Toca una caja para un popover detallado con todas las cifras (3-bet, continuation bet, fold ante 3-bet, intentos de robo, tasas de showdown\u2026), y arrástrala si tapa algo.',
              'El HUD solo conoce lo que has visto en tus propias mesas — lee tus registros de manos locales, así que el registro debe estar activo y las cifras cobran sentido tras suficientes manos. Está desactivada por defecto: actívala en Opciones avanzadas \u2192 Asistencia.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'forumnews', t: 'Novedades del foro en el lobby',
          b: ['El botón de periódico en la cabecera del lobby abre los últimos mensajes del foro de pokerth.net, una entrada por tema y cada foro con su color. La insignia del botón cuenta los mensajes no leídos; abrir un mensaje (nueva pestaña) lo marca como leído, y «Marcar todo como leído» lo limpia todo de una vez.',
              'Es un extra web: el botón puede ocultarse en las Opciones avanzadas («Botón del foro en la cabecera del lobby»).',
              'La pestaña «Eventos» muestra las próximas partidas de la BBC y la próxima Monthly Cup con el número de jugadores inscritos, y los últimos ganadores de la BBC, la WEC y la Monthly Cup. Las horas están en tu hora local, y un toque abre el sitio de la comunidad. La opción «Mostrar contenido de la comunidad (BBC / WEC)» oculta esta pestaña.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Reproductor de música',
          b: ['La entrada de música de los menús de la cabecera abre un pequeño reproductor de música de ambiente: elige una pista de la lista, reproducir/pausar, anterior/siguiente, aleatorio, y repetición de una pista, de toda la lista o de nada. El volumen, la pista seleccionada y el modo de repetición se recuerdan. La reproducción nunca empieza sola — los navegadores exigen un toque — y el reproductor es totalmente independiente de los efectos de sonido del juego.', 'Dos pulgares bajo el título de la pista dicen si te gusta lo que suena. Un voto anónimo por dispositivo, radios incluidas, y puedes cambiarlo o retirarlo cuando quieras; si el operador no muestra los totales, solo ves tu propio pulgar.', "En iPhone y iPad el reproductor usa por defecto una reproducción simple, para que la música siga sonando con CarPlay, Bluetooth o la pantalla bloqueada; el volumen se ajusta entonces con los botones del dispositivo o del vehículo. La opción «Volumen en la app» recupera el control de volumen, el balance y el vúmetro, pero el sonido puede entrecortarse en el vehículo."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Dónde viven las opciones',
          b: ['Las Opciones avanzadas se abren desde la entrada del engranaje de cualquier menú de cabecera. Están agrupadas como en el cliente de escritorio: Interfaz de usuario, Estilo, Sonido, Partida local, Partida en red, Partida por Internet, Apodos / Avatares, Mensajes de registro, y Copia de seguridad y restablecer. Cada función específica de la web tiene allí su propio interruptor, para que puedas desactivar todo lo que no uses.'] },
        { id: 'cfgxml', t: 'Intercambiar ajustes con el cliente de escritorio',
          b: ['Tus ajustes pueden viajar entre clientes: la categoría Copia de seguridad y restablecer ofrece exportar/importar el archivo config.xml oficial (el \u007e/.pokerth/config.xml que usan los clientes de escritorio y QML). La exportación escribe los ajustes compartidos — nombre, opciones de pantalla, sonidos, preferencias de mesa, ciegas, estilos — y la importación aplica aquí un archivo del escritorio. Los ajustes que este cliente no conoce se conservan intactos en el archivo.', 'Tus notas de jugador también viajan con el archivo: el texto y la valoración con estrellas, escritos tal como los leen los clientes de escritorio. Las etiquetas de color se quedan en este cliente: el formato oficial no tiene un campo para ellas, así que una importación nunca las toca.'] },
        ...
        { id: 'fkeys', t: 'Atajos de teclado oficiales',
          b: ['Las teclas de funci\u00f3n oficiales de PokerTH funcionan durante una partida \u2014 Alt+S funciona en cualquier parte:'],
          keys: [
