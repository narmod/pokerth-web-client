  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Family leaderboard',
          b: ['Sa mga pribadong server at LAN game lang, ang client ay nag-iingat ng lifetime na istatistika bawat palayaw \u2014 mga kamay at larong nilaro at napanalunan, pinakamalaking panalo, pinakamahabang sunod na panalo \u2014 at ibinabahagi ito sa pamamagitan ng server para makita ng bawat device sa paligid ng mesa ang parehong leaderboard. Hindi kailanman sinusubaybayan nang ganito ang mga laro sa pokerth.net, at hiwalay na nakatago ang stats ng training mode.', 'Sa mga larong ito, binubuksan ng button na tropeo ang window ng ranking sa tab na LAN: ang lahat ng manlalaro, na maaaring isaayos ayon sa ilang pamantayan.'] },
        { id: 'language', t: 'Wika',
          b: ['Available ang interface sa 71 wika. Palitan ito anumang oras sa Advanced options (gear menu) sa ilalim ng User interface. Ang mga terminong aksyon sa poker (Fold, Check, Call, Bet, Raise, All-In) ay nananatili sa Ingles ayon sa kaugalian, eksaktong tulad ng desktop client.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Table zoom (mga phone)',
          b: ['Sa maliliit na screen, ang mga magnifier button ay nagzu-zoom sa mesa (2\u00d7) at maaari kang mag-pan gamit ang daliri \u2014 tanging ang action bar ang nananatiling nakapirmi; pinalalaki rin ang sarili mong box at bumabalik dito ang view kapag turn mo. Awtomatikong sinusundan ng view ang aktibong upuan at nagzu-zoom pabalik sa showdown para sa overview. Maaari itong i-off sa Advanced options. Sa turn mo, kung nasa labas ng view ang mga community card, may lalabas na maliit na kopya ng mga ito sa itaas ng mesa; i-tap ito para pumunta sa mga card at bumalik.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'hud', t: 'Stats HUD sa mga upuan',
          b: ['Ang HUD ay nagkakabit ng maliit na statistics box sa tabi ng upuan ng bawat manlalaro, binuo mula sa mga kamay na naitala mo sa mga log mo: bilang ng mga kamay na naobserbahan, saka VPIP (gaano kadalas silang kusang naglalagay ng pera pre-flop), PFR (mga pre-flop raise) at AF (aggression factor), may color-code mula passive hanggang aggressive. Sa ilalim nito, may badge na nagbubuod sa manlalaro sa simpleng salita \u2014 Tight-Passive, Loose-Aggressive at iba pa \u2014 sa tabi ng maliit na dial na ang lit quadrant ay binabasa kaliwa-pakanan para sa tight hanggang loose, at ibaba-pataas para sa passive hanggang aggressive. Lumalabas ang badge mula sa kauna-unahang kamay pero nananatiling dimmed hanggang 25 kamay, kung saan nagiging maaasahan. I-tap ang box para sa detalyadong popover na may buong set ng mga numero (3-bet, continuation bet, fold to 3-bet, mga steal attempt, showdown rate\u2026), at i-drag ang box para ilipat kung may natatakpan.',
              'Alam lang ng HUD ang nakita mo sa sarili mong mga mesa \u2014 binabasa nito ang lokal mong mga hand log, kaya dapat naka-enable ang pag-log at nagiging makabuluhan ang mga numero pagkatapos ng sapat na mga kamay. Naka-off ito by default: i-enable sa Advanced options \u2192 Tulong.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Music player',
          b: ['Ang music entry sa mga header menu ay nagbubukas ng maliit na lounge-music player: pumili ng track mula sa playlist, play/pause, previous/next, shuffle, at ulitin ang isang track, ang buong playlist o wala. Naaalala ang volume, napiling track at repeat mode. Hindi kailanman nagsisimula ang playback nang mag-isa \u2014 nangangailangan ng tap ang mga browser \u2014 at ang player ay ganap na independent sa mga sound effect ng laro.', 'Dalawang hinlalaki sa ilalim ng pamagat ang nagsasabi kung gusto mo ang tumutugtog. Isang hindi nagpapakilalang boto kada device, kasama ang mga radyo, at puwede mo itong baguhin o bawiin anumang oras; hangga\u2019t hindi ipinapakita ng operator ang kabuuan, ikaw lang ang nakakakita ng sarili mong boto.', "Sa iPhone at iPad, gumagamit ang player ng simpleng playback bilang default upang magpatuloy ang musika sa CarPlay, Bluetooth o naka-lock na screen; itinatakda noon ang volume gamit ang mga button ng device o ng sasakyan. Ibinabalik ng opsyong “Volume sa app” ang volume slider, balance at VU meter, ngunit maaaring maputol-putol ang tunog sa sasakyan."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Saan naroroon ang mga option',
          b: ['Nagbubukas ang Advanced options mula sa gear entry ng anumang header menu. Nakagrupo ang mga ito tulad ng desktop client: User interface, Istilo, Tunog, Lokal na laro, Network na laro, Internet na laro, Mga palayaw / Avatar, Mga log message, at Backup at reset. Bawat web-specific na feature ay may sariling switch doon, kaya maaari mong i-off ang anumang hindi mo ginagamit.'] },
        { id: 'cfgxml', t: 'Pagpapalitan ng mga setting sa desktop client',
          b: ['Maaaring maglakbay ang mga setting mo sa pagitan ng mga client: ang kategoryang Backup at reset ay nag-aalok ng export/import ng opisyal na config.xml file (ang \u007e/.pokerth/config.xml na ginagamit ng mga desktop at QML client). Isinusulat ng export ang mga ibinabahaging setting \u2014 pangalan, mga display option, tunog, mga kagustuhan sa mesa, mga blind, mga istilo \u2014 at inilalapat ng import ang desktop file dito. Ang mga setting na hindi kilala ng client na ito ay pinapanatili sa file nang hindi ginagalaw.', 'Kasama rin sa file ang mga tala mo tungkol sa mga manlalaro — ang teksto at ang rating na bituin, nakasulat sa paraang binabasa ng mga desktop client. Nananatili rito ang mga kulay na label: walang puwang para sa mga ito ang opisyal na format, kaya hindi sila ginagalaw ng pag-import.'] },
