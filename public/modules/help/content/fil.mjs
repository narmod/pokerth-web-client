  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Wika',
          b: ['Available ang interface sa 61 wika. Palitan ito anumang oras sa Advanced options (gear menu) sa ilalim ng User interface. Ang mga terminong aksyon sa poker (Fold, Check, Call, Bet, Raise, All-In) ay nananatili sa Ingles ayon sa kaugalian, eksaktong tulad ng desktop client.'] },
