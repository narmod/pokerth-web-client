  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Lingua',
          b: ['L\u2019interfaccia è disponibile in 73 lingue. Cambiala in qualsiasi momento nelle Opzioni avanzate (menu con l\u2019ingranaggio), categoria Interfaccia utente. I termini d\u2019azione del poker (Fold, Check, Call, Bet, Raise, All-In) restano in inglese per convenzione, esattamente come nel client desktop.'] },
