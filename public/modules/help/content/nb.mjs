  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Språk',
          b: ['Grensesnittet finnes på 75 språk. Bytt når som helst i Avanserte innstillinger (tannhjulmenyen), kategorien Brukergrensesnitt. Pokerens handlingstermer (Fold, Check, Call, Bet, Raise, All-In) forblir på engelsk etter konvensjonen, nøyaktig som i skrivebordsklienten.'] },
