  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Familierangering',
          b: ['Bare på private servere og i LAN-spill lagrer klienten samlede statistikker per kallenavn — spilte og vunne hender og partier, største gevinst, beste rekke — og deler dem via serveren, slik at hver enhet rundt bordet ser den samme rangeringen. pokerth.net-spill spores aldri på denne måten, og treningsmodusens statistikk holdes helt adskilt.', 'I disse spillene åpner pokal-knappen rangeringsvinduet på fanen LAN: alle spillere, sorterbare etter flere kriterier.'] },
        { id: 'language', t: 'Språk',
          b: ['Grensesnittet finnes på 74 språk. Bytt når som helst i Avanserte innstillinger (tannhjulmenyen), kategorien Brukergrensesnitt. Pokerens handlingstermer (Fold, Check, Call, Bet, Raise, All-In) forblir på engelsk etter konvensjonen, nøyaktig som i skrivebordsklienten.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Bordzoom (telefoner)',
          b: ['På små skjermer forstørrer lupeknappene bordet (2\u00d7), og du kan dra det med fingeren — bare handlingslinjen står fast; din egen boks forstørres også, og visningen går tilbake til den når det er din tur. Visningen følger automatisk den aktive plassen og zoomer ut ved showdown for oversikten. Kan slås av i Avanserte innstillinger. Når det er din tur og felleskortene er utenfor bildet, vises en liten kopi øverst på bordet; trykk på den for å gå til kortene og tilbake.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Logginnstillinger',
          b: ['Under Avanserte valg \u2192 Loggmeldinger kan du slå logging av eller på og velge skriveintervall, med de samme tre innstillingene som skrivebordsklienten: etter hver handling, etter hver hånd (standard) eller etter hvert spill. Et annet valg skriver .pdb-filen til en mappe du velger og holder den oppdatert med det intervallet, pluss en siste gang når du forlater siden, slik at et annet verktøy kan følge spillet direkte.'],
          note: 'Å skrive til en lokal mappe krever File System Access API: bare Chrome, Edge og Opera på skrivebordet. Ellers forklarer valget seg selv, og manuell eksport fra loggvinduet er fortsatt tilgjengelig. En nettleser kan bare erstatte en fil, aldri legge til i den, så et verktøy som leser .pdb bør åpne den på nytt etter hver endring.' },
        ...
        { id: 'hud', t: 'Statistikk-HUD ved plassene',
          b: ['HUD-en fester en liten statistikkboks ved siden av hver spillers plass, bygd av hendene du har registrert i loggene dine: antall observerte hender, deretter VPIP (hvor ofte han frivillig legger inn penger pre-flop), PFR (pre-flop-hevinger) og AF (aggresjonsfaktor), fargekodet fra passiv til aggressiv. Under dem oppsummerer et merke spilleren med ord \u2014 Stram-Passiv, Løs-Aggressiv og så videre \u2014 ved siden av en liten skive der den opplyste kvadranten leses fra venstre mot høyre som stram til løs, og nedenfra og opp som passiv til aggressiv. Merket vises fra aller første hånd, men holdes dempet til 25 hender, der det blir pålitelig. Trykk på en boks for et detaljert popover med alle tallene (3-bet, continuation bet, fold mot 3-bet, stjeleforsøk, showdown-rater\u2026), og dra den vekk hvis den dekker noe.',
              'HUD-en kjenner bare det du har sett ved dine egne bord — den leser dine lokale håndlogger, så opptaket må være på, og tallene gir først mening etter nok hender. Den er av som standard: slå den på i Avanserte innstillinger \u2192 Assistanse.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'privatemsg', t: "Private meldinger",
          b: ["Skriv til én spiller uten at hele lobbyen leser med. Konvolutten ved siden av et navn i spillerlisten åpner en samtale med vedkommende; konvolutten i lobbyens topptekst åpner den siste på nytt. Samtaler lagres på denne enheten og er der fortsatt når du kommer tilbake, så en chat som tas opp igjen dager senere har sin egen historikk — et rødt tall på konvolutten viser hva du ikke har lest ennå, og søppelbøtten i vindustittelen sletter en samtale for godt."],
          keys: [
            ["/msg <kallenavn> <melding>", "Send en privat melding fra lobbychatten"],
            ["/msg \"<kallenavn>\" <melding>", "Det samme, når kallenavnet inneholder mellomrom"]],
          note: "Meldinger er begrenset til 128 tegn. Serveren leverer ikke en privat melding til en spiller som sitter ved et bord som er i gang, og historikken lagres bare i denne nettleseren — den følger deg ikke til en annen enhet." },
        ...
        { id: 'translate', t: 'Forstå alle',
          b: ['Med chatoversettelse på vises en oversettelsesknapp på linjen under pekeren — eller på linjen du trykker på, på en berøringsskjerm — og viser meldingen på språket ditt med nettleserens oversetter. Den kan vises permanent på alle linjer under Avanserte innstillinger → Chat, der også hjelpeteksten som forklarer vanlige bordforkortelser (gg, nh, utg…) bor.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Musikkspiller',
          b: ['Musikkoppføringen i toppfeltmenyene åpner en liten bakgrunnsmusikkspiller: velg et spor fra spillelisten, spill/pause, forrige/neste, tilfeldig, og gjentakelse av ett spor, hele listen eller ingenting. Volum, valgt spor og gjentakelsesmodus huskes. Avspillingen starter aldri av seg selv — nettlesere krever et trykk — og spilleren er helt uavhengig av spillets lydeffekter.', 'To tomler under sportittelen sier om du liker det som spilles. Én anonym stemme per enhet, radiokanaler inkludert, og du kan endre eller trekke den tilbake når som helst; med mindre operatøren viser totalene, ser du bare din egen tommel.', "På iPhone og iPad bruker spilleren som standard vanlig avspilling, slik at musikken fortsetter med CarPlay, Bluetooth eller låst skjerm; volumet stilles da med knappene på enheten eller i bilen. Valget «Volum i appen» gir tilbake volumglideren, balansen og VU-meteret, men lyden kan hakke i bilen."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Hvor innstillingene bor',
          b: ['Avanserte innstillinger åpnes fra tannhjuloppføringen i enhver toppfeltmeny. De er gruppert som i skrivebordsklienten: Brukergrensesnitt, Stil, Lyd, Lokalt spill, Nettverksspill, Internettspill, Kallenavn / Avatarer, Loggmeldinger og Sikkerhetskopi og tilbakestilling. Hver webspesifikke funksjon har sin egen bryter der, så du kan slå av alt du ikke bruker.'] },
        { id: 'cfgxml', t: 'Utveksle innstillinger med skrivebordsklienten',
          b: ['Innstillingene dine kan reise mellom klienter: kategorien Sikkerhetskopi og tilbakestilling tilbyr eksport/import av den offisielle config.xml-filen (den \u007e/.pokerth/config.xml som skrivebords- og QML-klientene bruker). Eksporten skriver de delte innstillingene — navn, visningsvalg, lyder, bordpreferanser, blinds, stiler — og importen bruker en fil fra datamaskinen her. Innstillinger denne klienten ikke kjenner, bevares urørt i filen.', 'Spillernotatene dine reiser også med filen — teksten og stjernevurderingen, skrevet slik skrivebordsklientene leser dem. Fargeetikettene blir i denne klienten: det offisielle formatet har ikke noe felt for dem, så en import rører dem aldri.'] },
        ...
        { id: 'fkeys', t: 'Offisielle hurtigtaster',
          ...
          keys: [
            ...
            ['Alt+S', 'Innstillinger — hvor som helst i appen, ikke bare under et spill'],
            ['F11', 'Full skjerm']],
        ...
        { id: 'webkeys', t: 'Webbokstavtaster',
          b: ['Webutvidelse: enkeltbokstavtaster og Alt+T utløser også handlinger, og alle kan tilordnes på nytt i Avanserte innstillinger → Hurtigtaster:'],
          keys: [
            ['F', 'Fold'],
            ['C', 'Check / Call'],
            ['R', 'Raise'],
            ...
            ['Alt+T', 'Statistikkpanel'],
            ['Esc', 'Lukk det forreste vinduet (også Androids Tilbake-knapp)'],
            ['\u2191 \u2193 \u00b7 \u21b5', 'Bordlisten i lobbyen (nås med Tab): velg et bord \u00b7 bli med']],
