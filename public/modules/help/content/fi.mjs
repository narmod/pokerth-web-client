  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Kieli',
          b: ['Käyttöliittymä on saatavilla 63 kielellä. Vaihda se milloin tahansa Lisäasetuksista (ratasvalikko), kohdasta Käyttöliittymä. Pokerin toimintotermit (Fold, Check, Call, Bet, Raise, All-In) pysyvät käytännön mukaan englanniksi, aivan kuten työpöytäasiakkaassa.'] },
