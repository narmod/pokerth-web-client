  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Perheen sijoituslista',
          b: ['Vain yksityisillä palvelimilla ja LAN-peleissä asiakasohjelma pitää nimimerkkikohtaisia kokonaistilastoja — pelatut ja voitetut kädet ja pelit, suurin voitto, paras putki — ja jakaa ne palvelimen kautta, joten jokainen pöydän ääressä oleva laite näkee saman listan. pokerth.net-pelejä ei koskaan seurata näin, ja harjoittelutilan tilastot pysyvät täysin erillään.', 'Näissä peleissä pokaalipainike avaa sijoitusikkunan LAN-välilehdelle: kaikki pelaajat, lajiteltavissa useilla perusteilla.'] },
        { id: 'language', t: 'Kieli',
          b: ['Käyttöliittymä on saatavilla 71 kielellä. Vaihda se milloin tahansa Lisäasetuksista (ratasvalikko), kohdasta Käyttöliittymä. Pokerin toimintotermit (Fold, Check, Call, Bet, Raise, All-In) pysyvät käytännön mukaan englanniksi, aivan kuten työpöytäasiakkaassa.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Pöydän zoomaus (puhelimet)',
          b: ['Pienillä näytöillä suurennuslasipainikkeet suurentavat pöytää (2\u00d7), ja voit vetää sitä sormella — vain toimintopalkki pysyy paikoillaan; myös oma laatikkosi suurennetaan, ja näkymä palaa siihen, kun on sinun vuorosi. Näkymä seuraa automaattisesti aktiivista paikkaa ja loitontaa showdownissa kokonaiskuvaa varten. Voi poistaa käytöstä Lisäasetuksista. Kun on sinun vuorosi ja yhteiset kortit ovat näkymän ulkopuolella, pöydän yläreunaan ilmestyy niistä pieni kopio; napauta sitä siirtyäksesi korttien luo ja takaisin.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Käsilokit ja \u201dLokit\u201d-ikkuna',
          b: ['Reaaliaikaisen lokin lisäksi jokainen pelaamasi käsi tallennetaan paikallisesti selaimeesi, samassa muodossa kuin virallisen asiakkaan .pdb-lokitiedostot. Lokit-ikkuna (Lisäasetukset \u2192 Lokiviestit \u2192 Hallitse lokeja\u2026) listaa istuntosi ja antaa työskennellä niiden kanssa: esikatsele istuntoa haulla ja korostuksella, suodata pelin mukaan, vie HTML:nä tai pelkkänä tekstinä, tallenna raaka .pdb-tiedosto tai tuo työpöytäasiakkaan tallentama .pdb. Istunnot poistetaan yksi kerrallaan tai kaikki kerralla (vahvistuksella), ja automaattinen säilytys voi pitää vain viimeiset 7, 30, 90, 180 tai 365 päivää. Itse tuomiasi lokeja ei poisteta koskaan automaattisesti. Toinen asetus rajaa säilytettävien istuntojen määrän, ja luettelosaraketta voi venyttää leveämmäksi.',
              'Kun haluat siivota useita istuntoja kerralla, Valitse…-painike tuo jokaiseen riviin valintaruudun: rastita turhat, ja Poista poistaa koko erän yhdellä vahvistuksella. Tietokoneella Ctrl (⌘) + napsautus lisää istuntoja yksitellen ja Vaihto + napsautus ottaa koko välin.',
        ...
        { id: 'hud', t: 'Tilasto-HUD paikoilla',
          b: ['HUD kiinnittää pienen tilastolaatikon jokaisen pelaajan paikan viereen. Se rakennetaan käsistä, jotka olet tallentanut lokeihisi: havaittujen käsien määrä, sitten VPIP (kuinka usein hän laittaa rahaa vapaaehtoisesti pre-flopissa), PFR (pre-flop-korotukset) ja AF (aggressiokerroin), väreillä passiivisesta aggressiiviseen. Niiden alla merkki tiivistää pelaajan sanoin \u2014 Tiukka-Passiivinen, Löysä-Aggressiivinen ja niin edelleen \u2014 pienen kellotaulun vieressä, jonka syttynyt neljännes luetaan vasemmalta oikealle tiukasta löysään ja alhaalta ylös passiivisesta aggressiiviseen. Merkki näkyy heti ensimmäisestä kädestä, mutta pysyy himmennettynä 25 käteen asti, jolloin siitä tulee luotettava. Napauta laatikkoa nähdäksesi yksityiskohtaisen ponnahdusikkunan kaikilla luvuilla (3-bet, continuation bet, fold 3-bettiin, varastusyritykset, showdown-osuudet\u2026), ja vedä laatikkoa, jos se peittää jotain.',
              'HUD tietää vain sen, mitä olet nähnyt omissa pöydissäsi — se lukee paikallisia käsilokejasi, joten tallennuksen on oltava päällä ja luvut muuttuvat merkityksellisiksi vasta riittävän monen käden jälkeen. Se on oletuksena pois päältä: ota se käyttöön kohdasta Lisäasetukset \u2192 Avustin.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Musiikkisoitin',
          b: ['Yläpalkin valikkojen musiikkikohta avaa pienen taustamusiikkisoittimen: valitse kappale soittolistalta, toista/tauko, edellinen/seuraava, satunnaistoisto sekä yhden kappaleen, koko listan tai ei minkään toisto. Äänenvoimakkuus, valittu kappale ja toistotila muistetaan. Toisto ei koskaan ala itsestään — selaimet vaativat kosketuksen — ja soitin on täysin riippumaton pelin äänitehosteista.', 'Kaksi peukkua kappaleen nimen alla kertovat, pidätkö soivasta kappaleesta. Yksi nimetön ääni laitetta kohden, radiot mukaan lukien, ja voit muuttaa tai perua sen milloin tahansa; ellei ylläpitäjä paljasta summia, näet vain oman peukkusi.', "iPhonessa ja iPadissa soitin käyttää oletuksena tavallista toistoa, jotta musiikki jatkuu CarPlayn, Bluetoothin tai lukitun näytön kanssa; äänenvoimakkuus säädetään silloin laitteen tai auton painikkeilla. Valinta ”Äänenvoimakkuus sovelluksessa” palauttaa äänenvoimakkuuden liukusäätimen, balanssin ja VU-mittarin, mutta ääni voi pätkiä autossa."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Missä asetukset asuvat',
          b: ['Lisäasetukset avataan minkä tahansa yläpalkkivalikon ratas-kohdasta. Ne on ryhmitelty kuten työpöytäasiakkaassa: Käyttöliittymä, Tyyli, Ääni, Paikallinen peli, Verkkopeli, Internet-peli, Nimimerkit / Avatarit, Lokiviestit ja Varmuuskopio ja palautus. Jokaisella verkkokohtaisella ominaisuudella on siellä oma kytkimensä, joten voit kytkeä pois kaiken, mitä et käytä.'] },
        { id: 'cfgxml', t: 'Asetusten vaihto työpöytäasiakkaan kanssa',
          b: ['Asetuksesi voivat matkustaa asiakkaiden välillä: Varmuuskopio ja palautus-kategoria tarjoaa virallisen config.xml-tiedoston viennin/tuonnin (sen \u007e/.pokerth/config.xml-tiedoston, jota työpöytä- ja QML-asiakkaat käyttävät). Vienti kirjoittaa jaetut asetukset — nimen, näyttöasetukset, äänet, pöytämieltymykset, blindit, tyylit — ja tuonti soveltaa työpöydän tiedoston tänne. Asetukset, joita tämä asiakas ei tunne, säilyvät tiedostossa koskemattomina.', 'Pelaajamuistiinpanosi kulkevat tiedoston mukana — teksti ja tähtiarvio, kirjoitettuna niin kuin työpöytäasiakkaat ne lukevat. Värimerkinnät jäävät tähän asiakkaaseen: virallisessa muodossa ei ole niille kenttää, joten tuonti ei kajoa niihin koskaan.'] },
