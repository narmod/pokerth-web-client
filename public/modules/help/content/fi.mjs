    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Lokiasetukset',
          b: ['Kohdassa Lisäasetukset \u2192 Lokiviestit voit kytkeä tallennuksen päälle tai pois ja valita kirjoitusvälin (jokaisen toiminnon jälkeen tai kerran kädessä), aivan kuten työpöytäasiakkaan asetuksissa. Lisäasetus kirjoittaa .pdb-tiedoston suoraan valitsemaasi kansioon ja päivittää sen joka käden jälkeen — täsmälleen kuten työpöytäasiakas, jotta muut työkalut voivat lukea sitä reaaliajassa.'],
          note: 'Paikalliseen kansioon kirjoittaminen vaatii File System Access -API:n: vain työpöydän Chrome ja Edge. Firefox, Safari ja mobiiliselaimet eivät pysty — asetus näyttää silloin lyhyen selityksen, ja manuaalinen vienti Lokit-ikkunasta on käytettävissä kaikkialla.' },
        ...
        { id: 'hud', t: 'Tilasto-HUD paikoilla (beta)',
          b: ['HUD kiinnittää jokaisen pelaajan paikan viereen pienen tilastolaatikon, joka rakentuu lokeihisi tallennetuista käsistä: havaittujen käsien määrä, sitten VPIP (kuinka usein hän laittaa rahaa vapaaehtoisesti pre-flopissa), PFR (pre-flop-korotukset), AF (aggressiokerroin), 3B (3-bet), CB (continuation bet) ja F3B (fold 3-betille), värikoodattuna passiivisesta aggressiiviseen. Napauta laatikkoa nähdäksesi yksityiskohtaisen ponnahdusikkunan lisäluvuilla (varastusyritykset, fold varastukselle, showdown-osuudet\u2026), ja vedä laatikkoa, jos se peittää jotain.',
      ...
      sections: [
        ...
        { id: 'cups', t: 'Yhteisön cupit: BBC ja WeCup',
          b: ['Kaksi yhteisöä järjestää pokerth.netissä omat kilpailunsa, kummallakin oma sivusto ja oma sijoituslista. Best Brainies Cup (BBC) on vuonna 2013 syntynyt porrasturnaus: edetään Step 1:stä Step 4:ään, ja uusi kausi alkaa jokaisen Step 4 -pelin jälkeen, kun pokaali jaetaan. WeCupilla (WEC) on oma, paljon laajemmalle levittyvä asteikkonsa — 75 pistettä ensimmäisestä sijasta, sitten 45, 30, 20… — ja sen score normalisoi keskiarvosi sen mukaan, montako peliä olet pelannut muihin jäseniin verrattuna.',
              'Molemmat sijoituslistat avautuvat pokaalipainikkeesta PokerTH-listan vierestä. Näiden kilpailujen pöytäasetukset ovat mukana esiasetuksina, kun luot pelin (BBC Step 1–4, WEC ja WEC Grand Final), joten voit harjoitella samoissa oloissa. Osallistuminen vaatii ilmoittautumisen kyseisen cupin sivustolla.'],
