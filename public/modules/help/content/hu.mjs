  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Nyelv',
          b: ['A felület 55 nyelven érhető el. Bármikor átválthatod a Speciális beállításokban (fogaskerék menü), a Felhasználói felület kategóriában. A póker akciókifejezései (Fold, Check, Call, Bet, Raise, All-In) konvenció szerint angolul maradnak, pontosan úgy, mint az asztali kliensben.'] },
