  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Családi ranglista',
          b: ['Csak privát szervereken és LAN-játékokban tart a kliens becenevenkénti összesített statisztikákat — játszott és megnyert leosztások és játszmák, legnagyobb nyeremény, legjobb sorozat — és a szerveren keresztül megosztja őket, így az asztal körül minden eszköz ugyanazt a ranglistát látja. A pokerth.net játékokat soha nem követi így, és a gyakorlómód statisztikái teljesen külön vannak tárolva.', 'Ezekben a játékokban a serleg gomb a ranglistaablakot a LAN fülön nyitja meg: minden játékos, több szempont szerint rendezhetően.'] },
        { id: 'language', t: 'Nyelv',
          b: ['A felület 66 nyelven érhető el. Bármikor átválthatod a Speciális beállításokban (fogaskerék menü), a Felhasználói felület kategóriában. A póker akciókifejezései (Fold, Check, Call, Bet, Raise, All-In) konvenció szerint angolul maradnak, pontosan úgy, mint az asztali kliensben.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Asztali nagyítás (telefonok)',
          b: ['Kis képernyőkön a nagyító gombok felnagyítják az asztalt (2\u00d7), és ujjal húzhatod — csak az akciósáv marad a helyén; a saját dobozod is felnagyítódik, és a nézet visszatér hozzá, amikor te következel. A nézet automatikusan követi az aktív ülést, és showdownnál kizoomol az áttekintéshez. A Speciális beállításokban kikapcsolható. Amikor te következel, és a közös lapok a nézeten kívül vannak, az asztal tetején megjelenik egy kis másolatuk; koppints rá, hogy a lapokhoz ugorj és vissza.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Zenelejátszó',
          b: ['A fejlécmenük zene bejegyzése egy kis háttérzene-lejátszót nyit: válassz számot a lejátszási listáról, lejátszás/szünet, előző/következő, keverés, valamint egy szám, a teljes lista vagy semmi ismétlése. A hangerő, a kiválasztott szám és az ismétlési mód megjegyzésre kerül. A lejátszás soha nem indul magától — a böngészők érintést követelnek — a lejátszó pedig teljesen független a játék hangeffektjeitől.', 'Két hüvelykujj a szám címe alatt jelzi, tetszik-e, ami szól. Eszközönként egy névtelen szavazat, a rádiókat is beleértve, és bármikor megváltoztathatod vagy visszavonhatod; amíg az üzemeltető nem mutatja meg az összesítést, csak a saját szavazatodat látod.', "iPhone-on és iPaden a lejátszó alapértelmezés szerint egyszerű lejátszást használ, hogy a zene CarPlay, Bluetooth vagy zárolt képernyő mellett is tovább szóljon; a hangerő ilyenkor a készülék vagy az autó gombjaival állítható. A(z) „Hangerő az alkalmazásban” beállítás visszahozza a hangerőcsúszkát, a balanszot és a VU-mérőt, de a hang az autóban akadozhat."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Hol laknak a beállítások',
          b: ['A Speciális beállítások bármely fejlécmenü fogaskerék-bejegyzéséből nyílnak. Az asztali klienshez hasonlóan vannak csoportosítva: Felhasználói felület, Stílus, Hang, Helyi játszma, Hálózati játszma, Internetes játszma, Becenevek / Avatárok, Naplóüzenetek és Biztonsági mentés és visszaállítás visszaállítása. Minden webspecifikus funkciónak ott saját kapcsolója van, így mindent kikapcsolhatsz, amit nem használsz.'] },
        { id: 'cfgxml', t: 'Beállításcsere az asztali klienssel',
          b: ['A beállításaid utazhatnak a kliensek között: a Biztonsági mentés és visszaállítás kategória a hivatalos config.xml fájl exportját/importját kínálja (azt a \u007e/.pokerth/config.xml-t, amelyet az asztali és a QML kliensek használnak). Az export a közös beállításokat írja ki — név, megjelenítési opciók, hangok, asztalpreferenciák, vakok, stílusok — az import pedig egy asztali fájlt alkalmaz itt. Az ezen kliens által nem ismert beállítások érintetlenül maradnak a fájlban.', 'A játékosjegyzeteid is utaznak a fájllal — a szöveg és a csillagos értékelés, úgy leírva, ahogyan az asztali kliensek olvassák. A színcímkék ebben a kliensben maradnak: a hivatalos formátumban nincs mezőjük, így az importálás soha nem nyúl hozzájuk.'] },
