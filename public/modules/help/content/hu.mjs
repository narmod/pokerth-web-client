    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Asztali nagyítás (telefonok)',
          b: ['Kis képernyőkön a nagyító gombok felnagyítják az asztalt (2\u00d7), és ujjal húzhatod — csak az akciósáv marad a helyén; a saját dobozod is felnagyítódik, és a nézet visszatér hozzá, amikor te következel. A nézet automatikusan követi az aktív ülést, és showdownnál kizoomol az áttekintéshez. A Speciális beállításokban kikapcsolható.'],
