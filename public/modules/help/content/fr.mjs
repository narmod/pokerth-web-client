  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Classement familial',
          b: ['Sur les serveurs privés et les parties LAN uniquement, le client conserve des statistiques cumulées par pseudo — mains et parties jouées et gagnées, plus gros gain, meilleure série — et les partage via le serveur pour que chaque appareil autour de la table voie le même classement. Les parties pokerth.net ne sont jamais suivies de cette façon, et les statistiques du mode entraînement restent complètement séparées.', 'Dans ces parties, le bouton trophée ouvre la fenêtre des classements sur son onglet LAN : tous les joueurs, triables selon plusieurs critères.'] },
        { id: 'language', t: 'Langue',
          b: ['L\u2019interface est disponible en 73 langues. Change-la à tout moment dans les Options avancées (menu roue crantée), catégorie Interface utilisateur. Les termes d\u2019action du poker (Fold, Check, Call, Bet, Raise, All-In) restent en anglais par convention, exactement comme dans le client de bureau.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zoom de table (téléphones)',
          b: ['Sur petit écran, des boutons loupe zooment la table (2\u00d7) et tu peux la faire défiler au doigt — seule la barre d\u2019action reste fixe ; ta propre boîte est agrandie elle aussi, et la vue y revient quand c\u2019est ton tour. La vue suit automatiquement le siège actif et dézoome à l\u2019abattage pour la vue d\u2019ensemble. Désactivable dans les Options avancées. À ton tour, si les cartes communes sont hors de la vue, une petite copie s\u2019affiche en haut de la table ; touche-la pour aller aux cartes et en revenir.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Journaux de mains et fenêtre « Logs »',
          b: ['Au-delà de l\u2019historique en direct, chaque main que tu joues est enregistrée localement dans ton navigateur, au même format que les fichiers de journal .pdb du client officiel. La fenêtre Logs (Options avancées \u2192 Messages de log \u2192 Gérer les logs\u2026) liste tes sessions et te permet de travailler avec : prévisualiser une session avec recherche et surlignage, filtrer par partie, exporter en HTML ou en texte brut, enregistrer le fichier .pdb brut, ou importer un .pdb enregistré par le client de bureau. Les sessions se suppriment une par une ou toutes d\u2019un coup (avec confirmation), et un réglage de rétention automatique peut ne garder que les 7, 30, 90, 180 ou 365 derniers jours. Les journaux que vous importez ne sont jamais supprimés automatiquement. Un second réglage plafonne le nombre de sessions conservées, et la colonne de la liste s’élargit en la tirant.',
              'Pour faire le ménage d’un coup, le bouton Sélectionner… fait apparaître une case à cocher sur chaque session : coche celles dont tu ne veux plus et Supprimer efface tout le lot après une seule confirmation. Sur ordinateur, Ctrl (⌘) + clic ajoute les sessions une par une et Maj + clic en prend toute une plage.',
        ...
        { id: 'hud', t: 'HUD de stats sur les sièges',
          b: ['Le HUD attache une petite boîte de statistiques à côté du siège de chaque joueur, construite à partir des mains que tu as enregistrées dans tes journaux : nombre de mains observées, puis VPIP (fréquence à laquelle il met volontairement de l\u2019argent pre-flop), PFR (relances pre-flop) et AF (facteur d\u2019agressivité), avec un code couleur du passif à l\u2019agressif. En dessous, un badge résume le joueur en toutes lettres \u2014 Serré-Passif, Large-Agressif, etc. \u2014 à côté d\u2019un petit cadran dont le quadrant allumé se lit de gauche à droite du serré au large, et de bas en haut du passif à l\u2019agressif. Le badge apparaît dès la première main mais reste atténué tant que 25 mains ne sont pas atteintes, seuil à partir duquel il devient fiable. Touche une boîte pour un popover détaillé avec tous les chiffres (3-bet, continuation bet, fold face au 3-bet, tentatives de vol, taux d\u2019abattage\u2026), et fais-la glisser si elle masque quelque chose.',
              'Le HUD ne connaît que ce que tu as vu à tes propres tables — il lit tes journaux de mains locaux, la journalisation doit donc être active et les chiffres deviennent significatifs après suffisamment de mains. Elle est désactivée par défaut : active-la dans Options avancées \u2192 Assistance.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Lecteur de musique',
          b: ['L\u2019entrée musique des menus du header ouvre un petit lecteur de musique d\u2019ambiance : choisis un morceau dans la playlist, lecture/pause, précédent/suivant, aléatoire, et répétition d\u2019un morceau, de toute la playlist ou de rien. Le volume, le morceau sélectionné et le mode de répétition sont mémorisés. La lecture ne démarre jamais toute seule — les navigateurs exigent un appui — et le lecteur est entièrement indépendant des effets sonores du jeu.', 'Deux pouces sous le titre du morceau disent si tu aimes ce qui passe. Une voix anonyme par appareil, radios comprises, et tu peux la changer ou la retirer à tout moment ; tant que l\u2019exploitant n\u2019a pas révélé les totaux, tu ne vois que ton propre pouce.', "Sur iPhone et iPad, le lecteur utilise par défaut une lecture simple, pour que la musique continue avec CarPlay, en Bluetooth ou écran verrouillé ; le volume se règle alors avec les boutons de l’appareil ou de la voiture. L’option « Volume dans l’app » rétablit le curseur de volume, la balance et le VU-mètre, mais le son peut saccader en voiture."] },
