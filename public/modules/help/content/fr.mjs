  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Langue',
          b: ['L\u2019interface est disponible en 40 langues. Change-la à tout moment dans les Options avancées (menu roue crantée), catégorie Interface utilisateur. Les termes d\u2019action du poker (Fold, Check, Call, Bet, Raise, All-In) restent en anglais par convention, exactement comme dans le client de bureau.'] },
