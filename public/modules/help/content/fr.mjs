    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Options de journalisation',
          b: ['Dans Options avancées \u2192 Messages de log, tu peux activer ou couper la journalisation et choisir l\u2019intervalle d\u2019écriture (après chaque action, ou une fois par main), comme dans les réglages du client de bureau. Une option supplémentaire écrit le fichier .pdb directement dans un dossier de ton choix et le met à jour après chaque main — exactement comme le fait le client de bureau, pour que d\u2019autres outils puissent le lire en direct.'],
          note: 'L\u2019écriture dans un dossier local nécessite l\u2019API File System Access : Chrome et Edge de bureau uniquement. Firefox, Safari et les navigateurs mobiles ne le peuvent pas — l\u2019option affiche alors une courte explication, et l\u2019export manuel depuis la fenêtre Logs reste disponible partout.' },
    ...
    },
    {
      ...
      sections: [
        { id: 'list', t: 'La liste des parties',
          b: ['Le lobby liste toutes les tables du serveur avec leur couleur d\u2019état : vert = ouverte (tu peux rejoindre), orange = en cours, jaune = pleine, rouge = fermée. Les filtres réduisent la liste (ouvertes, sans mot de passe, en direct, classées) et le champ de recherche trouve une partie par son nom. La pastille des joueurs ouvre la liste de tous les connectés, cherchable et triable.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'fkeys', t: 'Raccourcis clavier officiels',
          b: ['Les touches de fonction officielles de PokerTH fonctionnent pendant une partie :'],
          keys: [
