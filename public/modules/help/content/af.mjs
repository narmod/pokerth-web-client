    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Tafelzoem (fone)',
          b: ['Op klein skerms vergroot die vergrootglasknoppies die tafel (2\u00d7) en jy kan dit met jou vinger sleep — net die aksiebalk bly staan; jou eie blokkie word ook vergroot en die aansig keer daarheen terug wanneer dit jou beurt is. Die aansig volg die aktiewe sitplek outomaties en zoem by showdown uit vir die oorsig. In Gevorderde opsies afskakelbaar.'],
