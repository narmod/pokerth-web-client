  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Gesinsranglys',
          b: ['Slegs op private bedieners en in LAN-spelle hou die kliënt saamgestelde statistieke per bynaam — hande en spelle wat gespeel en gewen is, grootste wins, beste reeks — en deel dit deur die bediener, sodat elke toestel om die tafel dieselfde ranglys sien. pokerth.net-spelle word nooit so nagespoor nie, en die oefenmodus se statistieke bly heeltemal apart.', 'In hierdie speletjies maak die trofee-knoppie die ranglysvenster op sy LAN-oortjie oop: alle spelers, sorteerbaar volgens verskeie kriteria.'] },
        { id: 'language', t: 'Taal',
          b: ['Die koppelvlak is in 81 tale beskikbaar. Verander dit enige tyd in Gevorderde opsies (die ratkieslys), kategorie Gebruikerskoppelvlak. Poker se aksieterme (Fold, Check, Call, Bet, Raise, All-In) bly volgens konvensie Engels, presies soos in die werkskermkliënt.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Tafelzoem (fone)',
          b: ['Op klein skerms vergroot die vergrootglasknoppies die tafel (2\u00d7) en jy kan dit met jou vinger sleep — net die aksiebalk bly staan; jou eie blokkie word ook vergroot en die aansig keer daarheen terug wanneer dit jou beurt is. Die aansig volg die aktiewe sitplek outomaties en zoem by showdown uit vir die oorsig. In Gevorderde opsies afskakelbaar. Op jou beurt, as die gemeenskaplike kaarte buite sig is, verskyn \u2019n klein kopie daarvan bo-aan die tafel; tik daarop om na die kaarte en terug te spring.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Musiekspeler',
          b: ['Die musiekinskrywing in die kopstukkieslyste maak \u2019n klein agtergrondmusiekspeler oop: kies \u2019n snit uit die speellys, speel/wag, vorige/volgende, skommel, en herhaal een snit, die hele lys of niks. Volume, gekose snit en herhaalmodus word onthou. Die weergawe begin nooit vanself nie — blaaiers vereis \u2019n tik — en die speler is heeltemal onafhanklik van die spel se klankeffekte.', 'Twee duime onder die snittitel se of jy hou van wat speel. Een anonieme stem per toestel, radiostasies ingesluit, en jy kan dit enige tyd verander of terugtrek; tensy die operateur die totale wys, sien jy net jou eie duim.', "Op iPhone en iPad gebruik die speler by verstek gewone terugspeel, sodat die musiek aanhou speel met CarPlay, Bluetooth of ’n geslote skerm; die volume word dan met die toestel of motor se knoppies gestel. Die opsie “Volume in die app” bring die volumeskuif, die balans en die VU-meter terug, maar die klank kan in die motor hakkel."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Waar die opsies bly',
          b: ['Gevorderde opsies word deur die ratinskrywing in enige kopstukkieslys oopgemaak. Hulle is soos in die werkskermkliënt gegroepeer: Gebruikerskoppelvlak, Styl, Klank, Plaaslike spel, Netwerkspel, Internetspel, Byname / Avatars, Logboodskappe, en Rugsteun en herstel. Elke webspesifieke funksie het daar sy eie skakelaar, sodat jy alles kan afskakel wat jy nie gebruik nie.'] },
        { id: 'cfgxml', t: 'Ruil instellings met die werkskermkliënt',
          b: ['Jou instellings kan tussen kliënte reis: die kategorie Rugsteun en herstel bied uitvoer/invoer van die amptelike config.xml-lêer (daardie \u007e/.pokerth/config.xml wat die werkskerm- en QML-kliënte gebruik). Die uitvoer skryf die gedeelde instellings — naam, vertoonopsies, klanke, tafelvoorkeure, blinds, style — en die invoer pas \u2019n lêer van die werkskerm hier toe. Instellings wat hierdie kliënt nie ken nie, bly onaangeraak in die lêer.', 'Jou spelernotas reis ook saam met die lêer — die teks en die stertelling, geskryf soos die rekenaarkliënte dit lees. Die kleuretikette bly in hierdie kliënt: die amptelike formaat het geen veld daarvoor nie, dus raak \u2019n invoer joune nooit aan nie.'] },
