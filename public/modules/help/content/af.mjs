  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Taal',
          b: ['Die koppelvlak is in 47 tale beskikbaar. Verander dit enige tyd in Gevorderde opsies (die ratkieslys), kategorie Gebruikerskoppelvlak. Poker se aksieterme (Fold, Check, Call, Bet, Raise, All-In) bly volgens konvensie Engels, presies soos in die werkskermkliënt.'] },
