    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Logopsies',
          b: ['In Gevorderde opsies \u2192 Logboodskappe kan jy opname aan- of afskakel en die skryfinterval kies (ná elke aksie, of een keer per hand), soos in die werkskermkliënt se instellings. \u2019n Bykomende opsie skryf die .pdb-lêer direk na \u2019n vouer van jou keuse en werk dit ná elke hand by — presies soos die werkskermkliënt doen, sodat ander gereedskap dit lewendig kan lees.'],
          note: 'Om na \u2019n plaaslike vouer te skryf, vereis die File System Access-API: slegs werkskerm-Chrome en -Edge. Firefox, Safari en mobiele blaaiers kan nie — die opsie wys dan \u2019n kort verduideliking, en die handmatige uitvoer uit die Logs-venster bly oral beskikbaar.' },
        ...
        { id: 'hud', t: 'Statistiek-HUD by die sitplekke (beta)',
          b: ['Die HUD heg \u2019n klein statistiekblokkie langs elke speler se sitplek, gebou uit die hande wat in jou logs opgeneem is: aantal waargenome hande, dan VPIP (hoe gereeld hy vrywillig geld pre-flop insit), PFR (pre-flop-verhogings), AF (aggressiefaktor), 3B (3-bet), CB (continuation bet) en F3B (fold teen \u2019n 3-bet), met kleurkodes van passief tot aggressief. Tik \u2019n blokkie vir \u2019n uitvoerige opspringer met meer syfers (steelpogings, fold teen steal, showdownkoerse\u2026), en sleep dit as dit iets bedek.',
              'Die HUD ken slegs wat jy by jou eie tafels gesien het — dit lees jou plaaslike handlogs, dus moet opname aan wees, en die syfers word eers ná genoeg hande sinvol. Dit is \u2019n beta-funksie, by verstek af: skakel dit aan in Gevorderde opsies \u2192 Hulp.'] },
      ...
      sections: [
        ...
        { id: 'cups', t: 'Die gemeenskapsbekers: BBC en WeCup',
          b: ['Twee gemeenskappe hou hul eie kompetisies op pokerth.net, elk met sy eie webwerf en sy eie ranglys. Die Best Brainies Cup (BBC) is \u2019n trapkompetisie wat in 2013 ontstaan het: mens werk jou van Step 1 tot Step 4 op, en \u2019n nuwe seisoen begin ná elke Step 4-spel, wanneer die beker oorhandig word. Die WeCup (WEC) het sy eie, veel wyer skaal — 75 punte vir die eerste plek, dan 45, 30, 20… — en sy telling normaliseer jou gemiddeld aan die hand van hoeveel spele jy gespeel het in vergelyking met die ander lede.',
              'Albei ranglyste open by die beker-knoppie, langs die PokerTH-ranglys. Die tafelinstellings van hierdie kompetisies kom as voorafinstellings wanneer jy \u2019n spel skep (BBC Step 1 tot 4, WEC en WEC Grand Final), sodat jy onder dieselfde toestande kan oefen. Deelname verg registrasie op die webwerf van die betrokke beker.'],
