    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'journal', t: 'Registros de mãos e a janela \u201cLogs\u201d',
          b: ['Além do histórico ao vivo, cada mão que você joga é gravada localmente no navegador, no mesmo formato dos arquivos de log .pdb do cliente oficial. A janela Logs (Opções avançadas \u2192 Mensagens de log \u2192 Gerenciar logs\u2026) lista suas sessões e deixa você trabalhar com elas: visualizar uma sessão com busca e destaque, filtrar por partida, exportar em HTML ou texto simples, salvar o arquivo .pdb bruto, ou importar um .pdb gravado pelo cliente de desktop. As sessões são apagadas uma a uma ou todas de uma vez (com confirmação), e uma retenção automática pode manter só os últimos 7, 30, 90, 180 ou 365 dias. Os registros que você importa nunca são removidos automaticamente.',
