  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Idioma',
          b: ['A interface está disponível em 59 idiomas. Troque a qualquer momento nas Opções avançadas (menu da engrenagem), categoria Interface do usuário. Os termos de ação do pôquer (Fold, Check, Call, Bet, Raise, All-In) permanecem em inglês por convenção, exatamente como no cliente de desktop.'] },
