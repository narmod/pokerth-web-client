  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Lugha',
          b: ['Kiolesura kinapatikana kwa lugha 58. Kibadilishe wakati wowote kwenye chaguo za kina (menyu ya gia) chini ya Kiolesura cha mtumiaji. Maneno ya hatua za poker (Fold, Check, Call, Bet, Raise, All-In) hubaki kwa Kiingereza kwa desturi, sawasawa na kiteja cha kompyuta.'] },
