  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Orodha ya familia',
          b: ['Kwenye seva binafsi na michezo ya LAN pekee, kiteja huweka takwimu za maisha kwa kila jina la utani \u2014 mikono na michezo iliyochezwa na kushindwa, ushindi mkubwa zaidi, mfululizo bora \u2014 na kuzishiriki kupitia seva ili kila kifaa mezani kione orodha moja. Michezo ya pokerth.net haifuatiliwi hivi kamwe, na takwimu za hali ya mazoezi huhifadhiwa tofauti kabisa.', 'Katika michezo hii, kitufe cha kombe hufungua dirisha la viwango kwenye kichupo cha LAN: wachezaji wote, wanaoweza kupangwa kwa vigezo kadhaa.'] },
        { id: 'language', t: 'Lugha',
          b: ['Kiolesura kinapatikana kwa lugha 81. Kibadilishe wakati wowote kwenye chaguo za kina (menyu ya gia) chini ya Kiolesura cha mtumiaji. Maneno ya hatua za poker (Fold, Check, Call, Bet, Raise, All-In) hubaki kwa Kiingereza kwa desturi, sawasawa na kiteja cha kompyuta.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Kukuza meza (simu)',
          b: ['Kwenye skrini ndogo, vitufe vya kikuza hukuza meza (2\u00d7) na unaweza kusogeza kwa kidole \u2014 ni upau wa hatua pekee unaobaki mahali; kisanduku chako mwenyewe pia hukuzwa na mwonekano hurudi kwake zamu yako inapofika. Mwonekano hufuata kiti kinachocheza kiotomatiki na hupunguza kukuza kwenye showdown kwa muhtasari. Inaweza kuzimwa kwenye chaguo za kina. Zamu yako inapofika na karata za pamoja ziko nje ya mwonekano, nakala ndogo ya karata hizo huonekana juu ya meza; iguse ili kwenda kwenye karata na kurudi.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Kumbukumbu za mikono na dirisha la Kumbukumbu',
          b: ['Mbali na kumbukumbu ya moja kwa moja, kila mkono unaocheza hurekodiwa ndani ya kivinjari chako, kwa muundo uleule wa faili la kumbukumbu la .pdb la kiteja rasmi. Dirisha la Kumbukumbu (chaguo za kina \u2192 Jumbe za kumbukumbu \u2192 Simamia kumbukumbu\u2026) huorodhesha vipindi vyako na kukuruhusu kuvifanyia kazi: hakiki kipindi na utafutaji na uangaziaji, chuja kwa mchezo, hamisha kama HTML au maandishi matupu, hifadhi faili la .pdb ghafi, au ingiza .pdb lililorekodiwa na kiteja cha kompyuta. Vipindi vinaweza kufutwa kimoja kimoja au vyote pamoja (na uthibitisho), na mpangilio wa uhifadhi wa kiotomatiki unaweza kubaki na siku 7, 30, 90, 180 au 365 za mwisho pekee. Kumbukumbu ulizoziingiza mwenyewe haziondolewi kamwe kiotomatiki. Mpangilio wa pili huweka kikomo cha idadi ya vipindi vinavyohifadhiwa, na safu ya orodha inaweza kuburutwa kuwa pana zaidi.',
              'Ili kusafisha vipindi kadhaa kwa mara moja, kitufe cha Chagua… huonyesha kisanduku cha kuteua kwenye kila kipengee: teua visivyohitajika kisha Futa huondoa kundi zima baada ya uthibitisho mmoja tu. Kwenye kompyuta, Ctrl (⌘) + bofya huongeza vipindi kimoja baada ya kingine, na Shift + bofya huchukua mfululizo mzima.',
        ...
        { id: 'hud', t: 'HUD ya takwimu kwenye viti',
          b: ['HUD huambatanisha kisanduku kidogo cha takwimu kando ya kiti cha kila mchezaji, kilichojengwa kutoka mikono uliyorekodi kwenye kumbukumbu zako: idadi ya mikono iliyoangaliwa, kisha VPIP (mara ngapi wanaweka pesa kwa hiari pre-flop), PFR (raise za pre-flop) na AF (kipimo cha ushambuliaji), na msimbo wa rangi kutoka mtulivu hadi mshambuliaji. Chini yake beji hufupisha mchezaji kwa maneno rahisi \u2014 Mkali-Mtulivu, Huru-Mshambuliaji na kadhalika \u2014 kando ya kipimo kidogo ambacho robo yake inayowaka husomwa kushoto-kwenda-kulia kwa mkali hadi huru, na chini-kwenda-juu kwa mtulivu hadi mshambuliaji. Beji huonekana kutoka mkono wa kwanza kabisa lakini hubaki imefifia hadi mikono 25, inapokuwa ya kuaminika. Gusa kisanduku kwa dirisha dogo la maelezo lenye seti kamili ya nambari (3-bet, continuation bet, fold to 3-bet, majaribio ya steal, kiwango cha showdown\u2026), na buruta kisanduku kukisogeza kikifunika kitu.',
              'HUD hujua tu ulichokiona kwenye meza zako mwenyewe \u2014 husoma kumbukumbu zako za ndani za mikono, hivyo uwekaji kumbukumbu lazima uwe umewashwa na nambari huwa na maana baada ya mikono ya kutosha. Kimezimwa kwa chaguo-msingi: kiwashe kwenye chaguo za kina \u2192 Msaidizi.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Kichezaji muziki',
          b: ['Kiingilio cha muziki kwenye menyu za kichwa hufungua kichezaji kidogo cha muziki wa starehe: chagua wimbo kutoka orodha, cheza/simamisha, iliyotangulia/ifuatayo, changanya, na rudia wimbo mmoja, orodha nzima au usirudie. Kiwango, wimbo uliochaguliwa na hali ya kurudia hukumbukwa. Uchezaji hauanzi wenyewe kamwe \u2014 vivinjari vinahitaji mguso \u2014 na kichezaji ni huru kabisa na athari za sauti za mchezo.', 'Vidole gumba viwili chini ya jina la wimbo vinasema kama unapenda kinachochezwa. Kura moja isiyo na jina kwa kila kifaa, redio zikijumuishwa, na waweza kuibadilisha au kuiondoa wakati wowote; hadi msimamizi atakapoonyesha jumla, unaona kura yako pekee.', "Kwenye iPhone na iPad kichezaji hutumia uchezaji wa kawaida kwa chaguo-msingi, ili muziki uendelee na CarPlay, Bluetooth au skrini iliyofungwa; sauti hurekebishwa kwa vitufe vya kifaa au vya gari. Chaguo “Sauti ndani ya programu” hurudisha kitelezi cha sauti, mizani na mita ya VU, lakini sauti inaweza kukatika-katika ndani ya gari."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Chaguo zipo wapi',
          b: ['Chaguo za kina hufunguka kutoka kiingilio cha gia cha menyu yoyote ya kichwa. Zimepangwa kama kiteja cha kompyuta: Kiolesura cha mtumiaji, Mtindo, Sauti, Mchezo wa ndani, Mchezo wa mtandao, Mchezo wa intaneti, Majina ya utani / Avatari, Jumbe za kumbukumbu, na Hifadhi na kuweka upya. Kila kipengele maalum cha wavuti kina swichi yake hapo, hivyo unaweza kuzima chochote usichotumia.'] },
        { id: 'cfgxml', t: 'Kubadilishana mipangilio na kiteja cha kompyuta',
          b: ['Mipangilio yako inaweza kusafiri kati ya viteja: sehemu ya Hifadhi na kuweka upya inatoa uhamishaji/uingizaji wa faili rasmi la config.xml (\u007e/.pokerth/config.xml linalotumiwa na viteja vya kompyuta na QML). Uhamishaji huandika mipangilio inayoshirikiwa \u2014 jina, chaguo za maonyesho, sauti, mapendeleo ya meza, blind, mitindo \u2014 na uingizaji hutumia faili la kompyuta hapa. Mipangilio isiyojulikana na kiteja hiki hubaki kwenye faili bila kuguswa.', 'Madokezo yako kuhusu wachezaji husafiri pamoja na faili pia — maandishi na ukadiriaji wa nyota, yakiandikwa jinsi programu za kompyuta zinavyoyasoma. Lebo za rangi hubaki katika programu hii: muundo rasmi hauna nafasi kwa ajili yake, hivyo kuingiza faili hakuzigusi kamwe.'] },
