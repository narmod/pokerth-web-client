  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Dil',
          b: ['Arayüz 72 dilde mevcut. İstediğin an Gelişmiş seçeneklerden (dişli menüsü), Kullanıcı arayüzü kategorisinden değiştirebilirsin. Poker aksiyon terimleri (Fold, Check, Call, Bet, Raise, All-In) gelenek gereği İngilizce kalır — masaüstü istemcideki gibi.'] },
