    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'journal', t: 'El günlükleri ve \u201cGünlükler\u201d penceresi',
          b: ['Canlı günlüğün ötesinde, oynadığın her el resmi istemcinin .pdb günlük dosyalarıyla aynı biçimde tarayıcına yerel olarak kaydedilir. Günlükler penceresi (Gelişmiş seçenekler \u2192 Günlük mesajları \u2192 Günlükleri yönet\u2026) oturumlarını listeler ve onlarla çalışmanı sağlar: arama ve vurgulamayla bir oturumu önizlemek, oyuna göre süzmek, HTML veya düz metin olarak dışa aktarmak, ham .pdb dosyasını kaydetmek ya da masaüstü istemcinin kaydettiği bir .pdb\u2019yi içe aktarmak. Oturumlar tek tek veya hepsi birden silinir (onayla) ve otomatik saklama ayarı yalnızca son 7, 30 veya 90 günü tutabilir.',
        ...
        { id: 'logopts', t: 'Günlük seçenekleri',
          b: ['Gelişmiş seçenekler \u2192 Günlük mesajlarında kaydı açıp kapatabilir ve yazma aralığını (her aksiyondan sonra veya elde bir kez) seçebilirsin — masaüstü istemci ayarlarındaki gibi. Ek bir seçenek .pdb dosyasını doğrudan seçtiğin bir klasöre yazar ve her elden sonra günceller — tıpkı masaüstü istemcinin yaptığı gibi; böylece başka araçlar onu canlı okuyabilir.'],
          note: 'Yerel bir klasöre yazmak File System Access API gerektirir: yalnızca masaüstü Chrome ve Edge. Firefox, Safari ve mobil tarayıcılar yapamaz — o zaman seçenek kısa bir açıklama gösterir ve Günlükler penceresinden elle dışa aktarma her yerde kullanılabilir kalır.' },
        ...
        { id: 'hud', t: 'Koltuklarda istatistik HUD\u2019u (beta)',
          b: ['HUD, her oyuncunun koltuğunun yanına, günlüklerine kaydettiğin ellerden kurulan küçük bir istatistik kutusu iliştirir: gözlemlenen el sayısı, sonra VPIP (pre-flop ne sıklıkla gönüllü para koyduğu), PFR (pre-flop yükseltmeler), AF (agresiflik katsayısı), 3B (3-bet), CB (continuation bet) ve F3B (3-bet\u2019e fold) — pasiften agresife renk kodlu. Bir kutuya dokununca daha fazla sayının olduğu ayrıntılı bir açılır pencere gelir (çalma denemeleri, çalmaya fold, showdown oranları\u2026); bir şeyi kapatıyorsa sürükleyebilirsin.',
      ...
      sections: [
        ...
        { id: 'cups', t: 'Topluluk kupaları: BBC ve WeCup',
          b: ['İki topluluk pokerth.net üzerinde kendi turnuvalarını düzenler, her biri kendi sitesi ve kendi sıralamasıyla. Best Brainies Cup (BBC) 2013\u2019te doğmuş bir basamak turnuvasıdır: Step 1\u2019den Step 4\u2019e yükselirsin ve her Step 4 oyunundan sonra, kupa verildiğinde yeni bir sezon başlar. WeCup\u2019ın (WEC) kendi cetveli vardır, çok daha geniş yayılmış — birinciye 75 puan, sonra 45, 30, 20… — ve score\u2019u, diğer üyelerle karşılaştırıldığında oynadığın oyun sayısına göre ortalamanı normalleştirir.',
              'Her iki sıralama da PokerTH sıralamasının yanındaki kupa düğmesinden açılır. Bu turnuvaların masa ayarları, oyun oluştururken hazır ayar olarak gelir (BBC Step 1– 4, WEC ve WEC Grand Final), böylece aynı koşullarda çalışabilirsin. Katılmak için ilgili kupanın sitesine kaydolmak gerekir.'],
