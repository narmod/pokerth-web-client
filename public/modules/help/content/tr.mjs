  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Dil',
          b: ['Arayüz 78 dilde mevcut. İstediğin an Gelişmiş seçeneklerden (dişli menüsü), Kullanıcı arayüzü kategorisinden değiştirebilirsin. Poker aksiyon terimleri (Fold, Check, Call, Bet, Raise, All-In) gelenek gereği İngilizce kalır — masaüstü istemcideki gibi.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Masa yakınlaştırma (telefonlar)',
          b: ['Küçük ekranlarda büyüteç düğmeleri masayı büyütür (2\u00d7) ve parmağınla kaydırabilirsin — yalnızca aksiyon çubuğu sabit kalır; kendi kutun da büyütülür ve sıra sana geldiğinde görünüm ona döner. Görünüm etkin koltuğu otomatik izler ve showdown\u2019da genel bakış için uzaklaşır. Gelişmiş seçeneklerden kapatılabilir. Sıra sendeyken ortak kartlar görünümün dışındaysa, masanın üstünde küçük bir kopyaları belirir; kartlara gidip geri dönmek için ona dokun.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'El günlükleri ve \u201cGünlükler\u201d penceresi',
          b: ['Canlı günlüğün ötesinde, oynadığın her el resmi istemcinin .pdb günlük dosyalarıyla aynı biçimde tarayıcına yerel olarak kaydedilir. Günlükler penceresi (Gelişmiş seçenekler \u2192 Günlük mesajları \u2192 Günlükleri yönet\u2026) oturumlarını listeler ve onlarla çalışmanı sağlar: arama ve vurgulamayla bir oturumu önizlemek, oyuna göre süzmek, HTML veya düz metin olarak dışa aktarmak, ham .pdb dosyasını kaydetmek ya da masaüstü istemcinin kaydettiği bir .pdb\u2019yi içe aktarmak. Oturumlar tek tek veya hepsi birden silinir (onayla) ve otomatik saklama ayarı yalnızca son 7, 30, 90, 180 veya 365 günü tutabilir. Kendi içe aktardığınız kayıtlar asla otomatik olarak silinmez. İkinci bir ayar kaç oturumun saklanacağını sınırlar ve liste sütunu sürüklenerek genişletilebilir.',
              'Birden fazla oturumu tek seferde temizlemek için Seç… düğmesi her kaydın yanına bir kutucuk koyar: gereksizleri işaretleyin, Sil tek bir onaydan sonra tüm grubu kaldırsın. Bilgisayarda Ctrl (⌘) + tıklama oturumları teker teker ekler, Shift + tıklama ise bütün bir aralığı seçer.',
        ...
        { id: 'hud', t: 'Koltuklarda istatistik HUD\u2019u',
          b: ['HUD, her oyuncunun koltuğunun yanına küçük bir istatistik kutusu iliştirir; kutu, günlüklerinde kaydettiğin ellerden oluşturulur: gözlenen el sayısı, ardından VPIP (pre-flop\u2019ta ne sıklıkta gönüllü para koyduğu), PFR (pre-flop yükseltmeleri) ve AF (agresiflik katsayısı), pasiften agresife renk kodlu. Altlarında bir rozet oyuncuyu kelimelerle özetler \u2014 Sıkı-Pasif, Gevşek-Agresif vb. \u2014 yanındaki küçük kadranın yanan çeyreği soldan sağa sıkıdan gevşeğe, aşağıdan yukarıya pasiften agresife okunur. Rozet daha ilk elden itibaren görünür ama 25 ele kadar soluk kalır; oradan sonra güvenilir olur. Tüm sayıları içeren ayrıntılı bir açılır pencere için bir kutuya dokun (3-bet, continuation bet, 3-bet\u2019e fold, çalma denemeleri, showdown oranları\u2026), bir şeyi kapatıyorsa kutuyu sürükle.',
              'HUD yalnızca kendi masalarında gördüklerini bilir — yerel el günlüklerini okur, dolayısıyla kayıt açık olmalı ve sayılar yeterince elden sonra anlam kazanır. Varsayılan olarak kapalıdır: Gelişmiş seçenekler \u2192 Asistan\u2019dan aç.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Müzik çalar',
          b: ['Başlık menülerindeki müzik girdisi küçük bir ortam müziği çaları açar: çalma listesinden parça seç, çal/duraklat, önceki/sonraki, karışık ve tek parça, tüm liste ya da hiç tekrarı. Ses düzeyi, seçili parça ve tekrar modu hatırlanır. Çalma asla kendiliğinden başlamaz — tarayıcılar bir dokunuş ister — ve çalar, oyun ses efektlerinden tamamen bağımsızdır.', 'Parça başlığının altındaki iki başparmak, çalan parçayı beğenip beğenmediğini söyler. Radyolar dahil, cihaz başına tek bir anonim oy; istediğin zaman değiştirebilir ya da geri alabilirsin. İşletmeci toplamları göstermediği sürece yalnızca kendi oyunu görürsün.', "iPhone ve iPad’de oynatıcı varsayılan olarak yalın oynatmayı kullanır; böylece müzik CarPlay, Bluetooth veya kilitli ekranda çalmaya devam eder ve ses düzeyi cihazın ya da arabanın düğmeleriyle ayarlanır. “Uygulama içi ses düzeyi” seçeneği ses kaydırıcısını, dengeyi ve VU göstergesini geri getirir, ancak ses arabada takılabilir."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Seçenekler nerede yaşar',
          b: ['Gelişmiş seçenekler, herhangi bir başlık menüsünün dişli girdisinden açılır. Masaüstü istemcideki gibi gruplanmıştır: Kullanıcı arayüzü, Stil, Ses, Yerel oyun, Ağ oyunu, İnternet oyunu, Takma adlar / Avatarlar, Günlük mesajları ve Yedekleme ve sıfırlamaı geri yükle. Web\u2019e özgü her özelliğin orada kendi anahtarı vardır; kullanmadığın her şeyi kapatabilirsin.'] },
        { id: 'cfgxml', t: 'Masaüstü istemciyle ayar alışverişi',
          b: ['Ayarların istemciler arasında yolculuk edebilir: Yedekleme ve sıfırlama kategorisi resmi config.xml dosyasının (masaüstü ve QML istemcilerin kullandığı \u007e/.pokerth/config.xml) dışa/içe aktarımını sunar. Dışa aktarma ortak ayarları yazar — ad, görüntü seçenekleri, sesler, masa tercihleri, blindler, stiller — içe aktarma ise masaüstünden bir dosyayı buraya uygular. Bu istemcinin bilmediği ayarlar dosyada dokunulmadan korunur.', 'Oyuncu notların da dosyayla birlikte yolculuk eder — notun metni ve yıldız değerlendirmesi, masaüstü istemcilerin okuduğu biçimde yazılır. Renk etiketleri bu istemcide kalır: resmî biçimde onlar için bir alan yok, bu yüzden içe aktarma onlara asla dokunmaz.'] },
