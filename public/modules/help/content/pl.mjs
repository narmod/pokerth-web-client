    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Opcje dziennika',
          b: ['W Opcje zaawansowane \u2192 Komunikaty dziennika możesz włączyć lub wyłączyć zapisywanie i wybrać interwał zapisu (po każdej akcji albo raz na rękę), jak w ustawieniach klienta desktopowego. Dodatkowa opcja zapisuje plik .pdb bezpośrednio do wybranego folderu i aktualizuje go po każdej ręce — dokładnie jak klient desktopowy, żeby inne narzędzia mogły go czytać na żywo.'],
          note: 'Zapis do lokalnego folderu wymaga API File System Access: tylko desktopowy Chrome i Edge. Firefox, Safari i przeglądarki mobilne tego nie potrafią — opcja pokazuje wtedy krótkie wyjaśnienie, a ręczny eksport z okna Logi pozostaje dostępny wszędzie.' },
        ...
        { id: 'hud', t: 'HUD statystyk przy miejscach (beta)',
          b: ['HUD dokleja małe pole statystyk obok miejsca każdego gracza, zbudowane z rąk zapisanych w twoich dziennikach: liczba zaobserwowanych rąk, potem VPIP (jak często dobrowolnie wkłada pieniądze pre-flop), PFR (przebicia pre-flop), AF (współczynnik agresji), 3B (3-bet), CB (continuation bet) i F3B (fold na 3-bet), z kolorami od pasywnego po agresywne. Dotknij pola, by zobaczyć szczegółowy dymek z większą liczbą danych (próby kradzieży, fold na kradzież, wskaźniki showdownów\u2026), a przeciągnij pole, jeśli coś zasłania.',
      ...
      sections: [
        ...
        { id: 'cups', t: 'Puchary społeczności: BBC i WeCup',
          b: ['Dwie społeczności prowadzą na pokerth.net własne rozgrywki, każda z własną stroną i własnym rankingiem. Best Brainies Cup (BBC) to turniej etapowy powstały w 2013 roku: przechodzi się od Step 1 do Step 4, a nowy sezon zaczyna się po każdej grze Step 4, gdy puchar zostaje wręczony. WeCup (WEC) ma własną punktację, znacznie szerszą — 75 punktów za pierwsze miejsce, potem 45, 30, 20… — a jego score normalizuje twoją średnią względem liczby gier, które rozegrałeś w porównaniu z innymi członkami.',
              'Oba rankingi otwierasz przyciskiem pucharu, obok rankingu PokerTH. Ustawienia stołów tych rozgrywek są dostępne jako gotowe zestawy przy tworzeniu gry (BBC Step 1 do 4, WEC i WEC Grand Final), więc możesz trenować w tych samych warunkach. Udział wymaga rejestracji na stronie danego pucharu.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'fkeys', t: 'Oficjalne skróty klawiszowe',
          b: ['Oficjalne klawisze funkcyjne PokerTH działają podczas gry:'],
          keys: [
