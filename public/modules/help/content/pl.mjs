  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Język',
          b: ['Interfejs jest dostępny w 61 językach. Zmień go w każdej chwili w Opcjach zaawansowanych (menu z zębatką), kategoria Interfejs użytkownika. Pokerowe terminy akcji (Fold, Check, Call, Bet, Raise, All-In) pozostają po angielsku zgodnie z konwencją, dokładnie tak jak w kliencie desktopowym.'] },
