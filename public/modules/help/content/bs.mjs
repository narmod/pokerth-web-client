// ── help/content/bs.mjs — Bosanski korpus pomoći ────────────────────────────
  ...
  chapters: [
    {
      ...
      sections: [
        { id: 'modes', t: 'Tri načina igranja',
          ...
          list: [
            'Internet — igraj online na službenom serveru pokerth.net, s ljestvicama. Potreban je pokerth.net račun; registracija na pokerth.net je besplatna.',
            'Lokalno / trening — igraj offline protiv botova. Ništa za postavljanje, radi bez veze i otključava trofeje kako napreduješ.',
            'LAN / namjenski server — spoji se na privatni PokerTH server u svojoj lokalnoj mreži ili na vlastitom računaru.'] },
        { id: 'lan', t: 'LAN / namjenski server',
          b: ['Treći način spaja se na bilo koji PokerTH server koji vodiš ti ili prijatelj — u kućnoj mreži, na privatnom VPS-u, bilo gdje. Unesi adresu i port servera, označi TLS ako server koristi šifrirani port i prijavi se nadimkom (gostujuća prijava radi ako je server dopušta). Za stolom se potom sve ponaša točno kao na službenom serveru.'] },
        { id: 'famboard', t: 'Obiteljska ljestvica',
          b: ['Samo na privatnim serverima i u LAN igrama klijent čuva kumulativne statistike po nadimku — odigrane i dobivene ruke i partije, najveći dobitak, najbolji niz — i dijeli ih preko servera, tako da svaki uređaj oko stola vidi istu ljestvicu. Igre na pokerth.net nikad se ne prate na taj način, a statistike trening načina drže se potpuno odvojeno.', 'U tim igrama gumb s peharom otvara prozor ljestvica na kartici LAN: svi igrači, s razvrstavanjem prema nekoliko kriterija.'] },
        { id: 'language', t: 'Jezik',
          b: ['Interfejs je dostupan na 77 jezika. Promijeni ga bilo kada u Naprednim opcijama (meni sa zupčanikom), kategorija Korisničko interfejs. Pokerski izrazi za akcije (Fold, Check, Call, Bet, Raise, All-In) ostaju na engleskom prema konvenciji, točno kao u desktop klijentu.'] },
        { id: 'pwa', t: 'Instaliraj kao aplikaciju',
          b: ['Ovaj klijent je Progressive Web App: možeš ga instalirati iz menia pregledača (ili gumbom za instalaciju u zaglavlju) i dobiti aplikaciju preko cijelog zaslona s vlastitom ikonom. Nakon instalacije pokreće se trenutačno, a trening način radi potpuno offline.'],
          note: 'Na Androidu i u Chromeu/Edgeu na računaru gumb za instalaciju obavlja sve. Na iPhoneu/iPadu Apple dopušta instalaciju samo kroz Safari: gumb Dijeli \u2192 \u201eDodaj na početni zaslon\u201c — klijent prikazuje te korake kad je potrebno. Gumb nestaje čim je aplikacija instalirana.' },
        { id: 'platforms', t: 'Platforme i preglednici',
          b: ['Klijent radi u svakom modernom pregledaču na svakom sustavu — Windows, macOS, Linux, Android, iOS. Nekoliko funkcija oslanja se na novije API-je pregledača; kad API nedostaje, funkcija se sakrije ili objasni situaciju umjesto da se pokvari. Glavne razlike koje treba znati:'],
          list: [
            'Chrome / Edge (računar): sve radi, uključujući zapisivanje .pdb dnevnika u mapu.',
        ...
        { id: 'avatar', t: 'Nadimak i avatar',
          b: ['Odaberi nadimak i avatar na zaslonu za prijavu prije spajanja. Na pokerth.net nadimak je ime tvog računa; avatari se dijele s drugim igračima preko avatar-servera.', 'Tvoj avatar šalje se pri spajanju i svi igrači vide upravo njega. Ako ga promijeniš dok si spojen, novi avatar vrijedi od sljedećeg spajanja. Početno slovo (Aa) ne šalje se: ostali igrači vide zadani avatar.'] }
      ]
    },
    {
      ...
      sections: [
        ...
        { id: 'actions', t: 'Šta možeš uraditi kad si na potezu',
          list: [
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'automodes', t: 'Automatski načini',
          b: ['Padajući meni pokraj gumba akcija nudi tri načina igre: Ručni, Auto Check/Call i Auto Check/Fold. Automatski načini igraju umjesto tebe dok se ne vratiš — svaki ručni klik na akciju odmah vraća Ručni način.'] },
        ...
        { id: 'zoom', t: 'Zumiranje stola (telefoni)',
          ...
          note: 'Na telefonima i tabletima zumiranje štipanjem samog pregledača blokirano je prema zadanim postavkama, kako se gesta zumiranja nikad ne bi slučajno aktivirala usred ruke; ponovno je uključi u Napredne opcije \u2192 Korisničko interfejs ako ti tako više odgovara.' },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'odds', t: 'Izgledi (monitor vjerovatnosti)',
          b: ['Kartica Izgledi prikazuje za tvoju trenutnu ruku vjerovatnost uživo da završiš sa svakom od 10 kategorija ruku — od High Card do Royal Flush — svaka s ikonom, postotkom i trakom. Prikaz posivi čim odustaneš. Koristi samo tvoje karte i zajedničke: ne vidi ništa što protivnici ne pokažu.'] },
        { id: 'journal', t: 'Dnevnici ruku i prozor \u201eZapisnici\u201c',
          b: ['Osim dnevnika uživo, svaka odigrana ruka lokalno se snima u tvoj pregledač, u istom formatu kao .pdb datoteke zapisnika službenog klijenta. Prozor Zapisnici (Napredne opcije \u2192 Poruke zapisnika \u2192 Upravljanje zapisnicima\u2026) navodi tvoje sesije i omogućuje rad s njima: pregled sesije s pretraživanjem i isticanjem, filtriranje po partiji, izvoz u HTML ili obični tekst, spremanje sirove .pdb datoteke ili uvoz .pdb-a snimljenog desktop klijentom. Sesije se brišu jedna po jedna ili sve odjednom (uz potvrdu), a automatsko zadržavanje može čuvati samo zadnjih 7, 30, 90, 180 ili 365 dana. Zapisi koje sami uvezete nikada se ne brišu automatski. Druga postavka ograničava koliko se sesija čuva, a stupac s popisom može se povući širi.',
              'Za čišćenje više sesija odjednom, gumb Odaberi… prikazuje kućicu uz svaki unos: označite one koje više ne trebate i Obriši uklanja cijelu skupinu nakon jedne potvrde. Na računaru Ctrl (⌘) + klik dodaje sesije jednu po jednu, a Shift + klik uzima cijeli raspon.',
      ...
      sections: [
        ...
        { id: 'typing', t: 'Pomoć pri tipkanju',
          list: [
            ...
            '\u2191 / \u2193 listaju historiju tvojih poruka.',
        ...
        { id: 'privatemsg', t: 'Privatne poruke',
          b: ['Piši jednom igraču, a da cijelo predvorje ne čita zajedno s tobom. Koverta pored imena na popisu igrača otvara razgovor s njim; koverta u zaglavlju predvorja ponovo otvara posljednji. Razgovori se čuvaju na ovom uređaju i i dalje su tu kad se vratiš, tako da chat nastavljen danima kasnije nosi svoju vlastitu historiju — crveni broj na koverti pokazuje šta još nisi pročitao, a kanta u naslovu prozora trajno briše razgovor.'],
          keys: [
            ['/msg <nadimak> <tekst>', 'Pošalji privatnu poruku iz chata predvorja'],
            ['/msg "<nadimak sa razmacima>" <tekst>', 'Isto, kad nadimak sadrži razmake']],
          note: 'Poruke su ograničene na 128 znakova. Server ne dostavlja privatnu poruku igraču koji sjedi za stolom gdje partija teče, a historija se čuva samo u ovom pregledaču — ne prati te na drugi uređaj.' },
        ...
        { id: 'translate', t: 'Razumij sve',
          b: ['S uključenim prijevodom razgovora gumb za prijevod pojavljuje se u retku ispod pokazivača — ili u retku koji dodirneš na dodirnom zaslonu — i prikazuje poruku na tvom jeziku pomoću prevoditelja pregledača. Može se trajno prikazivati u svim recima u Napredne opcije → Razgovor, gdje živi i savjet koji objašnjava uobičajene kratice za stolom (gg, nh, utg…).'],
          note: 'Prijevod koristi uslugu Google Translate i radi u svakom pregledaču — potrebna je samo internetska veza. Poruka se šalje usluzi prijevoda tek kad dodirneš njezin gumb za prijevod, nikad automatski.' },
    ...
    },
    {
      ...
      sections: [
        { id: 'list', t: 'Popis partija',
          b: ['Predvorje navodi sve stolove servera. Svaki redak prikazuje broj igrača, vrstu partije, lokot kad je potrebna lozinka ili pozivnica, i značku stanja: \u201eČeka se\u201c (zelena — partija nije počela, možeš ući ako ima slobodnog mjesta), \u201eU tijeku\u201c (topla boja — može se gledati uživo kad su gledatelji dopušteni) i \u201eZatvorena\u201c (prigušena). Pun stol prepoznaje se jednostavno po punom brojaču, npr. 10/10; boje značaka prate aktivnu temu.',
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'rankhow', t: 'Kako se računa ljestvica',
          ...
          note: 'Bodovnu ljestvicu i točnu formulu određuje server ljestvice pokerth.net i mogu se mijenjati; mjerodavne su stranice web-mjesta.' },
        ...
        { id: 'forumcups', t: 'Kupovi foruma i događaji',
          b: ['Forum pokerth.neta ugošćuje i Monthly Cup, mjesečnu seriju u kojoj se igrači raspoređuju za stolove Gold, Silver i Bronze prije nego što se okruni prvak mjeseca, uz pojedinačne posebne kupove tijekom godine.',
              'Prijave, termini, postavke stolova i rezultati objavljuju se na forumu, a partije se igraju na službenom serveru kao i sve druge. Za praćenje rezultata dovoljan je pokerth.net račun; prijava na kup ide preko odgovarajuće teme na forumu.'] },
        { id: 'forumnews', t: 'Novosti s foruma u predvorju',
          b: ['Gumb s novinama u zaglavlju predvorja otvara najnovije objave s foruma pokerth.net, jedan unos po temi, svaki forum sa svojom bojom. Značka na gumbu broji nepročitane objave; otvaranje objave (nova kartica) označava je pročitanom, a „Označi sve kao pročitano” briše sve odjednom.',
              ...
              'Kartica „Događaji“ prikazuje predstojeće BBC igre i sljedeći Monthly Cup s brojem prijavljenih igrača, te posljednje pobjednike BBC-a, WEC-a i Monthly Cupa. Vremena su u vašem lokalnom vremenu, a dodir otvara stranicu zajednice. Opcija „Prikaži sadržaj zajednice (BBC / WEC)“ sakriva ovu karticu.'] },
        { id: 'avatars', t: 'Avatari i zastave',
          b: ['Na pokerth.net tvoj se avatar distribuira drugim igračima preko avatar-servera, a mala zastava zemlje može se prikazivati na kutijama igrača. Oboje je neobavezno i podesivo u opcijama.'] }
      ]
    },
    {
      ...
      sections: [
        { id: 'what', t: 'Šta je to',
          b: ['Način Lokalno / trening potpuna je partija protiv protivnika kojima upravlja računar: bez veze, bez računa, ništa na kocki. Nakon što je aplikacija instalirana (ili samo jednom posjećena), radi potpuno offline — savršeno za učenje igre, isprobavanje interfejsa ili kraćenje vremena u zrakoplovnom načinu.'] },
        ...
        { id: 'learn', t: 'Dobro mjesto za učenje',
          b: ['Sve opisano u drugim poglavljima radi i ovdje: monitor vjerovatnosti, prikaz pomoćnika, predodabir, tastaturni prečaci. Trening način najbolje je mjesto da ih isprobaš bez pritiska prije nego se baciš na pokerth.net.'] }
      ]
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Glazbeni player',
          b: ['Stavka glazbe u menijima zaglavlja otvara mali player ambijentalne glazbe: odaberi pjesmu s popisa, reprodukcija/pauza, prethodna/sljedeća, nasumično te ponavljanje jedne pjesme, cijelog popisa ili ničega. Glasnoća, odabrana pjesma i način ponavljanja pamte se. Reprodukcija nikad ne počinje sama — preglednici zahtijevaju dodir — a player je potpuno neovisan o zvučnim efektima igre.', 'Dva palca ispod naslova pjesme govore sviđa li ti se ono što svira. Jedan anoniman glas po uređaju, uključujući radijske postaje, i možeš ga promijeniti ili povući u bilo kojem trenutku; dok operater ne otkrije zbrojeve, vidiš samo vlastiti palac.', "Na iPhoneu i iPadu player podrazumijevano koristi običnu reprodukciju, kako bi muzika nastavila svirati uz CarPlay, Bluetooth ili zaključan ekran; jačina zvuka se tada podešava tipkama uređaja ili automobila. Opcija „Jačina zvuka u aplikaciji“ vraća klizač jačine zvuka, balans i VU-metar, ali zvuk u autu može zastajkivati."] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'fkeys', t: 'Službeni tastaturni prečaci',
          ...
          keys: [
            ...
            ['F11', 'Puni zaslon']],
          note: 'Prečaci zahtijevaju fizičku tastaturu. Na Macu tipke F prema zadanim postavkama upravljaju multimedijom: drži Fn (ili u postavkama macOS-a uključi \u201eKoristi tipke F1, F2 itd. kao standardne funkcijske tipke\u201c). Na iPhoneu je puni zaslon ograničen iOS-om — instaliranje aplikacije kao PWA daje isto iskustvo punog zaslona.' },
        { id: 'webkeys', t: 'Web slovne tipke',
          b: ['Web proširenje: jednoslovne tipke i Alt+T također pokreću radnje, a sve se mogu preraspodijeliti u Napredne opcije → Tastaturni prečaci:'],
          keys: [
            ['F', 'Fold'],
            ['C', 'Check / Call'],
            ['R', 'Raise'],
