    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Gdje opcije žive',
          b: ['Napredne opcije otvaraju se stavkom sa zupčanikom u bilo kojem meniu zaglavlja. Grupirane su kao u desktop klijentu: Korisničko interfejs, Stil, Zvuk, Lokalna partija, Mrežna partija, Internetska partija, Nadimci / Avatari, Poruke zapisnika i Vrati zadano. Svaka funkcija specifična za web ondje ima vlastiti prekidač, pa možeš isključiti sve što ne koristiš.'] },
