  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Jezik',
          b: ['Interfejs je dostupan na 78 jezika. Promijeni ga bilo kada u Naprednim opcijama (meni sa zupčanikom), kategorija Korisničko interfejs. Pokerski izrazi za akcije (Fold, Check, Call, Bet, Raise, All-In) ostaju na engleskom prema konvenciji, točno kao u desktop klijentu.'] },
