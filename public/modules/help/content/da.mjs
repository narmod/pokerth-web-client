  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Sprog',
          b: ['Grænsefladen findes på 81 sprog. Skift det når som helst i Avancerede indstillinger (tandhjulsmenuen), kategorien Brugergrænseflade. Pokerens handlingstermer (Fold, Check, Call, Bet, Raise, All-In) forbliver på engelsk efter konventionen, nøjagtigt som i skrivebordsklienten.'] },
        ...
        { id: 'avatar', t: 'Kaldenavn og avatar',
          b: ['Vælg dit kaldenavn og din avatar på loginskærmen, før du forbinder. På pokerth.net er dit kaldenavn dit kontonavn; avatarer deles med andre spillere via avatarserveren.', 'Din avatar sendes, når du forbinder, og alle spillere ser den samme. Skifter du den, mens du er forbundet, gælder den nye avatar fra din næste forbindelse. Forbogstavet (Aa) sendes ikke: andre spillere ser standardavataren.'] }
      ]
    },
    {
      ...
      sections: [
        ...
        { id: 'showdown', t: 'Showdown og delte potter',
          b: ['Hvis flere spillere er tilbage efter indsatsrunden på river, vises hænderne, og den bedste vinder — den vindende kombination vises under fælleskortene. Når en spiller er all-in for mindre end de fulde indsatser, opstår sidepotter: hver spiller kan kun vinde den del af potten, som vedkommende har bidraget til. Lige hænder deler potten.',
            'Ikke alle skal vise: fra den sidste spiller der satsede eller hævede, vendes en hånd kun, hvis den slår det der allerede ligger åbent. Den der må mucke, beholder kortene skjult og får en Show-knap til alligevel at vise dem.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Bordzoom (telefoner)',
          b: ['På små skærme forstørrer lupknapperne bordet (2\u00d7), og du kan trække det med fingeren — kun handlingsbjælken bliver stående; din egen boks forstørres også, og visningen vender tilbage til den, når det er din tur. Visningen følger automatisk den aktive plads og zoomer ud ved showdown for at give overblik. Kan slås fra i Avancerede indstillinger. Når det er din tur, og fælleskortene er uden for billedet, vises en lille kopi øverst på bordet; tryk på den for at hoppe til kortene og tilbage igen.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Håndlogs og vinduet \u201cLogs\u201d',
          b: ['Ud over den løbende log optages hver hånd, du spiller, lokalt i din browser i samme format som den officielle klients .pdb-logfiler. Vinduet Logs (Avancerede indstillinger \u2192 Logbeskeder \u2192 Administrér logs\u2026) viser dine sessioner og lader dig arbejde med dem: forhåndsvise en session med søgning og fremhævning, filtrere efter spil, eksportere som HTML eller ren tekst, gemme den rå .pdb-fil eller importere en .pdb optaget af skrivebordsklienten. Sessioner slettes én ad gangen eller alle på én gang (med bekræftelse), og en automatisk opbevaring kan nøjes med at beholde de seneste 7, 30, 90, 180 eller 365 dage. Logfiler, du selv importerer, slettes aldrig automatisk. En anden indstilling begrænser antallet af gemte sessioner, og listekolonnen kan trækkes bredere.',
              'Vil du rydde op i flere sessioner på én gang, viser knappen Vælg… et afkrydsningsfelt ved hver post: sæt flueben ved dem, der skal væk, og Slet fjerner hele bunken efter én bekræftelse. På en computer tilføjer Ctrl (⌘) + klik sessioner én ad gangen, og Skift + klik tager et helt interval.',
        ...
        { id: 'logopts', t: 'Logindstillinger',
          b: ['Under Avancerede indstillinger \u2192 Logmeddelelser kan du slå logning til eller fra og vælge skriveintervallet med de samme tre indstillinger som skrivebordsklienten: efter hver handling, efter hver hånd (standard) eller efter hvert spil. En anden indstilling skriver .pdb-filen til en mappe efter eget valg og holder den opdateret med det interval, plus en sidste gang når du forlader siden, så et andet værktøj kan følge spillet live.'],
          note: 'Skrivning til en lokal mappe kræver File System Access API: kun Chrome, Edge og Opera på skrivebordet. Andre steder forklarer indstillingen sig selv, og manuel eksport fra logvinduet er stadig tilgængelig. En browser kan kun erstatte en fil, aldrig tilføje til den, så et værktøj der læser .pdb bør åbne den igen efter hver ændring.' },
        ...
        { id: 'hud', t: 'Statistik-HUD ved pladserne',
          b: ['HUD\u2019en sætter en lille statistikboks ved siden af hver spillers plads, bygget af de hænder du har optaget i dine logfiler: antal observerede hænder, derefter VPIP (hvor ofte han frivilligt lægger penge i pre-flop), PFR (pre-flop-forhøjelser) og AF (aggressionsfaktor), farvekodet fra passiv til aggressiv. Nedenunder opsummerer et mærke spilleren med ord \u2014 Stram-Passiv, Løs-Aggressiv og så videre \u2014 ved siden af en lille skive, hvis oplyste kvadrant læses fra venstre mod højre som stram til løs, og nedefra og op som passiv til aggressiv. Mærket vises fra allerførste hånd, men er dæmpet indtil 25 hænder, hvor det bliver pålideligt. Tryk på en boks for et detaljeret popover med alle tallene (3-bet, continuation bet, fold mod 3-bet, stjæleforsøg, showdown-rater\u2026), og træk den væk, hvis den dækker noget.',
              'HUD\u2019en kender kun det, du har set ved dine egne borde — den læser dine lokale håndlogs, så optagelsen skal være slået til, og tallene giver først mening efter tilstrækkeligt mange hænder. Den er slået fra som standard: slå den til i Avancerede indstillinger \u2192 Assistance.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'forumnews', t: 'Forumnyheder i lobbyen',
          b: ['Avisknappen i lobbyens topbjælke åbner de nyeste indlæg fra pokerth.net-forummet, én linje pr. emne, hvert forum med sin egen farve. Mærket på knappen tæller de ulæste indlæg; åbnes et indlæg (ny fane), markeres det som læst, og “Markér alt som læst” rydder alt på én gang.',
              'Det er en web-ekstra: knappen kan skjules under Avancerede indstillinger (“Forumknap i lobbyens topbjælke”).',
              'Fanen “Begivenheder” viser de kommende BBC-spil og den næste Monthly Cup med antallet af tilmeldte spillere samt de seneste vindere af BBC, WEC og Monthly Cup. Tiderne er i din lokale tid, og et tryk åbner fællesskabets side. Indstillingen “Vis fællesskabsindhold (BBC / WEC)” skjuler denne fane.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Musikafspiller',
          b: ['Musikpunktet i headermenuerne åbner en lille baggrundsmusikafspiller: vælg et nummer fra afspilningslisten, afspil/pause, forrige/næste, bland, og gentag ét nummer, hele listen eller intet. Lydstyrke, valgt nummer og gentagelsestilstand huskes. Afspilningen starter aldrig af sig selv — browsere kræver et tryk — og afspilleren er helt uafhængig af spillets lydeffekter.', 'To tommelfingre under nummerets titel siger, om du kan lide det, der spiller. Én anonym stemme pr. enhed, radiokanaler inklusive, og du kan altid ændre den eller trække den tilbage; medmindre operatøren viser totalerne, ser du kun din egen tommelfinger.', "På iPhone og iPad bruger afspilleren som standard almindelig afspilning, så musikken fortsætter med CarPlay, Bluetooth eller låst skærm; lydstyrken indstilles så med enhedens eller bilens knapper. Indstillingen “Lydstyrke i appen” giver lydstyrkeskyderen, balancen og VU-meteret tilbage, men lyden kan hakke i bilen."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Hvor indstillingerne bor',
          b: ['Avancerede indstillinger åbnes fra tandhjulspunktet i enhver headermenu. De er grupperet som i skrivebordsklienten: Brugergrænseflade, Stil, Lyd, Lokalt spil, Netværksspil, Internetspil, Kaldenavne / Avatarer, Logbeskeder og Sikkerhedskopi og nulstilling. Hver webspecifik funktion har sin egen kontakt dér, så du kan slå alt fra, du ikke bruger.'] },
        { id: 'cfgxml', t: 'Udveksl indstillinger med skrivebordsklienten',
          b: ['Dine indstillinger kan rejse mellem klienter: kategorien Sikkerhedskopi og nulstilling tilbyder eksport/import af den officielle config.xml-fil (den \u007e/.pokerth/config.xml, som skrivebords- og QML-klienterne bruger). Eksporten skriver de delte indstillinger — navn, visningsindstillinger, lyde, bordpræferencer, blinds, stilarter — og importen anvender en fil fra computeren her. Indstillinger, som denne klient ikke kender, bevares urørte i filen.', 'Dine spillernoter rejser også med filen — teksten og stjernebedømmelsen, skrevet som desktopklienterne læser dem. Farveetiketterne bliver i denne klient: det officielle format har ikke noget felt til dem, så en import rører dem aldrig.'] },
        ...
        { id: 'fkeys', t: 'Officielle tastaturgenveje',
          b: ['PokerTH\u2019s officielle funktionstaster virker under et spil \u2014 Alt+S virker overalt:'],
          keys: [
