  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Sprog',
          b: ['Grænsefladen findes på 69 sprog. Skift det når som helst i Avancerede indstillinger (tandhjulsmenuen), kategorien Brugergrænseflade. Pokerens handlingstermer (Fold, Check, Call, Bet, Raise, All-In) forbliver på engelsk efter konventionen, nøjagtigt som i skrivebordsklienten.'] },
