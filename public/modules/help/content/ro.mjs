    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Opțiuni de jurnal',
          b: ['În Opțiuni avansate \u2192 Mesaje de jurnal poți porni sau opri înregistrarea și alege intervalul de scriere (după fiecare acțiune sau o dată pe mână), ca în setările clientului desktop. O opțiune suplimentară scrie fișierul .pdb direct într-un dosar la alegerea ta și îl actualizează după fiecare mână — exact cum face clientul desktop, ca alte instrumente să-l poată citi în timp real.'],
          note: 'Scrierea într-un dosar local necesită API-ul File System Access: doar Chrome și Edge pe desktop. Firefox, Safari și browserele mobile nu pot — opțiunea afișează atunci o scurtă explicație, iar exportul manual din fereastra Jurnale rămâne disponibil peste tot.' },
        ...
        { id: 'hud', t: 'HUD de statistici la locuri (beta)',
          b: ['HUD-ul atașează lângă locul fiecărui jucător o mică casetă de statistici, construită din mâinile înregistrate în jurnalele tale: numărul de mâini observate, apoi VPIP (cât de des pune bani voluntar pre-flop), PFR (măriri pre-flop), AF (factorul de agresivitate), 3B (3-bet), CB (continuation bet) și F3B (fold la 3-bet), cu coduri de culoare de la pasiv la agresiv. Atinge o casetă pentru un popover detaliat cu mai multe cifre (încercări de steal, fold la steal, rate de showdown\u2026) și trage-l dacă acoperă ceva.',
      ...
      sections: [
        ...
        { id: 'cups', t: 'Cupele comunității: BBC și WeCup',
          b: ['Două comunități își organizează propriile competiții pe pokerth.net, fiecare cu site și clasament proprii. Best Brainies Cup (BBC) este un turneu pe etape născut în 2013: se urcă de la Step 1 la Step 4, iar un nou sezon începe după fiecare partidă de Step 4, când se acordă cupa. WeCup (WEC) are baremul său, mult mai întins — 75 de puncte pentru primul loc, apoi 45, 30, 20… — iar scorul său îți normalizează media în funcție de numărul de partide jucate față de ceilalți membri.',
              'Ambele clasamente se deschid din butonul trofeu, lângă clasamentul PokerTH. Setările de masă ale acestor competiții vin ca presetări la crearea unei partide (BBC Step 1 până la 4, WEC și WEC Grand Final), așa că poți exersa în aceleași condiții. Participarea cere o înscriere pe site-ul cupei respective.'],
