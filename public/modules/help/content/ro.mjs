  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Clasamentul familiei',
          b: ['Doar pe serverele private și în partidele LAN, clientul păstrează statistici cumulate pe pseudonim — mâini și partide jucate și câștigate, cel mai mare câștig, cea mai bună serie — și le partajează prin server, astfel încât fiecare dispozitiv de la masă vede același clasament. Partidele de pe pokerth.net nu sunt niciodată urmărite astfel, iar statisticile modului de antrenament rămân complet separate.', 'În aceste jocuri, butonul cu trofeu deschide fereastra clasamentelor pe fila LAN: toți jucătorii, sortabili după mai multe criterii.'] },
        { id: 'language', t: 'Limba',
          b: ['Interfața este disponibilă în 77 de limbi. Schimb-o oricând în Opțiuni avansate (meniul cu rotiță), categoria Interfață utilizator. Termenii de acțiune din poker (Fold, Check, Call, Bet, Raise, All-In) rămân în engleză prin convenție, exact ca în clientul desktop.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zoom pe masă (telefoane)',
          b: ['Pe ecrane mici, butoanele cu lupă măresc masa (2\u00d7) și o poți deplasa cu degetul — doar bara de acțiuni rămâne fixă; și propria casetă este mărită, iar vederea revine la ea când e rândul tău. Vederea urmărește automat locul activ și se depărtează la showdown pentru imaginea de ansamblu. Dezactivabil în Opțiuni avansate. Când e rândul tău și cărțile comune sunt în afara vederii, o copie mică a lor apare în partea de sus a mesei; atinge-o ca să sari la cărți și înapoi.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Jurnalele de mâini și fereastra \u201eJurnale\u201d',
          b: ['Pe lângă jurnalul în timp real, fiecare mână jucată este înregistrată local în browser, în același format ca fișierele de jurnal .pdb ale clientului oficial. Fereastra Jurnale (Opțiuni avansate \u2192 Mesaje de jurnal \u2192 Gestionează jurnalele\u2026) îți listează sesiunile și te lasă să lucrezi cu ele: previzualizezi o sesiune cu căutare și evidențiere, filtrezi după partidă, exporți în HTML sau text simplu, salvezi fișierul .pdb brut sau imporți un .pdb înregistrat de clientul desktop. Sesiunile se șterg una câte una sau toate odată (cu confirmare), iar o retenție automată poate păstra doar ultimele 7, 30, 90, 180 sau 365 de zile. Jurnalele importate de tine nu sunt niciodată șterse automat. O a doua setări limitează câte sesiuni sunt păstrate, iar coloana cu lista poate fi lărgită prin tragere.',
              'Ca să faci curat în mai multe sesiuni deodată, butonul Selectează… afișează o casetă la fiecare intrare: bifează-le pe cele de prisos, iar Șterge elimină tot lotul după o singură confirmare. Pe calculator, Ctrl (⌘) + clic adaugă sesiuni una câte una, iar Shift + clic ia un interval întreg.',
        ...
        { id: 'hud', t: 'HUD de statistici la locuri',
          b: ['HUD-ul atașează o mică fereastră de statistici lângă locul fiecărui jucător, construită din mâinile pe care le-ai înregistrat în jurnalele tale: numărul de mâini observate, apoi VPIP (cât de des pune bani voluntar pre-flop), PFR (măriri pre-flop) și AF (factorul de agresivitate), colorate de la pasiv la agresiv. Dedesubt, o insignă rezumă jucătorul în cuvinte \u2014 Strâns-Pasiv, Larg-Agresiv și așa mai departe \u2014 lângă un mic cadran al cărui sfert aprins se citește de la stânga la dreapta de la strâns la larg, și de jos în sus de la pasiv la agresiv. Insigna apare de la prima mână, dar rămâne estompată până la 25 de mâini, prag de la care devine fiabilă. Atinge o fereastră pentru un popover detaliat cu toate cifrele (3-bet, continuation bet, fold la 3-bet, încercări de furt, rate de showdown\u2026), și trage-o dacă acoperă ceva.',
              'HUD-ul știe doar ce ai văzut la mesele tale — citește jurnalele tale locale de mâini, deci înregistrarea trebuie să fie pornită, iar cifrele capătă sens abia după destule mâini. Este dezactivată implicit: activeaz-o în Opțiuni avansate \u2192 Asistență.'] },
      ...
      sections: [
        ...
        { id: 'forumnews', t: 'Noutăți de pe forum în lobby',
          b: ['Butonul cu ziar din antetul lobby-ului deschide cele mai noi mesaje de pe forumul pokerth.net, o intrare pe subiect, fiecare forum cu propria culoare. Insigna de pe buton numără mesajele necitite; deschiderea unui mesaj (filă nouă) îl marchează drept citit, iar „Marchează tot ca citit” golește totul dintr-odată.',
              ...
              'Fila „Evenimente” arată următoarele jocuri BBC și următoarea Monthly Cup cu numărul de jucători înscriși, precum și ultimii câștigători BBC, WEC și Monthly Cup. Orele sunt în ora ta locală, iar o atingere deschide site-ul comunității. Opțiunea „Arată conținutul comunității (BBC / WEC)” ascunde această filă.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Player de muzică',
          b: ['Intrarea de muzică din meniurile antetului deschide un mic player de muzică ambientală: alege o piesă din listă, redare/pauză, anterioară/următoarea, amestecare, și repetarea unei piese, a întregii liste sau deloc. Volumul, piesa aleasă și modul de repetare sunt memorate. Redarea nu pornește niciodată singură — browserele cer o atingere — iar playerul este complet independent de efectele sonore ale jocului.', 'Două degete mari sub titlul piesei spun dacă îți place ce se aude. Un vot anonim per dispozitiv, radiourile incluse, și îl poți schimba sau retrage oricând; până când operatorul nu dezvăluie totalurile, vezi doar propriul tău vot.', "Pe iPhone și iPad playerul folosește implicit o redare simplă, pentru ca muzica să continue cu CarPlay, Bluetooth sau cu ecranul blocat; volumul se reglează atunci din butoanele dispozitivului sau ale mașinii. Opțiunea „Volum în aplicație” readuce cursorul de volum, balansul și VU-metrul, dar sunetul se poate întrerupe în mașină."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Unde locuiesc opțiunile',
          b: ['Opțiunile avansate se deschid din intrarea cu rotiță a oricărui meniu din antet. Sunt grupate ca în clientul desktop: Interfață utilizator, Stil, Sunet, Partidă locală, Partidă în rețea, Partidă pe internet, Pseudonime / Avataruri, Mesaje de jurnal și Copie de rezervă și resetare. Fiecare funcție specifică web are acolo propriul comutator, ca să poți opri tot ce nu folosești.'] },
        { id: 'cfgxml', t: 'Schimbă setări cu clientul desktop',
          b: ['Setările tale pot călători între clienți: categoria Copie de rezervă și resetare oferă exportul/importul fișierului oficial config.xml (acel \u007e/.pokerth/config.xml folosit de clienții desktop și QML). Exportul scrie setările partajate — nume, opțiuni de afișare, sunete, preferințe de masă, blinduri, stiluri — iar importul aplică aici un fișier de pe desktop. Setările pe care acest client nu le cunoaște rămân neatinse în fișier.', 'Notițele tale despre jucători călătoresc și ele cu fișierul — textul și evaluarea în stele, scrise așa cum le citesc clienții de desktop. Etichetele colorate rămân în acest client: formatul oficial nu are un câmp pentru ele, așa că un import nu le atinge niciodată.'] },
