  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Limba',
          b: ['Interfața este disponibilă în 71 de limbi. Schimb-o oricând în Opțiuni avansate (meniul cu rotiță), categoria Interfață utilizator. Termenii de acțiune din poker (Fold, Check, Call, Bet, Raise, All-In) rămân în engleză prin convenție, exact ca în clientul desktop.'] },
