  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: "language",
          t: "Dil",
          b: [
            "İnterfeys 78 dildə mövcuddur. Onu istənilən vaxt Əlavə seçimlərdə (dişli çarx menyusu) İstifadəçi interfeysi bölməsində dəyişin. Poker hərəkət terminləri (Fold, Check, Call, Bet, Raise, All-In) masaüstü klientdə olduğu kimi ənənəyə görə ingiliscə qalır."] },
        { id: "pwa",
