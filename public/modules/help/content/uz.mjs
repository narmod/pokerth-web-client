  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: "language",
          t: "Til",
          b: [
            "Interfeys 65 tilda mavjud. Uni istalgan vaqtda Kengaytirilgan sozlamalar (tishli gʻildirak menyusi) dagi Foydalanuvchi interfeysi boʻlimida oʻzgartiring. Poker harakat atamalari (Fold, Check, Call, Bet, Raise, All-In) anʼanaga koʻra, xuddi desktop mijozdagidek, ingliz tilida qoladi."] },
        { id: "pwa",
