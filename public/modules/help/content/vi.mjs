  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Bảng xếp hạng gia đình',
          b: ['Chỉ trên máy chủ riêng và ván LAN, ứng dụng mới lưu thống kê tích lũy theo biệt danh — số ván bài và ván đấu đã chơi và đã thắng, khoản thắng lớn nhất, chuỗi thắng tốt nhất — rồi chia sẻ qua máy chủ, để mọi thiết bị quanh bàn đều thấy cùng một bảng xếp hạng. Các ván trên pokerth.net không bao giờ được ghi nhận theo cách này, và thống kê của chế độ luyện tập được giữ hoàn toàn riêng biệt.', 'Trong các ván này, nút cúp mở cửa sổ xếp hạng ở thẻ LAN: mọi người chơi, có thể sắp xếp theo nhiều tiêu chí.'] },
        { id: 'language', t: 'Ngôn ngữ',
          b: ['Giao diện có sẵn ở 66 ngôn ngữ. Hãy đổi bất cứ lúc nào trong Tùy chọn nâng cao (menu bánh răng), mục Giao diện người dùng. Các thuật ngữ hành động của poker (Fold, Check, Call, Bet, Raise, All-In) vẫn giữ tiếng Anh theo quy ước, đúng như ứng dụng máy tính để bàn.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Phóng to bàn (điện thoại)',
          b: ['Trên màn hình nhỏ, các nút kính lúp phóng to bàn (2\u00d7) và bạn có thể kéo bằng ngón tay — chỉ thanh hành động đứng yên; ô của bạn cũng được phóng to và khung nhìn quay về đó khi đến lượt bạn. Khung nhìn tự động bám theo chỗ đang hành động và thu nhỏ lại ở showdown để nhìn toàn cảnh. Có thể tắt trong Tùy chọn nâng cao. Khi đến lượt bạn, nếu bài chung nằm ngoài khung nhìn, một bản sao nhỏ sẽ hiện ở phía trên bàn; chạm vào đó để chuyển đến các lá bài và quay lại.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Nhật ký ván bài và cửa sổ \u201cNhật ký\u201d',
          b: ['Ngoài nhật ký trực tiếp, mỗi ván bài bạn chơi đều được ghi cục bộ trong trình duyệt, đúng định dạng tệp nhật ký .pdb của ứng dụng chính thức. Cửa sổ Nhật ký (Tùy chọn nâng cao \u2192 Thông điệp nhật ký \u2192 Quản lý nhật ký\u2026) liệt kê các phiên của bạn và cho phép làm việc với chúng: xem trước một phiên kèm tìm kiếm và tô sáng, lọc theo ván đấu, xuất ra HTML hoặc văn bản thuần, lưu tệp .pdb gốc, hoặc nhập một tệp .pdb do ứng dụng máy tính ghi lại. Các phiên có thể xóa từng cái hoặc tất cả cùng lúc (có xác nhận), và chế độ lưu giữ tự động có thể chỉ giữ 7, 30, 90, 180 hoặc 365 ngày gần nhất. Nhật ký bạn tự nhập sẽ không bao giờ bị xóa tự động. Một thiết lập thứ hai giới hạn số phiên được giữ, và cột danh sách có thể kéo rộng ra.',
              'Để dọn nhiều phiên cùng lúc, nút Chọn… hiện ô đánh dấu ở từng mục: đánh dấu những phiên không cần nữa rồi Xóa sẽ xóa cả nhóm sau một lần xác nhận duy nhất. Trên máy tính, Ctrl (⌘) + nhấp thêm từng phiên một, còn Shift + nhấp lấy trọn một dải.',
        ...
        { id: 'logopts', t: 'Tùy chọn nhật ký',
          b: ['Trong Tùy chọn nâng cao \u2192 Thông báo nhật ký, bạn có thể bật hoặc tắt việc ghi nhật ký và chọn khoảng ghi, với ba thiết lập giống hệt ứng dụng máy tính: sau mỗi thao tác, sau mỗi lượt chơi (mặc định) hoặc sau mỗi màn chơi. Một tùy chọn khác ghi tệp .pdb vào thư mục bạn chọn và cập nhật theo khoảng đó, cộng thêm một lần nữa khi bạn rời trang, để công cụ khác có thể theo dõi ván đấu trực tiếp.'],
          note: 'Việc ghi vào thư mục cục bộ cần File System Access API: chỉ Chrome, Edge và Opera trên máy tính. Ở nơi khác, tùy chọn sẽ tự giải thích và việc xuất thủ công từ cửa sổ nhật ký vẫn dùng được. Trình duyệt chỉ có thể thay thế tệp chứ không ghi nối tiếp, nên công cụ đọc .pdb nên mở lại tệp sau mỗi thay đổi.' },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Trình phát nhạc',
          b: ['Mục nhạc trong các menu tiêu đề mở một trình phát nhạc nền nhỏ: chọn bài từ danh sách, phát/tạm dừng, trước/sau, phát ngẫu nhiên, và lặp một bài, cả danh sách hoặc không lặp. Âm lượng, bài đang chọn và chế độ lặp đều được ghi nhớ. Nhạc không bao giờ tự phát — trình duyệt đòi hỏi một lần chạm — và trình phát hoàn toàn độc lập với hiệu ứng âm thanh của ván đấu.', 'Hai ngón cái dưới tên bài cho biết bạn có thích bản đang phát hay không. Mỗi thiết bị một phiếu ẩn danh, kể cả với các đài radio, và bạn có thể đổi hoặc rút lại bất cứ lúc nào; chừng nào người vận hành chưa công bố tổng số, bạn chỉ thấy phiếu của chính mình.', "Trên iPhone và iPad, trình phát mặc định dùng chế độ phát đơn giản để nhạc tiếp tục với CarPlay, Bluetooth hoặc khi khóa màn hình; khi đó âm lượng được chỉnh bằng nút của thiết bị hoặc của xe. Tùy chọn “Âm lượng trong ứng dụng” đưa thanh âm lượng, cân bằng và đồng hồ VU trở lại, nhưng âm thanh có thể bị giật trong xe."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Tùy chọn nằm ở đâu',
          b: ['Tùy chọn nâng cao mở từ mục bánh răng trong bất kỳ menu tiêu đề nào. Chúng được nhóm như ở ứng dụng máy tính: Giao diện người dùng, Kiểu dáng, Âm thanh, Ván cục bộ, Ván mạng, Ván internet, Biệt danh / Ảnh đại diện, Thông điệp nhật ký, và Sao lưu & đặt lại. Mỗi tính năng riêng của bản web đều có công tắc riêng ở đó, nên bạn tắt được mọi thứ mình không dùng.'] },
        { id: 'cfgxml', t: 'Trao đổi thiết lập với ứng dụng máy tính',
          b: ['Thiết lập của bạn có thể đi lại giữa các ứng dụng: mục Sao lưu & đặt lại cho phép xuất/nhập tệp config.xml chính thức (chính là \u007e/.pokerth/config.xml mà ứng dụng máy tính và QML vẫn dùng). Việc xuất ghi các thiết lập dùng chung — tên, tùy chọn hiển thị, âm thanh, sở thích bàn chơi, blind, kiểu dáng — còn việc nhập áp dụng tệp từ máy tính vào đây. Những thiết lập mà ứng dụng này không biết vẫn được giữ nguyên trong tệp.', 'Ghi chú về người chơi của bạn cũng đi cùng tệp — phần chữ và số sao, được ghi đúng theo cách các client trên máy tính đọc. Nhãn màu thì ở lại client này: định dạng chính thức không có chỗ cho chúng, nên việc nhập tệp không bao giờ đụng đến.'] },
