  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Ngôn ngữ',
          b: ['Giao diện có sẵn ở 47 ngôn ngữ. Hãy đổi bất cứ lúc nào trong Tùy chọn nâng cao (menu bánh răng), mục Giao diện người dùng. Các thuật ngữ hành động của poker (Fold, Check, Call, Bet, Raise, All-In) vẫn giữ tiếng Anh theo quy ước, đúng như ứng dụng máy tính để bàn.'] },
