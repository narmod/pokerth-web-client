  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Šeimos reitingas',
          b: ['Tik privačiuose serveriuose ir LAN žaidimuose klientas saugo suvestinę statistiką pagal slapyvardį — sužaistos ir laimėtos rankos bei partijos, didžiausias laimėjimas, geriausia serija — ir dalijasi ja per serverį, tad kiekvienas įrenginys prie stalo mato tą patį reitingą. pokerth.net žaidimai taip niekada nesekami, o treniruotės režimo statistika laikoma visiškai atskirai.', 'Šiuose žaidimuose taurės mygtukas atveria reitingų langą skirtuke LAN: visi žaidėjai, rikiuojami pagal kelis kriterijus.'] },
        { id: 'language', t: 'Kalba',
          b: ['Sąsaja prieinama 65 kalbomis. Keisk ją bet kada Išplėstinėse parinktyse (krumpliaračio meniu), kategorijoje Naudotojo sąsaja. Pokerio veiksmų terminai (Fold, Check, Call, Bet, Raise, All-In) pagal susitarimą lieka anglų kalba, lygiai kaip darbalaukio kliente.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Stalo mastelis (telefonai)',
          b: ['Mažuose ekranuose didinamojo stiklo mygtukai padidina stalą (2\u00d7) ir gali jį tempti pirštu — vietoje lieka tik veiksmų juosta; tavo dėžutė taip pat padidinama, o vaizdas grįžta prie jos, kai ateina tavo eilė. Vaizdas automatiškai seka aktyvią vietą ir showdown metu atitolsta bendram vaizdui. Išjungiama Išplėstinėse parinktyse. Kai ateina tavo eilė, o bendros kortos nematomos, stalo viršuje pasirodo maža jų kopija; bakstelėk ją, kad peršoktum prie kortų ir atgal.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Rankų žurnalai ir langas \u201eŽurnalai\u201c',
          b: ['Be gyvo žurnalo, kiekviena sužaista ranka vietoje įrašoma į tavo naršyklę tuo pačiu formatu kaip oficialaus kliento .pdb žurnalo failai. Langas Žurnalai (Išplėstinės parinktys \u2192 Žurnalo pranešimai \u2192 Tvarkyti žurnalus\u2026) išvardija tavo sesijas ir leidžia su jomis dirbti: peržiūrėti sesiją su paieška ir paryškinimu, filtruoti pagal partiją, eksportuoti į HTML ar paprastą tekstą, išsaugoti neapdorotą .pdb failą arba importuoti darbalaukio kliento įrašytą .pdb. Sesijos trinamos po vieną arba visos iškart (su patvirtinimu), o automatinis saugojimas gali laikyti tik paskutines 7, 30, 90, 180 ar 365 dienų. Jūsų pačių importuoti žurnalai niekada nėra šalinami automatiškai. Antras nustatymas riboja, kiek seansų laikoma, o sąrašo stulpelį galima išplėsti tempiant.',
              'Norėdami iškart išvalyti kelis seansus, mygtukas Pasirinkti… prie kiekvieno įrašo parodo žymimąjį langelį: pažymėkite nereikalingus ir Ištrinti pašalins visą grupę po vieno patvirtinimo. Kompiuteryje Ctrl (⌘) + spustelėjimas prideda seansus po vieną, o Lyg2 (Shift) + spustelėjimas pažymi visą sritį.',
        ...
        { id: 'logopts', t: 'Žurnalo parinktys',
          b: ['Skiltyje Išplėstinės parinktys \u2192 Žurnalo pranešimai gali įjungti arba išjungti žurnalo rašymą ir pasirinkti rašymo intervalą su tais pačiais trimis nustatymais kaip darbalaukio kliente: po kiekvieno veiksmo, po kiekvienos rankos (numatytasis) arba po kiekvieno žaidimo. Kita parinktis rašo .pdb failą į tavo pasirinktą aplanką ir tuo intervalu jį atnaujina, taip pat dar kartą išeinant iš puslapio, kad kita programa galėtų sekti žaidimą tiesiogiai.'],
          note: 'Rašymui į vietinį aplanką reikia File System Access API: tik Chrome, Edge ir Opera kompiuteryje. Kitur parinktis pati pasiaiškina, o rankinis eksportas iš žurnalų lango lieka prieinamas. Naršyklė failą gali tik pakeisti, bet ne papildyti, todėl .pdb skaitanti programa turėtų jį atverti iš naujo po kiekvieno pakeitimo.' },
        ...
        { id: 'hud', t: 'Statistikos HUD prie vietų',
          b: ['HUD prie kiekvieno žaidėjo vietos prikabina mažą statistikos langelį, sudarytą iš partijų, kurias užrašei savo žurnaluose: stebėtų partijų skaičius, tada VPIP (kaip dažnai jis savanoriškai deda pinigus pre-flop), PFR (pre-flop kėlimai) ir AF (agresyvumo koeficientas), spalvomis nuo pasyvaus iki agresyvaus. Po jais ženklelis apibendrina žaidėją žodžiais \u2014 Ankštas-Pasyvus, Laisvas-Agresyvus ir taip toliau \u2014 šalia mažo ciferblato, kurio įsižiebęs ketvirtis skaitomas iš kairės į dešinę nuo ankšto iki laisvo, o iš apačios į viršų nuo pasyvaus iki agresyvaus. Ženklelis rodomas nuo pat pirmos partijos, bet lieka pritemdytas iki 25 partijų, nuo kurių tampa patikimas. Bakstelėk langelį, kad pamatytum išsamų iššokantį langą su visais skaičiais (3-bet, continuation bet, fold prieš 3-bet, vogimo bandymai, showdown rodikliai\u2026), ir vilk jį, jei kažką užstoja.',
              'HUD žino tik tai, ką matei prie savo stalų — jis skaito tavo vietinius rankų žurnalus, tad įrašymas turi būti įjungtas, o skaičiai prasmingi tampa tik po pakankamai rankų. Pagal numatytuosius nustatymus ji išjungta: įjunk ją Išplėstinės parinktys \u2192 Asistentas.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Muzikos grotuvas',
          b: ['Muzikos įrašas antraštės meniu atidaro mažą foninės muzikos grotuvą: pasirink kūrinį iš grojaraščio, groti/pauzė, ankstesnis/kitas, maišymas ir vieno kūrinio, viso sąrašo ar nieko kartojimas. Garsumas, pasirinktas kūrinys ir kartojimo režimas įsimenami. Grojimas niekada neprasideda savaime — naršyklės reikalauja palietimo — o grotuvas visiškai nepriklausomas nuo žaidimo garso efektų.', 'Du nykščiai po kūrinio pavadinimu pasako, ar tau patinka tai, kas skamba. Vienas anoniminis balsas kiekvienam įrenginiui, įskaitant radijo stotis, ir bet kada gali jį pakeisti ar atsiimti; kol operatorius neatskleidžia sumų, matai tik savo nykštį.', "„iPhone“ ir „iPad“ grotuvas pagal numatymą naudoja paprastą atkūrimą, kad muzika grotų toliau su CarPlay, Bluetooth ar užrakintu ekranu; garsumas tada reguliuojamas įrenginio arba automobilio mygtukais. Parinktis „Garsumas programėlėje“ grąžina garsumo slankiklį, balansą ir VU matuoklį, tačiau automobilyje garsas gali trūkinėti."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Kur gyvena parinktys',
          b: ['Išplėstinės parinktys atidaromos krumpliaračio įrašu bet kuriame antraštės meniu. Jos sugrupuotos kaip darbalaukio kliente: Naudotojo sąsaja, Stilius, Garsas, Vietinė partija, Tinklo partija, Interneto partija, Slapyvardžiai / Avatarai, Žurnalo pranešimai ir Atsarginė kopija ir atkūrimas. Kiekviena žiniatinkliui būdinga funkcija ten turi savą jungiklį, tad gali išjungti viską, ko nenaudoji.'] },
        { id: 'cfgxml', t: 'Nustatymų mainai su darbalaukio klientu',
          b: ['Tavo nustatymai gali keliauti tarp klientų: kategorija Atsarginė kopija ir atkūrimas siūlo oficialaus config.xml failo eksportą/importą (to \u007e/.pokerth/config.xml, kurį naudoja darbalaukio ir QML klientai). Eksportas įrašo bendrus nustatymus — vardą, rodymo parinktis, garsus, stalo pageidavimus, blindus, stilius — o importas čia pritaiko failą iš kompiuterio. Nustatymai, kurių šis klientas nežino, faile lieka nepaliesti.', 'Tavo žaidėjų užrašai keliauja kartu su failu — tekstas ir žvaigždučių įvertinimas, užrašyti taip, kaip juos skaito darbalaukio klientai. Spalvų etiketės lieka šiame kliente: oficialiame formate joms nėra laukelio, tad importas jų niekada neliečia.'] },
