  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Kalba',
          b: ['Sąsaja prieinama 71 kalbomis. Keisk ją bet kada Išplėstinėse parinktyse (krumpliaračio meniu), kategorijoje Naudotojo sąsaja. Pokerio veiksmų terminai (Fold, Check, Call, Bet, Raise, All-In) pagal susitarimą lieka anglų kalba, lygiai kaip darbalaukio kliente.'] },
