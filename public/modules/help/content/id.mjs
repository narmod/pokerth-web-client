      ...
      sections: [
        ...
        { id: 'journal', t: 'Log tangan dan jendela Log',
          b: ['Di luar log langsung, setiap tangan yang Anda mainkan direkam secara lokal di peramban, dalam format yang sama dengan berkas log .pdb klien resmi. Jendela Log (Opsi lanjutan \u2192 Pesan log \u2192 Kelola log\u2026) mencantumkan sesi Anda dan memungkinkan Anda mengelolanya: pratinjau sesi dengan pencarian dan penyorotan, filter per permainan, ekspor sebagai HTML atau teks polos, simpan berkas .pdb mentah, atau impor .pdb yang direkam klien desktop. Sesi dapat dihapus satu per satu atau sekaligus (dengan konfirmasi), dan pengaturan retensi otomatis dapat menyimpan hanya 7, 30, 90, 180, atau 365 hari terakhir. Log yang Anda impor sendiri tidak pernah dihapus otomatis. Pengaturan kedua membatasi jumlah sesi yang disimpan, dan kolom daftar dapat diseret lebih lebar.',
              'Untuk membersihkan beberapa sesi sekaligus, tombol Pilih… menampilkan kotak centang pada setiap entri: centang yang tidak diperlukan lalu Hapus menghapus seluruh kelompok setelah satu konfirmasi. Di komputer, Ctrl (⌘) + klik menambahkan sesi satu per satu dan Shift + klik mengambil seluruh rentang.',
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Pemutar musik',
          b: ['Entri musik di menu kepala halaman membuka pemutar musik lounge kecil: pilih trek dari daftar putar, putar/jeda, sebelumnya/berikutnya, acak, dan ulangi satu trek, seluruh daftar putar, atau tidak sama sekali. Volume, trek terpilih, dan mode ulang diingat. Pemutaran tidak pernah mulai sendiri \u2014 peramban memerlukan ketukan \u2014 dan pemutar sepenuhnya independen dari efek suara permainan.', 'Dua jempol di bawah judul lagu menyatakan apakah kamu suka yang sedang diputar. Satu suara anonim per perangkat, termasuk radio, dan kamu bisa mengubah atau menariknya kapan saja; selama operator belum menampilkan totalnya, kamu hanya melihat jempolmu sendiri.', "Di iPhone dan iPad pemutar secara default memakai pemutaran sederhana agar musik tetap berjalan dengan CarPlay, Bluetooth, atau layar terkunci; volume lalu diatur dengan tombol perangkat atau mobil. Opsi “Volume di aplikasi” mengembalikan penggeser volume, balance, dan VU meter, tetapi suara bisa tersendat di mobil."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Di mana opsi berada',
          b: ['Opsi lanjutan dibuka dari entri roda gigi di menu kepala halaman mana pun. Opsi dikelompokkan seperti klien desktop: Antarmuka pengguna, Gaya, Suara, Permainan lokal, Permainan jaringan, Permainan internet, Nama panggilan / Avatar, Pesan log, dan Cadangan & reset. Setiap fitur khusus web punya sakelarnya sendiri di sana, jadi Anda dapat mematikan apa pun yang tidak Anda pakai.'] },
        { id: 'cfgxml', t: 'Bertukar pengaturan dengan klien desktop',
          b: ['Pengaturan Anda dapat berpindah antar klien: kategori Cadangan & reset menawarkan ekspor/impor berkas config.xml resmi (\u007e/.pokerth/config.xml yang dipakai klien desktop dan QML). Ekspor menulis pengaturan bersama \u2014 nama, opsi tampilan, suara, preferensi meja, blind, gaya \u2014 dan impor menerapkan berkas desktop di sini. Pengaturan yang tidak dikenal klien ini tetap utuh dalam berkas.', 'Catatan pemainmu ikut berjalan bersama berkas — teksnya dan penilaian bintang, ditulis persis seperti yang dibaca klien desktop. Label warna tetap di klien ini: format resmi tidak punya kolom untuknya, jadi impor tidak pernah menyentuhnya.'] },
