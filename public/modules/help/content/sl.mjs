  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Jezik',
          b: ['Vmesnik je na voljo v 73 jezikih. Spremeniš ga lahko kadar koli v Naprednih možnostih (meni z zobnikom) pod Uporabniški vmesnik. Pokrski izrazi za poteze (Fold, Check, Call, Bet, Raise, All-In) po dogovoru ostanejo v angleščini, tako kot pri namiznem odjemalcu.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Povečava mize (telefoni)',
          b: ['Na majhnih zaslonih gumbi za povečevalo povečajo mizo (2×), premikaš pa se lahko s prstom — fiksna ostane le vrstica potez; tudi tvoje polje se poveča, pogled pa se vrne nanj, ko si na potezi. Pogled samodejno sledi aktivnemu mestu in se ob razkritju znova pomanjša za pregled. To je mogoče izklopiti v Naprednih možnostih. Ko si na potezi in so skupne karte zunaj pogleda, se na vrhu mize prikaže njihova majhna kopija; tapni jo za skok h kartam in nazaj.'],
