  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Jezik',
          b: ['Vmesnik je na voljo v 81 jezikih. Spremeniš ga lahko kadar koli v Naprednih možnostih (meni z zobnikom) pod Uporabniški vmesnik. Pokrski izrazi za poteze (Fold, Check, Call, Bet, Raise, All-In) po dogovoru ostanejo v angleščini, tako kot pri namiznem odjemalcu.'] },
