  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Språk',
          b: ['Gränssnittet finns på 36 språk. Byt när som helst i Avancerade inställningar (kugghjulsmenyn), kategorin Användargränssnitt. Pokerns handlingstermer (Fold, Check, Call, Bet, Raise, All-In) förblir på engelska enligt konventionen, precis som i skrivbordsklienten.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Logginställningar',
          b: ['I Avancerade inställningar \u2192 Loggmeddelanden kan du slå på eller av inspelningen och välja skrivintervallet (efter varje handling, eller en gång per hand), som i skrivbordsklientens inställningar. En extra inställning skriver .pdb-filen direkt till en mapp du väljer och uppdaterar den efter varje hand — precis som skrivbordsklienten gör, så att andra verktyg kan läsa den live.'],
          note: 'Att skriva till en lokal mapp kräver File System Access-API:et: bara Chrome och Edge på dator. Firefox, Safari och mobilwebbläsare kan inte — inställningen visar då en kort förklaring, och manuell export från Loggar-fönstret är fortfarande tillgänglig överallt.' },
        ...
        { id: 'hud', t: 'Statistik-HUD vid platserna (beta)',
          b: ['HUD:en fäster en liten statistikruta vid varje spelares plats, byggd av händerna du spelat in i dina loggar: antal observerade händer, sedan VPIP (hur ofta hen frivilligt lägger pengar pre-flop), PFR (pre-flop-höjningar), AF (aggressionsfaktor), 3B (3-bet), CB (continuation bet) och F3B (fold mot 3-bet), med färgkoder från passiv till aggressiv. Tryck på en ruta för en detaljerad popover med fler siffror (steal-försök, fold mot steal, showdown-andelar\u2026), och dra den om den skymmer något.',
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'translate', t: 'Förstå alla',
          b: ['Med chattöversättning på får varje meddelande en översättningsknapp som visar det på ditt språk via webbläsarens översättare. Vanliga bordsförkortningar (gg, nh, utg\u2026) förklaras i ett verktygstips när du pekar på dem — båda inställningarna finns i Avancerade inställningar \u2192 Chatt.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'fkeys', t: 'Officiella tangentbordsgenvägar',
          b: ['PokerTH:s officiella funktionstangenter fungerar under ett spel:'],
          keys: [
        ...
        { id: 'webkeys', t: 'Webbokstavstangenter',
          b: ['Webbutökning: tangenter med en bokstav utlöser också handlingarna och kan bindas om i Avancerade inställningar \u2192 Tangentbordsgenvägar:'],
          keys: [
            ['F', 'Fold'],
            ['C', 'Check / Call'],
            ['R', 'Raise'],
