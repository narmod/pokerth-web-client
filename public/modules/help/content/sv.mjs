  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Språk',
          b: ['Gränssnittet finns på 72 språk. Byt när som helst i Avancerade inställningar (kugghjulsmenyn), kategorin Användargränssnitt. Pokerns handlingstermer (Fold, Check, Call, Bet, Raise, All-In) förblir på engelska enligt konventionen, precis som i skrivbordsklienten.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Bordszoom (telefoner)',
          b: ['På små skärmar förstorar luppknapparna bordet (2\u00d7) och du kan dra det med fingret — bara handlingsraden står stilla; din egen ruta förstoras också, och vyn går tillbaka till den när det är din tur. Vyn följer automatiskt den aktiva platsen och zoomar ut vid showdown för överblicken. Kan stängas av i Avancerade inställningar. När det är din tur och de gemensamma korten är utanför bild visas en liten kopia överst på bordet; tryck på den för att hoppa till korten och tillbaka.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Handloggar och fönstret \u201dLoggar\u201d',
          b: ['Utöver den löpande loggen spelas varje hand du spelar in lokalt i din webbläsare, i samma format som den officiella klientens .pdb-loggfiler. Fönstret Loggar (Avancerade inställningar \u2192 Loggmeddelanden \u2192 Hantera loggar\u2026) listar dina sessioner och låter dig arbeta med dem: förhandsgranska en session med sökning och markering, filtrera per spel, exportera som HTML eller ren text, spara den råa .pdb-filen eller importera en .pdb inspelad av skrivbordsklienten. Sessioner raderas en och en eller alla på en gång (med bekräftelse), och en automatisk lagringstid kan behålla bara de senaste 7, 30, 90, 180 eller 365 dagarna. Loggar du själv importerar tas aldrig bort automatiskt. En andra inställning begränsar hur många sessioner som behålls, och listkolumnen kan dras bredare.',
              'Vill du rensa flera sessioner på en gång visar knappen Välj… en kryssruta vid varje post: bocka för dem som kan gå och Ta bort tar bort hela bunten efter en enda bekräftelse. På en dator lägger Ctrl (⌘) + klick till sessioner en och en, och Skift + klick tar ett helt intervall.',
        ...
        { id: 'hud', t: 'Statistik-HUD vid platserna',
          b: ['HUD:en fäster en liten statistikruta bredvid varje spelares plats, byggd av händerna du har registrerat i dina loggar: antal observerade händer, sedan VPIP (hur ofta han frivilligt lägger in pengar pre-flop), PFR (pre-flop-höjningar) och AF (aggressionsfaktor), färgkodat från passiv till aggressiv. Under dem sammanfattar en bricka spelaren i ord \u2014 Tight-Passiv, Lös-Aggressiv och så vidare \u2014 bredvid en liten urtavla där den tända kvadranten läses från vänster till höger som tight till lös, och nedifrån och upp som passiv till aggressiv. Brickan visas från allra första handen men förblir nedtonad till 25 händer, då den blir tillförlitlig. Tryck på en ruta för en detaljerad popover med alla siffror (3-bet, continuation bet, fold mot 3-bet, stöldförsök, showdown-frekvenser\u2026), och dra undan den om den täcker något.',
              'HUD:en känner bara till det du sett vid dina egna bord — den läser dina lokala handloggar, så inspelningen måste vara på och siffrorna blir meningsfulla först efter tillräckligt många händer. Den är av som standard: slå på den i Avancerade inställningar \u2192 Assistans.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Musikspelare',
          b: ['Musikposten i sidhuvudsmenyerna öppnar en liten bakgrundsmusikspelare: välj ett spår från spellistan, spela/pausa, föregående/nästa, blanda, och upprepning av ett spår, hela listan eller inget. Volym, valt spår och upprepningsläge kommer ihåg. Uppspelningen startar aldrig av sig själv — webbläsare kräver en tryckning — och spelaren är helt oberoende av spelets ljudeffekter.', 'Två tummar under låttiteln säger om du gillar det som spelas. En anonym röst per enhet, radiokanaler inräknade, och du kan ändra eller ta tillbaka den när som helst; så länge operatören inte visar summorna ser du bara din egen tumme.', "På iPhone och iPad använder spelaren som standard vanlig uppspelning, så att musiken fortsätter med CarPlay, Bluetooth eller låst skärm; volymen ställs då in med enhetens eller bilens knappar. Alternativet ”Volym i appen” ger tillbaka volymreglaget, balansen och VU-mätaren, men ljudet kan hacka i bilen."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Var inställningarna bor',
          b: ['Avancerade inställningar öppnas från kugghjulsposten i valfri sidhuvudsmeny. De är grupperade som i skrivbordsklienten: Användargränssnitt, Stil, Ljud, Lokalt spel, Nätverksspel, Internetspel, Smeknamn / Avatarer, Loggmeddelanden och Säkerhetskopia och återställning. Varje webbspecifik funktion har sin egen brytare där, så att du kan stänga av allt du inte använder.'] },
        { id: 'cfgxml', t: 'Utbyt inställningar med skrivbordsklienten',
          b: ['Dina inställningar kan resa mellan klienter: kategorin Säkerhetskopia och återställning erbjuder export/import av den officiella config.xml-filen (den \u007e/.pokerth/config.xml som skrivbords- och QML-klienterna använder). Exporten skriver de delade inställningarna — namn, visningsval, ljud, bordspreferenser, mörkar, stilar — och importen tillämpar en fil från datorn här. Inställningar som den här klienten inte känner till bevaras orörda i filen.', 'Dina spelaranteckningar följer också med filen — texten och stjärnbetyget, skrivna så som skrivbordsklienterna läser dem. Färgetiketterna stannar i den här klienten: det officiella formatet har inget fält för dem, så en import rör dem aldrig.'] },
