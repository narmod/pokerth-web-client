  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Språk',
          b: ['Gränssnittet finns på 57 språk. Byt när som helst i Avancerade inställningar (kugghjulsmenyn), kategorin Användargränssnitt. Pokerns handlingstermer (Fold, Check, Call, Bet, Raise, All-In) förblir på engelska enligt konventionen, precis som i skrivbordsklienten.'] },
