    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Bordszoom (telefoner)',
          b: ['På små skärmar förstorar luppknapparna bordet (2\u00d7) och du kan dra det med fingret — bara handlingsraden står stilla; din egen ruta förstoras också, och vyn går tillbaka till den när det är din tur. Vyn följer automatiskt den aktiva platsen och zoomar ut vid showdown för överblicken. Kan stängas av i Avancerade inställningar.'],
