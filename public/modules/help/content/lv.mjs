  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Valoda',
          b: ['Saskarne ir pieejama 73 valodās. To jebkurā laikā vari mainīt papildu opcijās (zobrata izvēlne) sadaļā Lietotāja saskarne. Pokera darbību termini (Fold, Check, Call, Bet, Raise, All-In) pēc vienošanās paliek angliski, tieši tāpat kā darbvirsmas klientā.'] },
