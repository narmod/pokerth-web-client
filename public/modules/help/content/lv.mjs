  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Valoda',
          b: ['Saskarne ir pieejama 65 valodās. To jebkurā laikā vari mainīt papildu opcijās (zobrata izvēlne) sadaļā Lietotāja saskarne. Pokera darbību termini (Fold, Check, Call, Bet, Raise, All-In) pēc vienošanās paliek angliski, tieši tāpat kā darbvirsmas klientā.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Galda tālummaiņa (telefoni)',
          b: ['Mazos ekrānos lupas pogas pietuvina galdu (2×), un ar pirkstu vari pārvietot skatu — fiksēta paliek tikai darbību josla; arī tavs paša lodziņš tiek pietuvināts, un skats atgriežas pie tā, kad ir tava kārta. Skats automātiski seko aktīvajai vietai un kāršu atklāšanā attālinās atpakaļ, lai redzētu visu. To var izslēgt papildu opcijās. Kad ir tava kārta un kopējās kārtis ir ārpus skata, galda augšdaļā parādās to maza kopija; pieskaries tai, lai pārietu pie kārtīm un atpakaļ.'],
