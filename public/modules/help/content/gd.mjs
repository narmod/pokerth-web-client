    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Roghainnean loga',
          b: ['Ann an Roghainnean adhartach \u2192 Teachdaireachdan loga \u2019s urrainn dhut clàradh a chur air no dheth agus an eadaramh sgrìobhaidh a thaghadh (às dèidh gach gnìomh, no aon uair san làimh), mar a tha ann an roghainnean a\u2019 chliant deasg. Sgrìobhaidh roghainn a bharrachd am faidhle .pdb gu dìreach gu pasgan a thaghas tu agus ùraichidh e às dèidh gach làimhe — dìreach mar a nì an cliant deasg, gus an leugh innealan eile beò e.'],
          note: 'Feumaidh sgrìobhadh gu pasgan ionadail an API File System Access: Chrome agus Edge deasg a-mhàin. Chan urrainn do Firefox, Safari agus brabhsairean fòn — seallaidh an roghainn mìneachadh goirid an uair sin, agus fanaidh an t-às-phortadh làimhe on uinneig Logaichean ri fhaotainn anns a h-uile àite.' },
