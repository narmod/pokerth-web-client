  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Clàr-rangachaidh an teaghlaich',
          b: ['Air frithealaichean prìobhaideach agus ann an geamannan LAN a-mhàin, cumaidh an cliant staitistigean cruinnichte a-rèir far-ainm — làmhan is geamannan a chaidh a chluich agus a bhuannachadh, an duais as motha, an t-sreath as fheàrr — agus roinnidh e iad tron fhrithealaiche, gus am faic gach inneal timcheall a\u2019 bhùird an aon chlàr. Cha tèid geamannan pokerth.net a chlàradh mar seo a-riamh, agus cumar staitistigean a\u2019 mhodh trèanaidh gu tur air leth.', 'Sna geamannan seo, fosglaidh am putan cupa uinneag nan rangachadh air an taba LAN: gach cluicheadair, a ghabhas an òrdachadh a-rèir grunn shlatan-tomhais.'] },
        { id: 'language', t: 'Cànan',
          b: ['Tha an eadar-aghaidh ri fhaotainn ann an 64 cànan. Atharraich e uair sam bith anns na Roghainnean adhartach (clàr a\u2019 ghèar), roinn Eadar-aghaidh a\u2019 chleachdaiche. Fanaidh briathran gnìomh a\u2019 phoker (Fold, Check, Call, Bet, Raise, All-In) sa Bheurla a-rèir gnàth, dìreach mar anns a\u2019 chliant deasg.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Sùm a\u2019 bhùird (fònaichean)',
          b: ['Air sgrìnichean beaga, meudaichidh putanan a\u2019 ghlainne-mheudachaidh am bòrd (2\u00d7) agus \u2019s urrainn dhut a shlaodadh le do mheur — chan fhan ach am bàr gnìomhan far a bheil e; thèid am bogsa agad fhèin a mheudachadh cuideachd agus tillidh an sealladh thuige nuair a thig do chuairt. Leanaidh an sealladh an suidheachan gnìomhach gu fèin-obrachail agus sùmaidh e a-mach aig an showdown airson an t-sealladh fharsaing. Gabhaidh a chur dheth sna Roghainnean adhartach. Nuair a thig do chuairt agus na cairtean coitcheann a-mach às an t-sealladh, nochdaidh lethbhreac beag dhiubh aig mullach a\u2019 bhùird; thoir gnogag air gus leum gu na cairtean agus air ais.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Logaichean làmhan agus an uinneag \u201cLogaichean\u201d',
          b: ['A bharrachd air an loga bheò, thèid gach làmh a chluicheas tu a chlàradh gu h-ionadail sa bhrabhsair agad, san aon chruth ris na faidhlichean loga .pdb aig a\u2019 chliant oifigeil. Liostaichidh an uinneag Logaichean (Roghainnean adhartach \u2192 Teachdaireachdan loga \u2192 Stiùirich na logaichean\u2026) na seiseanan agad agus leigidh i leat obrachadh leotha: ro-shealladh de sheisean le lorg agus soillseachadh, sìoladh a-rèir geama, às-phortadh gu HTML no teacsa lom, sàbhaladh an fhaidhle .pdb amh, no in-phortadh .pdb a chlàraich an cliant deasg. Thèid seiseanan a sguabadh às fear mu seach no uile còmhla (le dearbhadh), agus \u2019s urrainn do ghlèidheadh fèin-obrachail dìreach na 7, 30, 90, 180 no 365 latha mu dheireadh a chumail. Cha tèid logaichean a rinn thu ion-phortadh a sguabadh às gu fèin-obrachail idir. Cuingichidh dara roghainn cò mheud seisean a thèid a chumail, agus gabhaidh an colbh liosta a shlàodadh nas fharsainge.',
              'Gus grunn sheiseanan a ghlanadh còmhla, seallaidh am putan Tagh… bogsa-cromaig ri taobh gach nì: cuir cromag ris an fheadhainn nach eil a dhìth agus sguabaidh Sguab às am baidse gu lèir às dèidh aon dhearbhadh. Air coimpiutair, cuiridh Ctrl (⌘) + briogadh seiseanan ris fear mu seach, agus gabhaidh Shift + briogadh raon slàn.',
        ...
        { id: 'hud', t: 'HUD staitistigean aig na suidheachan',
          b: ['Bidh an HUD a\u2019 ceangal bogsa beag staitistig ri taobh cathair gach cluicheadair, air a thogail o na làmhan a chlàr thu sna logaichean agad: an àireamh de làmhan a chunnaic thu, an uair sin VPIP (cho tric \u2019s a chuireas e airgead a-steach a dh\u2019aon ghnothach ro-flop), PFR (àrdachaidhean ro-flop) agus AF (factar ionnsaigh), le còd dathan o fhulangach gu ionnsaigheach. Fon sin, bheir suaicheantas geàrr-chunntas air a\u2019 chluicheadair ann am faclan \u2014 Teann-Fulangach, Sgaoilte-Ionnsaigheach is mar sin air adhart \u2014 ri taobh cleoc beag far a bheil an cairteal soillsichte ga leughadh o chlì gu deas o theann gu sgaoilte, agus o bhun gu bàrr o fhulangach gu ionnsaigheach. Nochdaidh an suaicheantas on chiad làmh, ach fanaidh e doilleir gu 25 làmhan, far am fàs e earbsach. Thoir gnogadh air bogsa airson priobadh mionaideach leis na h-àireamhan gu lèir (3-bet, continuation bet, fold an aghaidh 3-bet, oidhirpean goid, ìrean showdown\u2026), agus slaod e ma tha e a\u2019 còmhdach rud.',
              'Chan eil fios aig an HUD ach air na chunnaic thu aig na bùird agad fhèin — leughaidh e na logaichean làmhan ionadail agad, agus mar sin feumaidh clàradh a bhith air, agus cha bhi na h-àireamhan brìoghmhor ach às dèidh làmhan gu leòr. Tha e dheth a ghnàth: cuir air e ann an Roghainnean adhartach \u2192 Taic.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Cluicheadair ciùil',
          b: ['Fosglaidh an t-innteart ciùil ann an clàran a\u2019 bhanna-chinn cluicheadair beag airson ceòl cùl-raoin: tagh òran on liosta-chluich, cluich/stad, roimhe/às dèidh, tuaireamach, agus ath-chluich aon òrain, na liosta gu lèir no dad. Thèid an àirde-fuaim, an t-òran a thagh thu agus am modh ath-chluich a chuimhneachadh. Cha tòisich a\u2019 chluich leatha fhèin a-riamh — iarraidh brabhsairean suathadh — agus tha an cluicheadair gu tur neo-eisimeileach o bhuaidhean fuaim a\u2019 gheama.', 'Tha dà òrdaig fon ainm a\u2019 nochdadh a bheil thà measail air na tha a\u2019 cluich. Aon bhòt gun ainm gach uidheam, a\u2019 gabhail a-steach nan rèidiothan, agus faodaidh tu atharrachadh no a toirt air ais uair sam bith; mura seall an gniùomhaiche na h-iomlain, chan fhaic thu ach an òrdag agad fhèin.', "Air iPhone agus iPad cleachdaidh an cluicheadair cluich shìmplidh a ghnàth, gus an lean an ceòl le CarPlay, Bluetooth no sgrìn ghlaiste; thèid an àirde-fuaime a shuidheachadh an uair sin le putanan an uidheim no a’ chàir. Bheir an roghainn “Àirde-fuaime san aplacaid” air ais sleamhnachan na fuaime, an cothromachadh agus am meatair VU, ach faodaidh an fhuaim stad-stad sa chàr."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Càite a bheil na roghainnean',
          b: ['Fosglar na Roghainnean adhartach on innteart gèar ann an clàr banna-chinn sam bith. Tha iad air an cruinneachadh mar a tha sa chliant deasg: Eadar-aghaidh a\u2019 chleachdaiche, Stoidhle, Fuaim, Geama ionadail, Geama lìonraidh, Geama eadar-lìn, Far-ainmean / Avataran, Teachdaireachdan loga, agus Lethbhreac-glèidhidh is ath-shuidheachadh. Tha suidse fhèin aig gach feart a tha sònraichte don lìon an sin, agus mar sin \u2019s urrainn dhut a h-uile càil nach cleachd thu a chur dheth.'] },
        { id: 'cfgxml', t: 'Roghainnean iomlaid leis a\u2019 chliant deasg',
          b: ['\u2019S urrainn do na roghainnean agad siubhal eadar cliantan: tha an roinn Lethbhreac-glèidhidh is ath-shuidheachadh a\u2019 tabhann às-phortadh/in-phortadh an fhaidhle oifigeil config.xml (an \u007e/.pokerth/config.xml sin a chleachdas na cliantan deasg agus QML). Sgrìobhaidh an t-às-phortadh na roghainnean co-roinnte — ainm, roghainnean taisbeanaidh, fuaimean, roghainnean bùird, blinds, stoidhlean — agus cuiridh an t-in-phortadh faidhle on deasg an sàs an seo. Fanaidh roghainnean nach aithne don chliant seo gun bhean san fhaidhle.', 'Bidh na nòtaichean agad mu chluicheadairean a\u2019 siubhal leis an fhaidhle cuideachd — an teacsa agus an rangachadh rionnagan, sgrìobhte mar a leughas na clientan deasg iad. Fanaidh na leubailean dathte anns a\u2019 chliant seo: chan eil raon aca san fhòrmat oifigeil, mar sin cha bhean ion-phortadh riutha idir.'] },
