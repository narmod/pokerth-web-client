  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Cànan',
          b: ['Tha an eadar-aghaidh ri fhaotainn ann an 80 cànan. Atharraich e uair sam bith anns na Roghainnean adhartach (clàr a\u2019 ghèar), roinn Eadar-aghaidh a\u2019 chleachdaiche. Fanaidh briathran gnìomh a\u2019 phoker (Fold, Check, Call, Bet, Raise, All-In) sa Bheurla a-rèir gnàth, dìreach mar anns a\u2019 chliant deasg.'] },
