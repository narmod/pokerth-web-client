  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: "language",
          t: "Tungumál",
          b: [
            "Viðmótið er til á 61 tungumáli. Skiptu um hvenær sem er í ítarlegum valkostum (tannhjólsvalmyndin), undir Notendaviðmót. Aðgerðaorð pókersins (Fold, Check, Call, Bet, Raise, All-In) haldast á ensku samkvæmt hefð, alveg eins og í skjáborðsbiðlaranum."] },
        { id: "pwa",
