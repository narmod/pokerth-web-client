  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Jazyk',
          b: ['Rozhranie je k dispozícii v 71 jazykoch. Kedykoľvek ho zmeníš v Pokročilých možnostiach (menu s ozubeným kolieskom), kategória Používateľské rozhranie. Pokrové akčné termíny (Fold, Check, Call, Bet, Raise, All-In) zostávajú podľa konvencie po anglicky, presne ako v desktopovom klientovi.'] },
