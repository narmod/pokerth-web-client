  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Jazyk',
          b: ['Rozhranie je k dispozícii v 81 jazykoch. Kedykoľvek ho zmeníš v Pokročilých možnostiach (menu s ozubeným kolieskom), kategória Používateľské rozhranie. Pokrové akčné termíny (Fold, Check, Call, Bet, Raise, All-In) zostávajú podľa konvencie po anglicky, presne ako v desktopovom klientovi.'] },
        ...
        { id: 'avatar', t: 'Prezývka a avatar',
          b: ['Pred pripojením si na prihlasovacej obrazovke vyber prezývku a avatar. Na pokerth.net je prezývka menom tvojho účtu; avatary sa s ostatnými hráčmi zdieľajú cez avatarový server.', 'Tvoj avatar sa odošle pri pripojení a všetci hráči vidia práve ten. Ak ho zmeníš počas pripojenia, nový avatar platí až od ďalšieho pripojenia. Začiatočné písmeno (Aa) sa neodosiela: ostatní hráči vidia predvolený avatar.'] }
      ]
    },
    {
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zoom stola (telefóny)',
          b: ['Na malých obrazovkách tlačidlá lupy stôl zväčšia (2\u00d7) a môžeš ho posúvať prstom — na mieste zostáva len panel akcií; tvoj box sa zväčšuje tiež a pohľad sa k nemu vracia, keď si na ťahu. Pohľad automaticky sleduje aktívne miesto a pri showdowne sa oddiali pre celkový prehľad. Vypína sa v Pokročilých možnostiach. Keď si na ťahu a spoločné karty sú mimo pohľadu, zobrazí sa hore na stole ich malá kópia; ťuknutím na ňu preskočíš ku kartám a späť.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Záznamy rúk a okno \u201eLogy\u201c',
          b: ['Okrem živej histórie sa každá odohraná ruka lokálne ukladá do prehliadača, v rovnakom formáte ako súbory logov .pdb oficiálneho klienta. Okno Logy (Pokročilé možnosti \u2192 Správy logu \u2192 Spravovať logy\u2026) vypisuje tvoje relácie a umožňuje s nimi pracovať: náhľad relácie s vyhľadávaním a zvýraznením, filtrovanie podľa hry, export do HTML alebo čistého textu, uloženie surového súboru .pdb, alebo import .pdb nahraného desktopovým klientom. Relácie sa mažú po jednej alebo všetky naraz (s potvrdením) a automatická retencia môže ponechať len posledných 7, 30, 90, 180 alebo 365 dní. Záznamy, ktoré si sami naimportujete, sa nikdy nemažu automaticky. Druhé nastavenie obmedzuje počet uchovaných relácií a stĺpec so zoznamom sa dá potiahnutím rozšíriť.',
              'Ak chcete upratať viacero relacií naraz, tlačidlo Vybrať… zobrazí pri každej položke zaškrtávacie políčko: označte tie zbytočné a Odstrániť odstráni celú skupinu po jedinom potvrdení. Na počítači pridá Ctrl (⌘) + kliknutie relácie po jednej a Shift + kliknutie vyberie celý rozsah.',
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Hudobný prehrávač',
          b: ['Položka hudby v menu hlavičky otvorí malý prehrávač hudby na pozadí: vyber skladbu z playlistu, prehrať/pauza, predchádzajúca/ďalšia, náhodne a opakovanie jednej skladby, celého playlistu alebo ničoho. Hlasitosť, vybraná skladba a režim opakovania sa pamätajú. Prehrávanie nikdy nezačne samo — prehliadače vyžadujú ťuknutie — a prehrávač je úplne nezávislý od herných zvukových efektov.', 'Dva palce pod názvom skladby povedia, či sa ti páči to, čo hrá. Jeden anonymný hlas na zariadenie, vrátane rádií, a kedykoľvek ho môžeš zmeniť alebo vziať späť; kým prevádzkovateľ neodkryje súčty, vidíš len vlastný palec.', "Na iPhone a iPade prehrávač predvolene používa jednoduché prehrávanie, aby hudba hrala ďalej s CarPlay, Bluetooth alebo pri zamknutej obrazovke; hlasitosť sa potom nastavuje tlačidlami zariadenia alebo auta. Voľba „Hlasitosť v aplikácii“ vráti posuvník hlasitosti, vyváženie a VU meter, no zvuk sa v aute môže zasekávať."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Kde možnosti bývajú',
          b: ['Pokročilé možnosti otvoríš položkou s ozubeným kolieskom v ľubovoľnom menu hlavičky. Sú zoskupené ako v desktopovom klientovi: Používateľské rozhranie, Štýl, Zvuk, Lokálna hra, Sieťová hra, Internetová hra, Prezývky / Avatary, Správy logu a Záloha a obnovenie. Každá webová funkcia tam má vlastný vypínač, takže si vypneš všetko, čo nepoužívaš.'] },
        { id: 'cfgxml', t: 'Výmena nastavení s desktopovým klientom',
          b: ['Tvoje nastavenia môžu cestovať medzi klientmi: kategória Záloha a obnovenie ponúka export/import oficiálneho súboru config.xml (toho \u007e/.pokerth/config.xml, ktorý používajú desktopoví a QML klienti). Export zapíše zdieľané nastavenia — meno, možnosti zobrazenia, zvuky, predvoľby stola, blindy, štýly — a import tu aplikuje súbor z desktopu. Nastavenia, ktoré tento klient nepozná, zostanú v súbore nedotknuté.', 'Tvoje poznámky o hráčoch cestujú so súborom tiež — text aj hodnotenie hviezdičkami, zapísané tak, ako ich čítajú desktopoví klienti. Farebné štítky zostávajú v tomto klientovi: oficiálny formát pre ne nemá pole, takže import sa ich nikdy nedotkne.'] },
