    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'journal', t: 'Záznamy rúk a okno \u201eLogy\u201c',
          b: ['Okrem živej histórie sa každá odohraná ruka lokálne ukladá do prehliadača, v rovnakom formáte ako súbory logov .pdb oficiálneho klienta. Okno Logy (Pokročilé možnosti \u2192 Správy logu \u2192 Spravovať logy\u2026) vypisuje tvoje relácie a umožňuje s nimi pracovať: náhľad relácie s vyhľadávaním a zvýraznením, filtrovanie podľa hry, export do HTML alebo čistého textu, uloženie surového súboru .pdb, alebo import .pdb nahraného desktopovým klientom. Relácie sa mažú po jednej alebo všetky naraz (s potvrdením) a automatická retencia môže ponechať len posledných 7, 30 alebo 90 dní.',
        ...
        { id: 'logopts', t: 'Možnosti záznamu',
          b: ['V Pokročilé možnosti \u2192 Správy logu môžeš záznam zapnúť či vypnúť a zvoliť interval zápisu (po každej akcii, alebo raz za ruku), rovnako ako v nastaveniach desktopového klienta. Ďalšia voľba zapisuje súbor .pdb priamo do zvoleného priečinka a aktualizuje ho po každej ruke — presne ako desktopový klient, aby ho iné nástroje mohli čítať naživo.'],
          note: 'Zápis do lokálneho priečinka vyžaduje API File System Access: len desktopový Chrome a Edge. Firefox, Safari a mobilné prehliadače to nevedia — voľba potom zobrazí krátke vysvetlenie a ručný export z okna Logy zostáva dostupný všade.' },
        ...
        { id: 'hud', t: 'HUD štatistík pri miestach (beta)',
          b: ['HUD pripne vedľa miesta každého hráča malý štatistický box zostavený z rúk zaznamenaných v tvojich logoch: počet pozorovaných rúk, ďalej VPIP (ako často dobrovoľne vkladá peniaze pre-flop), PFR (pre-flop navýšenia), AF (faktor agresie), 3B (3-bet), CB (continuation bet) a F3B (fold na 3-bet), s farebnou škálou od pasívneho po agresívneho. Ťuknutím na box otvoríš podrobné okno s ďalšími číslami (pokusy o steal, fold na steal, miery showdownov\u2026), a ak niečo zakrýva, potiahni ho.',
      ...
      sections: [
        ...
        { id: 'cups', t: 'Komunitné poháre: BBC a WeCup',
          b: ['Dve komunity organizujú na pokerth.net vlastné súťaže, každá s vlastným webom a vlastným rebríčkom. Best Brainies Cup (BBC) je stupňový turnaj vzniknutý v roku 2013: postupuje sa od Step 1 k Step 4 a nová sezóna sa začína po každej hre Step 4, keď sa odovzdáva pohár. WeCup (WEC) má vlastnú, oveľa rozloženejšiu stupnicu — 75 bodov za prvé miesto, potom 45, 30, 20… — a jeho score normalizuje tvoj priemer podľa počtu hier, ktoré si odohral, v porovnaní s ostatnými členmi.',
              'Oba rebríčky otvoríš tlačidlom pohára vedľa rebríčka PokerTH. Nastavenia stolov týchto súťaží sú k dispozícii ako predvoľby pri vytváraní hry (BBC Step 1 až 4, WEC a WEC Grand Final), takže môžeš trénovať za rovnakých podmienok. Účasť vyžaduje registráciu na webe príslušného pohára.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'fkeys', t: 'Oficiálne klávesové skratky',
          b: ['Oficiálne funkčné klávesy PokerTH fungujú počas hry:'],
          keys: [
