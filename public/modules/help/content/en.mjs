  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Language',
          b: ['The interface is available in 64 languages. Change it any time in Advanced options (gear menu) under User interface. Poker action terms (Fold, Check, Call, Bet, Raise, All-In) stay in English by convention, exactly like the desktop client.'] },
