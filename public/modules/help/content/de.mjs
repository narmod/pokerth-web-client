  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Sprache',
          b: ['Die Oberfläche ist in 67 Sprachen verfügbar. Ändere sie jederzeit in den Erweiterten Optionen (Zahnrad-Menü) unter Benutzeroberfläche. Die Poker-Aktionsbegriffe (Fold, Check, Call, Bet, Raise, All-In) bleiben per Konvention englisch, genau wie im Desktop-Client.'] },
