  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Jazyk',
          b: ['Rozhraní je k dispozici ve 60 jazycích. Kdykoli ho změníš v Pokročilých možnostech (menu s ozubeným kolem), kategorie Uživatelské rozhraní. Pokerové akční termíny (Fold, Check, Call, Bet, Raise, All-In) zůstávají podle konvence anglicky, přesně jako v desktopovém klientu.'] },
