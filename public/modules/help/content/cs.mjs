    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Možnosti záznamu',
          b: ['V Pokročilé možnosti \u2192 Zprávy logu můžeš záznam zapnout či vypnout a zvolit interval zápisu (po každé akci, nebo jednou za ruku), stejně jako v nastavení desktopového klienta. Další volba zapisuje soubor .pdb přímo do zvolené složky a aktualizuje ho po každé ruce — přesně jako desktopový klient, aby ho jiné nástroje mohly číst živě.'],
          note: 'Zápis do místní složky vyžaduje API File System Access: jen desktopový Chrome a Edge. Firefox, Safari a mobilní prohlížeče to neumí — volba pak zobrazí krátké vysvětlení a ruční export z okna Logy zůstává dostupný všude.' },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'translate', t: 'Rozumět všem',
          b: ['Se zapnutým překladem chatu dostane každá zpráva tlačítko překladu, které ji zobrazí v tvém jazyce pomocí překladače prohlížeče. Běžné stolní zkratky (gg, nh, utg\u2026) se vysvětlí v bublině po najetí — obě volby najdeš v Pokročilé možnosti \u2192 Chat.'],
      ...
      sections: [
        ...
        { id: 'cups', t: 'Komunitní poháry: BBC a WeCup',
          b: ['Dvě komunity pořádají na pokerth.net vlastní soutěže, každá s vlastním webem a vlastním žebříčkem. Best Brainies Cup (BBC) je stupňový turnaj vzniklý v roce 2013: postupuje se od Step 1 ke Step 4 a nová sezóna začíná po každé hře Step 4, kdy se předává pohár. WeCup (WEC) má vlastní, mnohem rozprostřenější stupnici — 75 bodů za první místo, pak 45, 30, 20… — a jeho score normalizuje tvůj průměr podle počtu her, které jsi odehrál, ve srovnání s ostatními členy.',
              'Oba žebříčky otevřeš tlačítkem poháru vedle žebříčku PokerTH. Nastavení stolů těchto soutěží je k dispozici jako předvolby při vytváření hry (BBC Step 1 až 4, WEC a WEC Grand Final), takže můžeš trénovat za stejných podmínek. Účast vyžaduje registraci na webu příslušného poháru.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'webkeys', t: 'Webové písmenné klávesy',
          b: ['Webové rozšíření: akce spouštějí i jednopísmenné klávesy a lze je přemapovat v Pokročilé možnosti \u2192 Klávesové zkratky:'],
          keys: [
            ['F', 'Fold'],
            ['C', 'Check / Call'],
            ['R', 'Raise'],
