  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Rodinný žebříček',
          b: ['Jen na soukromých serverech a v LAN hrách si klient vede souhrnné statistiky podle přezdívek — odehrané a vyhrané ruce i partie, největší výhra, nejlepší série — a sdílí je přes server, takže každé zařízení u stolu vidí stejný žebříček. Hry na pokerth.net se takto nikdy nesledují a statistiky tréninkového režimu zůstávají zcela oddělené.', 'V těchto hrách otevře tlačítko s pohárem okno žebříčků na kartě LAN: všichni hráči, řaditelní podle několika kritérií.'] },
        { id: 'language', t: 'Jazyk',
          b: ['Rozhraní je k dispozici ve 70 jazycích. Kdykoli ho změníš v Pokročilých možnostech (menu s ozubeným kolem), kategorie Uživatelské rozhraní. Pokerové akční termíny (Fold, Check, Call, Bet, Raise, All-In) zůstávají podle konvence anglicky, přesně jako v desktopovém klientu.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zoom stolu (telefony)',
          b: ['Na malých obrazovkách tlačítka lupy stůl zvětší (2\u00d7) a můžeš ho posouvat prstem — na místě zůstává jen panel akcí; tvůj box se zvětšuje také a pohled se k němu vrací, když jsi na tahu. Pohled automaticky sleduje aktivní místo a při showdownu se oddálí pro celkový přehled. Vypíná se v Pokročilých možnostech. Když jsi na tahu a společné karty jsou mimo pohled, objeví se nahoře na stole jejich malá kopie; klepnutím na ni přeskočíš ke kartám a zpět.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Záznamy rukou a okno \u201eLogy\u201c',
          b: ['Kromě živé historie se každá odehraná ruka lokálně ukládá do prohlížeče, ve stejném formátu jako soubory logů .pdb oficiálního klienta. Okno Logy (Pokročilé možnosti \u2192 Zprávy logu \u2192 Spravovat logy\u2026) vypisuje tvá sezení a umožňuje s nimi pracovat: náhled sezení s vyhledáváním a zvýrazněním, filtrování podle hry, export do HTML nebo prostého textu, uložení surového souboru .pdb, nebo import .pdb nahraného desktopovým klientem. Sezení se mažou po jednom nebo všechna najednou (s potvrzením) a automatická retence může ponechat jen posledních 7, 30, 90, 180 nebo 365 dní. Záznamy, které si sami naimportujete, se nikdy nemažou automaticky. Druhé nastavení omezuje počet uchovávaných relací a sloupec se seznamem lze tažením rozšířit.',
              'Chcete-li uklidit několik relací najednou, tlačítko Vybrat… zobrazí u každé položky zaškrtávací pole: označte ty nepotřebné a Smazat odstraní celou skupinu po jediném potvrzení. Na počítači přidá Ctrl (⌘) + kliknutí relace po jedné a Shift + kliknutí vybere celý rozsah.',
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'privatemsg', t: "Soukromé zprávy",
          b: ["Napište jednomu hráči, aniž by to četlo celé lobby. Obálka vedle jména v seznamu hráčů otevře konverzaci s ním; obálka v záhlaví lobby znovu otevře tu poslední. Konverzace se uchovávají v tomto zařízení a po návratu tam stále jsou, takže chat obnovený o několik dní později má svou historii — červený počet na obálce ukazuje, co jste ještě nečetli, a koš v titulku okna konverzaci nenávratně smaže."],
          keys: [
            ["/msg <přezdívka> <zpráva>", "Odeslat soukromou zprávu z chatu lobby"],
            ["/msg \"<přezdívka>\" <zpráva>", "Totéž, když přezdívka obsahuje mezery"]],
          note: "Zprávy jsou omezeny na 128 znaků. Server nedoručí soukromou zprávu hráči, který sedí u běžícího stolu, a historie se ukládá pouze v tomto prohlížeči — na jiné zařízení vás nenásleduje." },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Hudební přehrávač',
          b: ['Položka hudby v menu záhlaví otevře malý přehrávač hudby na pozadí: vyber skladbu z playlistu, přehrát/pauza, předchozí/další, náhodně a opakování jedné skladby, celého playlistu nebo ničeho. Hlasitost, vybraná skladba a režim opakování se pamatují. Přehrávání nikdy nezačne samo — prohlížeče vyžadují klepnutí — a přehrávač je zcela nezávislý na herních zvukových efektech.', 'Dva palce pod názvem skladby řeknou, jestli se ti líbí to, co hraje. Jeden anonymní hlas na zařízení, včetně rádií, a kdykoli ho můžeš změnit nebo vzít zpět; dokud provozovatel neodkryje součty, vidíš jen svůj vlastní palec.', "Na iPhonu a iPadu přehrávač ve výchozím stavu používá prosté přehrávání, aby hudba hrála dál s CarPlay, Bluetooth nebo při zamčené obrazovce; hlasitost se pak nastavuje tlačítky zařízení nebo auta. Volba „Hlasitost v aplikaci“ vrací posuvník hlasitosti, vyvážení a VU metr, ale zvuk se v autě může zadrhávat."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Kde možnosti bydlí',
          b: ['Pokročilé možnosti otevřeš položkou s ozubeným kolem v libovolném menu záhlaví. Jsou seskupené jako v desktopovém klientu: Uživatelské rozhraní, Styl, Zvuk, Místní hra, Síťová hra, Internetová hra, Přezdívky / Avatary, Zprávy logu a Záloha a obnovení. Každá webová funkce tam má vlastní vypínač, takže si vypneš vše, co nepoužíváš.'] },
        { id: 'cfgxml', t: 'Výměna nastavení s desktopovým klientem',
          b: ['Tvá nastavení mohou cestovat mezi klienty: kategorie Záloha a obnovení nabízí export/import oficiálního souboru config.xml (onoho \u007e/.pokerth/config.xml, který používají desktopoví a QML klienti). Export zapíše sdílená nastavení — jméno, možnosti zobrazení, zvuky, předvolby stolu, blindy, styly — a import zde aplikuje soubor z desktopu. Nastavení, která tento klient nezná, zůstanou v souboru netknutá.', 'Tvoje poznámky o hráčích cestují se souborem také — text i hodnocení hvězdičkami, zapsané tak, jak je čtou desktopoví klienti. Barevné štítky zůstávají v tomto klientovi: oficiální formát pro ně nemá pole, import se jich tedy nikdy nedotkne.'] },
        ...
        { id: 'webkeys', t: 'Webové písmenné klávesy',
          ...
          keys: [
            ...
            ['\u2191 \u2193 \u00b7 \u21b5', 'Seznam stolů v lobby (přejdete na něj Tabem): výběr stolu · připojení']],
