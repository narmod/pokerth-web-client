    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zoom stolu (telefony)',
          b: ['Na malých obrazovkách tlačítka lupy stůl zvětší (2\u00d7) a můžeš ho posouvat prstem — na místě zůstává jen panel akcí; tvůj box se zvětšuje také a pohled se k němu vrací, když jsi na tahu. Pohled automaticky sleduje aktivní místo a při showdownu se oddálí pro celkový přehled. Vypíná se v Pokročilých možnostech.'],
