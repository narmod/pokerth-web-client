  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Keel',
          b: ['Liides on saadaval 72 keeles. Muuda seda millal tahes täpsemates valikutes (hammasrattamenüü) jaotises Kasutajaliides. Pokkeri käiguterminid (Fold, Check, Call, Bet, Raise, All-In) jäävad kokkuleppeliselt inglise keelde, täpselt nagu töölauakliendis.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Laua suum (telefonid)',
          b: ['Väikestel ekraanidel suurendavad suurendusnupud lauda (2\u00d7) ja vaadet saab sõrmega liigutada \u2014 paigale jääb ainult käiguriba; ka sinu enda kasti suurendatakse ja vaade naaseb selle juurde, kui on sinu kord. Vaade järgib automaatselt aktiivset istekohta ja suumib showdown\u2019il ülevaate saamiseks tagasi välja. Selle saab täpsemates valikutes välja lülitada. Kui on sinu kord ja ühised kaardid on vaatest väljas, ilmub laua ülaossa nende väike koopia; puuduta seda, et hüpata kaartide juurde ja tagasi.'],
