  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Keel',
          b: ['Liides on saadaval 60 keeles. Muuda seda millal tahes täpsemates valikutes (hammasrattamenüü) jaotises Kasutajaliides. Pokkeri käiguterminid (Fold, Check, Call, Bet, Raise, All-In) jäävad kokkuleppeliselt inglise keelde, täpselt nagu töölauakliendis.'] },
