  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Jezik',
          b: ['Sučelje je dostupno na 73 jezika. Promijeni ga bilo kada u Naprednim opcijama (izbornik sa zupčanikom), kategorija Korisničko sučelje. Pokerski izrazi za akcije (Fold, Check, Call, Bet, Raise, All-In) ostaju na engleskom prema konvenciji, točno kao u desktop klijentu.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zumiranje stola (telefoni)',
          b: ['Na malim zaslonima gumbi s povećalom povećavaju stol (2\u00d7) i možeš ga vući prstom — na mjestu ostaje samo traka akcija; i tvoja kutija se povećava, a prikaz se vraća na nju kad si ti na potezu. Prikaz automatski prati aktivno mjesto i udaljava se pri showdownu za cjelovitu sliku. Isključuje se u Naprednim opcijama. Kad si na potezu, a zajedničke karte su izvan prikaza, na vrhu stola pojavljuje se njihova mala kopija; dodirni je za skok do karata i natrag.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Dnevnici ruku i prozor \u201eZapisnici\u201c',
          b: ['Osim dnevnika uživo, svaka odigrana ruka lokalno se snima u tvoj preglednik, u istom formatu kao .pdb datoteke zapisnika službenog klijenta. Prozor Zapisnici (Napredne opcije \u2192 Poruke zapisnika \u2192 Upravljanje zapisnicima\u2026) navodi tvoje sesije i omogućuje rad s njima: pregled sesije s pretraživanjem i isticanjem, filtriranje po partiji, izvoz u HTML ili obični tekst, spremanje sirove .pdb datoteke ili uvoz .pdb-a snimljenog desktop klijentom. Sesije se brišu jedna po jedna ili sve odjednom (uz potvrdu), a automatsko zadržavanje može čuvati samo zadnjih 7, 30, 90, 180 ili 365 dana. Zapisi koje sami uvezete nikada se ne brišu automatski. Druga postavka ograničava koliko se sesija čuva, a stupac s popisom može se povući širi.',
              'Za čišćenje više sesija odjednom, gumb Odaberi… prikazuje kućicu uz svaki unos: označite one koje više ne trebate i Obriši uklanja cijelu skupinu nakon jedne potvrde. Na računalu Ctrl (⌘) + klik dodaje sesije jednu po jednu, a Shift + klik uzima cijeli raspon.',
        ...
        { id: 'hud', t: 'HUD sa statistikama uz mjesta',
          b: ['HUD uz mjesto svakog igrača lijepi malu kutiju sa statistikom, izgrađenu od dijeljenja koja si zabilježio u svojim dnevnicima: broj promatranih dijeljenja, zatim VPIP (koliko često dobrovoljno ulaže novac pre-flop), PFR (pre-flop povišenja) i AF (faktor agresivnosti), obojeno od pasivnog do agresivnog. Ispod njih značka sažima igrača riječima \u2014 Tijesan-Pasivan, Labav-Agresivan i tako dalje \u2014 uz mali brojčanik čiji se osvijetljeni kvadrant čita slijeva nadesno od tijesnog do labavog, a odozdo prema gore od pasivnog do agresivnog. Značka se pojavljuje već od prvog dijeljenja, ali ostaje prigušena do 25 dijeljenja, od kada postaje pouzdana. Dodirni kutiju za detaljni skočni prozor sa svim brojkama (3-bet, continuation bet, fold na 3-bet, pokušaji krađe, stope showdowna\u2026), i povuci je ako nešto zaklanja.',
              'HUD zna samo ono što si vidio za vlastitim stolovima — čita tvoje lokalne dnevnike ruku, pa snimanje mora biti uključeno, a brojke dobivaju smisao tek nakon dovoljno ruku. Isključena je prema zadanim postavkama: uključi je u Napredne opcije \u2192 Pomoćnik.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Glazbeni player',
          b: ['Stavka glazbe u izbornicima zaglavlja otvara mali player ambijentalne glazbe: odaberi pjesmu s popisa, reprodukcija/pauza, prethodna/sljedeća, nasumično te ponavljanje jedne pjesme, cijelog popisa ili ničega. Glasnoća, odabrana pjesma i način ponavljanja pamte se. Reprodukcija nikad ne počinje sama — preglednici zahtijevaju dodir — a player je potpuno neovisan o zvučnim efektima igre.', 'Dva palca ispod naslova pjesme govore sviđa li ti se ono što svira. Jedan anoniman glas po uređaju, uključujući radijske postaje, i možeš ga promijeniti ili povući u bilo kojem trenutku; dok operater ne otkrije zbrojeve, vidiš samo vlastiti palac.', "Na iPhoneu i iPadu player zadano koristi običnu reprodukciju, kako bi glazba nastavila svirati uz CarPlay, Bluetooth ili zaključan zaslon; glasnoća se tada podešava tipkama uređaja ili automobila. Opcija „Glasnoća u aplikaciji“ vraća klizač glasnoće, balans i VU-metar, ali zvuk u autu može zastajkivati."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Gdje opcije žive',
          b: ['Napredne opcije otvaraju se stavkom sa zupčanikom u bilo kojem izborniku zaglavlja. Grupirane su kao u desktop klijentu: Korisničko sučelje, Stil, Zvuk, Lokalna partija, Mrežna partija, Internetska partija, Nadimci / Avatari, Poruke zapisnika i Sigurnosna kopija i vraćanje. Svaka funkcija specifična za web ondje ima vlastiti prekidač, pa možeš isključiti sve što ne koristiš.'] },
        { id: 'cfgxml', t: 'Razmjena postavki s desktop klijentom',
          b: ['Tvoje postavke mogu putovati između klijenata: kategorija Sigurnosna kopija i vraćanje nudi izvoz/uvoz službene datoteke config.xml (onog \u007e/.pokerth/config.xml koji koriste desktop i QML klijenti). Izvoz zapisuje dijeljene postavke — ime, opcije prikaza, zvukove, preferencije stola, blindove, stilove — a uvoz ovdje primjenjuje datoteku s računala. Postavke koje ovaj klijent ne poznaje ostaju netaknute u datoteci.', 'Tvoje bilješke o igračima putuju s datotekom također — tekst i ocjena zvjezdicama, zapisani onako kako ih čitaju stolni klijenti. Bojane oznake ostaju u ovom klijentu: službeni format za njih nema polje, pa ih uvoz nikada ne dira.'] },
