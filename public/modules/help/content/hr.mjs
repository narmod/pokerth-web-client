  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Jezik',
          b: ['Sučelje je dostupno na 67 jezika. Promijeni ga bilo kada u Naprednim opcijama (izbornik sa zupčanikom), kategorija Korisničko sučelje. Pokerski izrazi za akcije (Fold, Check, Call, Bet, Raise, All-In) ostaju na engleskom prema konvenciji, točno kao u desktop klijentu.'] },
