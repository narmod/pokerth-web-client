    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Opcije zapisnika',
          b: ['U Napredne opcije \u2192 Poruke zapisnika možeš uključiti ili isključiti snimanje i odabrati interval zapisivanja (nakon svake akcije ili jednom po ruci), kao u postavkama desktop klijenta. Dodatna opcija zapisuje .pdb datoteku izravno u mapu po tvom izboru i ažurira je nakon svake ruke — točno kao desktop klijent, da je drugi alati mogu čitati uživo.'],
          note: 'Zapisivanje u lokalnu mapu zahtijeva API File System Access: samo Chrome i Edge na računalu. Firefox, Safari i mobilni preglednici ne mogu — opcija tada prikazuje kratko objašnjenje, a ručni izvoz iz prozora Zapisnici ostaje dostupan posvuda.' },
      ...
      sections: [
        ...
        { id: 'cups', t: 'Kupovi zajednice: BBC i WeCup',
          b: ['Dvije zajednice na pokerth.netu vode vlastita natjecanja, svaka sa svojim web-mjestom i vlastitom ljestvicom. Best Brainies Cup (BBC) stepenasti je turnir nastao 2013.: napreduje se od Step 1 do Step 4, a nova sezona počinje nakon svake partije Step 4, kad se dodijeli pehar. WeCup (WEC) ima vlastitu, znatno razvučeniju ljestvicu — 75 bodova za prvo mjesto, zatim 45, 30, 20… — a njegov score normalizira tvoj prosjek prema broju partija koje si odigrao u usporedbi s ostalim članovima.',
              'Obje se ljestvice otvaraju gumbom pehara, pokraj ljestvice PokerTH. Postavke stolova tih natjecanja dolaze kao predlošci pri stvaranju partije (BBC Step 1 do 4, WEC i WEC Grand Final), pa možeš vježbati u istim uvjetima. Sudjelovanje traži prijavu na web-mjestu dotičnog kupa.'],
