  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Idioma',
          b: ['A interface está disponível em 82 idiomas. Muda-o a qualquer momento nas Opções avançadas (menu da engrenagem), categoria Interface do utilizador. Os termos de ação do póquer (Fold, Check, Call, Bet, Raise, All-In) mantêm-se em inglês por convenção, exatamente como no cliente de secretária.'] },
