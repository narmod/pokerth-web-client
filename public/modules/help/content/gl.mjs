  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'famboard', t: 'Clasificación familiar',
          b: ['Só en servidores privados e partidas LAN, o cliente garda estatísticas acumuladas por alcume — mans e partidas xogadas e gañadas, maior ganancia, mellor racha — e compárteas a través do servidor, de xeito que cada dispositivo arredor da mesa vexa a mesma clasificación. As partidas de pokerth.net nunca se rexistran así, e as estatísticas do modo adestramento gárdanse completamente á parte.', 'Nestas partidas, o botón do trofeo abre a xanela de clasificacións na súa lapela LAN: todos os xogadores, ordenables segundo varios criterios.'] },
        { id: 'language', t: 'Idioma',
          b: ['A interface está dispoñible en 78 idiomas. Cámbiao cando queiras nas Opcións avanzadas (menú da engrenaxe), categoría Interface de usuario. Os termos de acción do póker (Fold, Check, Call, Bet, Raise, All-In) manteñen o inglés por convención, igual ca no cliente de escritorio.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zoom da mesa (móbiles)',
          b: ['En pantallas pequenas, os botóns de lupa amplían a mesa (2\u00d7) e podes arrastrala co dedo — só a barra de accións queda fixa; a túa caixa tamén se amplía e a vista volve a ela cando é a túa quenda. A vista segue automaticamente o asento activo e afástase no showdown para ver o conxunto. Pódese desactivar nas Opcións avanzadas. Na túa quenda, se as cartas comúns quedan fóra da vista, aparece unha pequena copia na parte superior da mesa; tócaa para ir ás cartas e volver.'],
      ...
      sections: [
        ...
        { id: 'journal', t: 'Rexistros de mans e a xanela \u00abRexistros\u00bb',
          b: ['Alén do rexistro en directo, cada man que xogas grávase localmente no teu navegador, no mesmo formato ca os ficheiros de rexistro .pdb do cliente oficial. A xanela Rexistros (Opcións avanzadas \u2192 Mensaxes de rexistro \u2192 Xestionar os rexistros\u2026) lista as túas sesións e permíteche traballar con elas: previsualizar unha sesión con busca e realce, filtrar por partida, exportar a HTML ou texto plano, gardar o ficheiro .pdb en bruto, ou importar un .pdb gravado polo cliente de escritorio. As sesións bórranse unha a unha ou todas de vez (con confirmación), e unha retención automática pode conservar só os últimos 7, 30, 90, 180 ou 365 días. Os rexistros que importas ti nunca se eliminan automaticamente. Un segundo axuste limita cantas sesións se conservan, e a columna da lista pódese ensanchar arrastrando.',
              'Para baleirar varias sesións dunha vez, o botón Seleccionar… mostra unha caixa en cada entrada: marca as que sobran e Borrar elimina todo o lote tras unha única confirmación. No ordenador, Ctrl (⌘) + clic engade sesións unha a unha e Maiús + clic colle un intervalo enteiro.',
        ...
        { id: 'hud', t: 'HUD de estatísticas nos asentos',
          b: ['O HUD engade unha pequena caixa de estatísticas a carón do asento de cada xogador, construída a partir das mans que rexistraches nos teus rexistros: número de mans observadas, logo VPIP (con que frecuencia mete cartos voluntariamente pre-flop), PFR (subidas pre-flop) e AF (factor de agresividade), cun código de cor do pasivo ao agresivo. Debaixo, unha insignia resume o xogador en palabras \u2014 Pechado-Pasivo, Aberto-Agresivo, etc. \u2014 a carón dun pequeno cadrante no que o sector aceso se le de esquerda a dereita de pechado a aberto, e de abaixo arriba de pasivo a agresivo. A insignia aparece desde a primeira man pero queda atenuada ata as 25 mans, limiar a partir do cal se volve fiable. Toca unha caixa para un popover detallado con todas as cifras (3-bet, continuation bet, fold ante o 3-bet, intentos de roubo, taxas de showdown\u2026), e arrástraa se tapa algo.',
              'O HUD só sabe o que viches nas túas propias mesas — le os teus rexistros locais de mans, así que a gravación ten que estar activada e as cifras só teñen sentido tras suficientes mans. Está desactivada por defecto: actívaa en Opcións avanzadas \u2192 Asistencia.'] },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'privatemsg', t: "Mensaxes privadas",
          b: ["Escribe a un só xogador sen que todo o lobby o lea. O sobre xunto a un nome na lista de xogadores abre unha conversa con el; o sobre da cabeceira do lobby volve abrir a última. As conversas gárdanse neste dispositivo e seguen aí cando volves, de xeito que un chat retomado días despois conserva o seu historial — un contador vermello no sobre indica o que aínda non liches, e a papeleira do título da xanela borra unha conversa definitivamente."],
          keys: [
            ["/msg <alcume> <mensaxe>", "Enviar unha mensaxe privada desde o chat do lobby"],
            ["/msg \"<alcume>\" <mensaxe>", "O mesmo, cando o alcume contén espazos"]],
          note: "As mensaxes están limitadas a 128 caracteres. O servidor non entrega unha mensaxe privada a un xogador sentado nunha mesa en curso, e o historial só se garda neste navegador — non te segue a outro dispositivo." },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'music', t: 'Reprodutor de música',
          b: ['A entrada de música dos menús de cabeceira abre un pequeno reprodutor de música ambiental: escolle unha pista da lista, reproducir/pausar, anterior/seguinte, aleatorio, e repetición dunha pista, de toda a lista ou de nada. O volume, a pista escollida e o modo de repetición lémbranse. A reprodución nunca comeza soa — os navegadores esixen un toque — e o reprodutor é totalmente independente dos efectos de son do xogo.', 'Dous polgares baixo o título da pista din se che gusta o que soa. Un voto anónimo por dispositivo, radios incluídas, e podes cambialo ou retiralo cando queiras; se o operador non mostra os totais, só ves o teu polgar.', "No iPhone e no iPad o reprodutor usa por defecto unha reprodución simple, para que a música siga soando con CarPlay, Bluetooth ou a pantalla bloqueada; o volume axústase entón cos botóns do dispositivo ou do coche. A opción «Volume na app» recupera o control de volume, o balance e o vúmetro, pero o son pode entrecortarse no coche."] },
    ...
    },
    {
      ...
      sections: [
        { id: 'where', t: 'Onde viven as opcións',
          b: ['As Opcións avanzadas ábrense desde a entrada da engrenaxe de calquera menú de cabeceira. Están agrupadas coma no cliente de escritorio: Interface de usuario, Estilo, Son, Partida local, Partida en rede, Partida por internet, Alcumes / Avatares, Mensaxes de rexistro, e Copia de seguranza e restablecemento. Cada función específica da web ten alí o seu propio interruptor, así podes desactivar todo o que non uses.'] },
        { id: 'cfgxml', t: 'Intercambiar axustes co cliente de escritorio',
          b: ['Os teus axustes poden viaxar entre clientes: a categoría Copia de seguranza e restablecemento ofrece exportación/importación do ficheiro oficial config.xml (aquel \u007e/.pokerth/config.xml que usan os clientes de escritorio e QML). A exportación escribe os axustes compartidos — nome, opcións de visualización, sons, preferencias de mesa, cegas, estilos — e a importación aplica aquí un ficheiro do escritorio. Os axustes que este cliente non coñece consérvanse intactos no ficheiro.', 'As túas notas de xogador tamén viaxan co ficheiro: o texto e a valoración con estrelas, escritos tal e como os len os clientes de escritorio. As etiquetas de cor quedan neste cliente: o formato oficial non ten un campo para elas, así que unha importación nunca as toca.'] },
