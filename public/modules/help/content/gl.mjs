    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'logopts', t: 'Opcións de rexistro',
          b: ['En Opcións avanzadas \u2192 Mensaxes de rexistro podes activar ou desactivar a gravación e escoller o intervalo de escritura (tras cada acción, ou unha vez por man), como nos axustes do cliente de escritorio. Unha opción adicional escribe o ficheiro .pdb directamente nun cartafol da túa escolla e actualízao tras cada man — exactamente como fai o cliente de escritorio, para que outras ferramentas o poidan ler en directo.'],
          note: 'Escribir nun cartafol local require a API File System Access: só Chrome e Edge de escritorio. Firefox, Safari e os navegadores móbiles non poden — a opción amosa entón unha breve explicación, e a exportación manual desde a xanela Rexistros segue dispoñible en todas partes.' },
      ...
      sections: [
        ...
        { id: 'cups', t: 'As copas da comunidade: BBC e WeCup',
          b: ['Dúas comunidades organizan as súas propias competicións en pokerth.net, cada unha co seu sitio e a súa clasificación. A Best Brainies Cup (BBC) é un torneo por etapas nacido en 2013: progrésase do Step 1 ao Step 4, e unha nova temporada comeza tras cada partida de Step 4, cando se entrega a copa. A WeCup (WEC) ten o seu propio baremo, moito máis repartido — 75 puntos para o primeiro posto, despois 45, 30, 20… — e a súa score normaliza a túa media segundo o número de partidas que xogaches en comparación cos demais membros.',
              'As dúas clasificacións ábrense desde o botón do trofeo, ao lado da clasificación de PokerTH. Os axustes de mesa destas competicións veñen como predefinicións ao crear unha partida (BBC Step 1 a 4, WEC e WEC Grand Final), así que podes adestrar nas mesmas condicións. Participar require rexistrarse no sitio da copa correspondente.'],
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'fkeys', t: 'Atallos de teclado oficiais',
          b: ['As teclas de función oficiais de PokerTH funcionan durante unha partida:'],
          keys: [
