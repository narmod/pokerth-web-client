    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'zoom', t: 'Zoom da mesa (móbiles)',
          b: ['En pantallas pequenas, os botóns de lupa amplían a mesa (2\u00d7) e podes arrastrala co dedo — só a barra de accións queda fixa; a túa caixa tamén se amplía e a vista volve a ela cando é a túa quenda. A vista segue automaticamente o asento activo e afástase no showdown para ver o conxunto. Pódese desactivar nas Opcións avanzadas.'],
