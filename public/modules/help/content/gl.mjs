  ...
  chapters: [
    {
      ...
      sections: [
        ...
        { id: 'language', t: 'Idioma',
          b: ['A interface está dispoñible en 76 idiomas. Cámbiao cando queiras nas Opcións avanzadas (menú da engrenaxe), categoría Interface de usuario. Os termos de acción do póker (Fold, Check, Call, Bet, Raise, All-In) manteñen o inglés por convención, igual ca no cliente de escritorio.'] },
