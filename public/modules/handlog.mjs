...
// « N » est du langage courant → traduit dans les 45 langues.
const COLS = [
...
// Exposé pour le module journal (import de .pdb : lecture SQLite).
if (typeof window !== 'undefined') window._loadSqlJs = _loadSqlJs;
