...
export const strings = {
  ...
  sectionSeat: 'Chỗ ngồi',    botDifficulty:'Độ khó của bot', botEasy:'Dễ', botMixed:'Hỗn hợp', botNormal:'Bình thường', botHard:'Khó',
    ...
    logCopied:'Đã sao chép nhật ký', logEmpty:'Nhật ký trống', gnBtn:'Thông báo chung (quản trị)',gnSent:'Thông báo chung đã được gửi tới mọi người chơi.',gnRejected:'Máy chủ đã từ chối thông báo chung.',logExportTitle:'Xuất nhật ký', chatClearTitle:'Xóa trò chuyện',
