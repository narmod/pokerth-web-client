...
export const strings = {
  ...
  sectionSeat: 'Chỗ ngồi',    botDifficulty:'Độ khó của bot', botEasy:'Dễ', botMixed:'Hỗn hợp', botNormal:'Bình thường', botHard:'Khó',
    ...
    pvSrv1:'Thống kê lượt truy cập: một mã định danh ngẫu nhiên do trình duyệt tạo ra dùng để đếm số thiết bị khác nhau và số lượt truy cập. Máy chủ chỉ lưu dạng băm của nó, không bao giờ kèm tên hay địa chỉ IP. Số liệu theo ngày bị xóa sau khoảng 13 tháng; các mã định danh đã băm dùng để phân biệt thiết bị mới với thiết bị quay lại được giữ lâu hơn. Trình duyệt, hệ điều hành và ngôn ngữ chỉ được đếm dưới dạng tổng.',
