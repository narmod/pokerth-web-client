...
export const strings = {
  ...
  sectionSeat: 'Chỗ ngồi',    botDifficulty:'Độ khó của bot', botEasy:'Dễ', botMixed:'Hỗn hợp', botNormal:'Bình thường', botHard:'Khó',
    ...
    advIgnoredDesc:'Người chơi trong danh sách bỏ qua bị ẩn khỏi trò chuyện.', advIgnoredEmpty:'(không có người chơi bị bỏ qua)', advIgnoredRemove:'Gỡ bỏ', advLobbyChat:'Hiện trò chuyện sảnh', advBackGuard:'Nút Quay lại đóng cửa sổ thay vì rời khỏi ván chơi (Android)', backAgainToExit:'Nhấn Quay lại lần nữa để thoát', advBrowserZoom:'Cho phép thu phóng trình duyệt (chụm ngón tay) trên điện thoại / máy tính bảng', accessibilityTitle:'Accessibility', accessibilityInterfaceSize:'Interface size', accessibilityStandard:'Standard', accessibilityLarge:'Large', accessibilityExtraLarge:'Extra Large', accessibilityHighContrast:'High contrast', accessibilityReset:'Reset accessibility preferences', advTableZoom:'Bật thu phóng bàn (nút kính lúp)',
