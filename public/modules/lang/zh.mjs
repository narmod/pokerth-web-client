...
export const strings = {
  ...
  sectionSeat: '座位',    botDifficulty:'机器人难度', botEasy:'简单', botMixed:'混合', botNormal:'普通', botHard:'困难',
    ...
    advSecIgnored:'已忽略的玩家', advIgnoredDesc:'忽略列表中的玩家在聊天中被隐藏。', advIgnoredEmpty:'（没有已忽略的玩家）', advIgnoredRemove:'移除', advLobbyChat:'显示大厅聊天', advBrowserZoom:'允许在手机 / 平板上使用浏览器缩放（双指缩放）', advTableZoom:'启用牌桌缩放（放大镜按钮）', advChatTranslate:'聊天翻译（Google 翻译，每条消息一个按钮）',
