...
export const strings = {
  ...
  sectionSeat: '座位',    botDifficulty:'机器人难度', botEasy:'简单', botMixed:'混合', botNormal:'普通', botHard:'困难',
    ...
    quickCreateBtn: '创建',
    logPanelTitle: '日志',
    logCopied:'日志已复制', logEmpty:'日志为空', gnBtn:'全局公告（管理员）',gnSent:'全局公告已发送给所有玩家。',gnRejected:'服务器拒绝了这条全局公告。',advChatClearLogin:'连接时清空大厅聊天', advGuardRaise:'确认超出允许范围的下注金额', raiseAdjusted:'金额已调整 — 再按一次确认', logExportTitle:'导出日志', chatClearTitle:'清除聊天',
    jumpLatest:'跳到最新',
