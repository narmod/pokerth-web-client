...
export const strings = {
  ...
  sectionSeat: 'Seats',    guestHint:'🌐 Guest play on pokerth.net — no account needed.',
    ...
    advSecLogSettings:'Log settings', advLogOn:'Enable logging', advStatsTrack:'Record hand statistics', advSecStatsExport:'Statistics export', advStatsExportDesc:'Export recorded hands as a .pdb file, importable in PokerTH Tracker.', advStatsExportSession:'Export session', advStatsExportAll:'Export all history', advLogInterval:'Log interval', advLogEveryAction:'Every action', advLogEveryHand:'Every hand',
