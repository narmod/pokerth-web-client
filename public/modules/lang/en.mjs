...
export const strings = {
  ...
  hdrWaitingPlayers:'Waiting for players', hdrSpectatingWait:'Spectating \u2014 waiting for the next hand', wpWaitingPlayers:'Waiting for players …', wpFillBots:'Fill up with computer players', wpStartGame:'Start Game', wpLeaveGame:'Leave Game', wpInvite:'Invite friends', advInviteLink:'Show the “Invite friends” button in the waiting room', sharedTableNotFound:'🔗 Shared table not found — it may have already ended.', invWarnInviteOnly:'Invite-only table: the link is not enough — once your friend is online, invite them from the player list.', invWarnGuests:'Registered-players or ranking table: friends without a pokerth.net account cannot join.', invWarnLocalhost:'Local server address (localhost): this link only works on this device.', sharedTableRunning:'🔗 The shared table has already started — watching as a spectator.',
  ...
  sectionSeat: 'Seats',    guestHint:'🌐 Guest play on pokerth.net — no account needed.',
    ...
    forumTabPosts:'Posts', forumTabEvents:'Events', evUpcoming:'Upcoming', evChampions:'Champions of the day', evResults:'Latest results', evSignups:'Signed up: {n}', evError:'Could not load the events.', evNone:'No upcoming events.', evOpenSite:'Open the site',
