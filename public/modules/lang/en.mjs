...
export const strings = {
  ...
  sectionSeat: 'Seats',    guestHint:'🌐 Guest play on pokerth.net — no account needed.',
    ...
    advSecLogSettings:'Log settings', advLogOn:'Enable logging', advStatsTrack:'Record hand statistics', advLogInterval:'Log interval', advLogEveryAction:'Every action', advLogEveryHand:'Every hand',
