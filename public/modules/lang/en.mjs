...
export const strings = {
  ...
  sectionSeat: 'Seats',    guestHint:'🌐 Guest play on pokerth.net — no account needed.',
    ...
    forumTooltip:'Forum', forumTitle:'Forum news', forumMarkRead:'Mark all as read', forumOpen:'Open the forum', forumError:'Could not load the forum feed.', advForumNews:'Forum button in the lobby header', forumOpenPost:'Open the post',
