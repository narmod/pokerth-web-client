...
export const strings = {
  ...
  sectionSeat: 'Seats',    guestHint:'🌐 Guest play on pokerth.net — no account needed.',
    ...
    pvSrv1:'Visit statistics: a random identifier created by your browser counts distinct devices and visits. The server stores only a hashed form of it, never with a name or an IP address. Daily figures are deleted after about 13 months; the hashed identifiers used to tell new from returning devices are kept longer. Browser, operating system and language are only counted as totals.',
