...
export const strings = {
    ...
    bntRockGreet1:'Evening. Let\'s play some cards.', bntRockGreet2:'I\'ll be here a while.', bntRockGreet3:'Cards down, patience up.', bntRockGreet4:'Let\'s see what the deck says.', bntRockBig1:'Patience pays.', bntRockBig2:'Told you I\'d wait for one.', bntRockBig3:'That\'ll do.', bntRockBig4:'Textbook value.', bntRockBad1:'Fine. Next hand.', bntRockBad2:'Can\'t win them all.', bntRockBad3:'Noted.', bntRockBad4:'That\'s poker.', bntRockSteal1:'Sometimes a bet is enough.', bntRockSteal2:'No need to show that.', bntRockSteal3:'Cheap pot\'s still a pot.', bntRockSteal4:'Didn\'t need the cards.', bntRockBust1:'Well played, table.', bntRockBust2:'Ran good against me.', bntRockBust3:'I\'ll watch the rest.', bntRockBust4:'Out. GG.', bntRockVictory1:'Patience, as always.', bntRockVictory2:'Slow and steady.', bntRockVictory3:'Good game, everyone.', bntRockVictory4:'That\'s how it\'s done.', bntRockRunnerup1:'Well earned.', bntRockRunnerup2:'Good game.', bntRockRunnerup3:'You played it well.', bntRockRunnerup4:'Next time, maybe.',
    bntTagGreet1:'Let\'s play good poker.', bntTagGreet2:'Ready when you are.', bntTagGreet3:'Good luck, everyone.', bntTagGreet4:'Let\'s see some hands.', bntTagBig1:'Textbook.', bntTagBig2:'That\'s how you play it.', bntTagBig3:'Right spot, right hand.', bntTagBig4:'Value, front to back.', bntTagBad1:'Can\'t win \'em all.', bntTagBad2:'Ran into it, happens.', bntTagBad3:'Good for you.', bntTagBad4:'I\'ll take that one on the chin.', bntTagSteal1:'Sometimes the bet does the work.', bntTagSteal2:'No showdown needed.', bntTagSteal3:'I\'ll take it.', bntTagSteal4:'Free chips, I\'ll take those.', bntTagBust1:'Good run while it lasted.', bntTagBust2:'GG, well played.', bntTagBust3:'That\'s poker for you.', bntTagBust4:'I\'ll catch the rest from the rail.', bntTagVictory1:'GG everyone, good game.', bntTagVictory2:'Solid table tonight.', bntTagVictory3:'That\'s a win.', bntTagVictory4:'Good games all around.', bntTagRunnerup1:'Well played.', bntTagRunnerup2:'Deserved win.', bntTagRunnerup3:'GG, nicely done.', bntTagRunnerup4:'Good game.',
    bntLagGreet1:'Let\'s get some chips moving.', bntLagGreet2:'Hope you brought your A-game.', bntLagGreet3:'Time to gamble a little.', bntLagGreet4:'Let\'s make this interesting.', bntLagBig1:'Told you I had it!', bntLagBig2:'That\'s what I\'m talking about.', bntLagBig3:'Never doubt me.', bntLagBig4:'Boom. Called it.', bntLagBad1:'Rigged table, I swear 😤', bntLagBad2:'Unlucky! I\'ll get it back.', bntLagBad3:'That one stings.', bntLagBad4:'Ok you got me, this time.', bntLagSteal1:'Didn\'t even need the cards.', bntLagSteal2:'Too easy.', bntLagSteal3:'That\'s the move.', bntLagSteal4:'Pressure works.', bntLagBust1:'Went out swinging.', bntLagBust2:'No regrets.', bntLagBust3:'That\'s how I roll.', bntLagBust4:'See you next game.', bntLagVictory1:'Never in doubt!', bntLagVictory2:'That\'s why I play loose.', bntLagVictory3:'GG, that was fun.', bntLagVictory4:'Told you I had it in me.', bntLagRunnerup1:'Nice one, close game.', bntLagRunnerup2:'You got lucky, respect.', bntLagRunnerup3:'Good game, for real.', bntLagRunnerup4:'I\'ll get you next time.',
    bntStationGreet1:'Hi everyone, good luck!', bntStationGreet2:'Excited to play!', bntStationGreet3:'Let\'s have some fun.', bntStationGreet4:'Hope for good cards.', bntStationBig1:'Ha, I got there!', bntStationBig2:'It worked out!', bntStationBig3:'Lucky me!', bntStationBig4:'I stayed in for a reason!', bntStationBad1:'Well, worth a shot.', bntStationBad2:'So close!', bntStationBad3:'Aw, almost had it.', bntStationBad4:'Guess it wasn\'t meant to be.', bntStationSteal1:'Oh, nobody called? Okay!', bntStationSteal2:'I\'ll take it, thanks!', bntStationSteal3:'That works too!', bntStationSteal4:'Didn\'t expect that!', bntStationBust1:'Aw, that\'s it for me.', bntStationBust2:'Good game though!', bntStationBust3:'Had fun while it lasted.', bntStationBust4:'See you all next time!', bntStationVictory1:'Wow, I actually won!', bntStationVictory2:'Didn\'t see that coming!', bntStationVictory3:'Thanks for playing, everyone!', bntStationVictory4:'That was so much fun!', bntStationRunnerup1:'Great game, congrats!', bntStationRunnerup2:'Well deserved!', bntStationRunnerup3:'That was fun, well played!', bntStationRunnerup4:'Nice win!',
    bntManiacGreet1:'LET\'S GAMBLE!', bntManiacGreet2:'Who\'s ready for chaos?', bntManiacGreet3:'No fold left behind!', bntManiacGreet4:'Buckle up.', bntManiacBig1:'BOOM! 💥', bntManiacBig2:'LET\'S GOOOO!', bntManiacBig3:'THAT\'S what I\'m here for!', bntManiacBig4:'Never folding again!', bntManiacBad1:'UNREAL. UNREAL!', bntManiacBad2:'This game is CRAZY!', bntManiacBad3:'Whatever, next hand, ALL IN.', bntManiacBad4:'I regret NOTHING.', bntManiacSteal1:'Didn\'t even need to show!', bntManiacSteal2:'Chaos works, every time.', bntManiacSteal3:'Free money, baby!', bntManiacSteal4:'That\'s the maniac tax.', bntManiacBust1:'WORTH IT.', bntManiacBust2:'No regrets, only vibes.', bntManiacBust3:'Went out in style!', bntManiacBust4:'That\'s how legends bust out.', bntManiacVictory1:'TOLD YOU CHAOS WORKS!', bntManiacVictory2:'GG, that was WILD.', bntManiacVictory3:'Never change my game, NEVER.', bntManiacVictory4:'Chaos wins again!', bntManiacRunnerup1:'WILD game, GG!', bntManiacRunnerup2:'That was insane, nice one!', bntManiacRunnerup3:'Respect, that was a battle!', bntManiacRunnerup4:'GG, what a ride!',
    ...
    rankingAvg:'Avg', rankingLast5:'Last 5:', rankingRecentGames:'Recent games', rankingSeasons:'Seasons', rankingLastLogin:'Last login', ppOpen:'Player profile', ppTitle:'Player profile',
    // Private messages (parity: QML "Messages prives", 2.1.7+).
    pmTitle:'Private messages', pmTooltip:'Private messages', pmBtn:'Private message', pmSend:'Send', pmPlaceholder:'Message…', pmDelete:'Delete this conversation', pmDeleteConfirm:'Delete the conversation with {name}?', pmEmpty:'No conversations yet.', pmNoConv:'Select a conversation.', pmNoMsg:'No messages yet.', pmMe:'Me', pmNotFound:'Player not found', pmSelf:'You cannot send a private message to yourself.', pmOffline:'Not connected to server', pmUsage:'Usage: /msg <nickname> <message>', pmAtTable:'Private messages are not available at the table.', pmRejected:'The private message could not be delivered.', pmOfflinePartner:'Not in the lobby at the moment', pmGuest:'Guests cannot send chat messages', pmNotInLobby:'not in the lobby', pmPartnerGuest:'Guests cannot receive private messages.',
    // Server timeout warning popup (parity: timeoutWarningPopup, pokerth.qml).
    timeoutWarnTitle:'Timeout Warning', timeoutWarnIdle:'Your connection is about to time out due to inactivity in {s} seconds.', timeoutWarnAdmin:'You are game-admin of an open game which will time out in {s} seconds.', timeoutWarnAfk:'You did not act in the game recently. You will be removed from the game in {s} seconds.', timeoutWarnExpired:'Timeout expired. You will be disconnected.', timeoutWarnExpiredGame:'Timeout expired. You are being removed from the game.', timeoutWarnHint:'Please click \u201cOK\u201d to stop the countdown!', timeoutWarnOk:'OK', connLostTitle:'Connection lost',
  ...
  pollErr: "Could not send your answer.",
    ...
    advPdbAutoSec:"Automatic .pdb file",
    advPdbAutoDesc:"Write the .pdb log into a folder on your computer and update it after every hand, like the desktop client. Desktop Chrome, Edge and Opera only.",
    advPdbAuto:"Write the .pdb file automatically",
    advPdbAutoPick:"Choose folder…",
    advPdbAutoNoFs:"This browser cannot write to a local folder.",
    ...
    hlStyleEstimate:"Estimate — fewer than 25 hands",
  ...
  reportAvatarTitle: `Report inappropriate avatar`, reportAvatarMsg: `Are you sure you want to report the avatar of "{name}" as inappropriate?`, reportAvatarAccepted: `The avatar report was accepted by the server. Thank you.`, reportAvatarDup: `This avatar was already reported by another player.`, reportAvatarError: `An error occurred while reporting the avatar.`, piReportAvatar: `Report avatar`,
  avImgNotImage: `Please choose an image file.`, avImgTooLarge: `This image is too large. Please choose a smaller one.`, avImgInvalid: `Invalid image.`, avImgFailed: `This image could not be processed.`,
  buttonsPokerth: 'PokerTH',
  hdrWaitingPlayers:'Waiting for players', hdrSpectatingWait:'Spectating \u2014 waiting for the next hand', wpWaitingPlayers:'Waiting for players …', wpFillBots:'Fill up with computer players', wpStartGame:'Start Game', wpLeaveGame:'Leave Game', wpInvite:'Invite friends', advInviteLink:'Show the “Invite friends” button in the waiting room', sharedTableNotFound:'🔗 Shared table not found — it may have already ended.',
  assist:'Assistance',assistPopOut:'Detach to a separate window',assistDock:'Dock back into the panel',advCatUI:'User interface',advCatStyle:'Style',advCatSound:'Sound',advCatLocal:'Local game',advCatNetwork:'Network game',advCatInternet:'Internet game',advCatAvatar:'Nicknames / Avatars',advCatLog:'Log messages',advCatReset:'Backup & reset',
  advStyleDesc:'Card decks, table felt, seat skins and the colour theme.',advStyleOpen:'Open the theme picker',advSoundDesc:'Game sound, music volume and reaction mute.',advSoundOpen:'Sound & volume settings',advLocalDesc:'Practise against bots: fill the empty seats at your table.',advLocalOpen:'Fill seats with bots',advNetworkDesc:'Host a game over your local network (LAN).',advSoonTag:'Coming soon',advInternetDesc:'You are connected to a PokerTH server.',advSrvLabel:'Server',advInternetOpen:'Change server / disconnect',advSrvUnknown:'\u2014', advSrvBridge:'Proxy bridge',advAvatarDesc:'Your nickname and avatar image.',advAvatarOpen:'Edit nickname / avatar',advLogDesc:'In-game log and chat overlay.',advLogOpen:'Open the log',advJournalOpen:'Manage logs\u2026',advSecJournal:'Session logs',advJournalDesc:'Browse, export, analyse and delete session logs, like the official client.',jrTitle:'Logs',jrGame:'Game:',jrGameN:'Game {n}',jrAllGames:'All games',jrPreview:'Preview:',jrSearch:'Search\u2026',jrExportHtml:'Export as HTML',jrExportTxt:'Export as txt',jrSaveAs:'Save as\u2026',jrSelect: "Select…", jrSelectCancel: "Cancel selection", jrSelectHint: "Pick several logs to delete at once — Ctrl (⌘) + click to add one, Shift + click for a range, Shift + ↑/↓ from the keyboard", jrDeleteN: "Delete ({n})", jrConfirmDeleteN: "Delete {n} logs? This cannot be undone.", jrDelete:'Delete',jrDeleteAll:'Delete all',jrAnalyze:'Analyse log file\u2026',jrAnalyzeLbl:'Hand log:',jrBack:'Back to preview',jrHand:'Hand',jrEmpty:'No logs yet. Play a hand and the session will appear here.',jrConfirmDelete:'Delete this log?',jrConfirmDeleteAll:'Delete ALL logs? This cannot be undone.',jrRetention:'Keep logs',jrKeepForever:'Forever',jrKeepDays:'{n} days',jrCurrent:'current',jrImported:'imported',jrKeepMax:'Maximum',jrKeepAll:'No limit',jrKeepLogs:'{n} logs',jrResizeList:'Resize the list',jrSaveAsPrompt:'File name',jrNoSql:'PDB export unavailable (sql.js not loaded)',advResetDesc:'Factory reset: restores EVERYTHING — options, styles and themes, shortcuts, windows, stats and logs — like a brand-new user. Nickname, avatar, account and server are kept.',advCfgSync:'Auto-sync these settings with my account (registered login only — stored on this server)', cfgSyncApplied:'Settings synced from your account', advCfgXmlSec:'PokerTH config.xml', advCfgXmlDesc:'Exchange your settings with the desktop and QML PokerTH clients (their ~/.pokerth/config.xml file). Export writes the shared settings (name, display options, sounds, table preferences, blinds, styles); import applies them here. Settings the web client does not know are kept in the file untouched and written back on the next export.', advCfgExport:'Export config.xml', advCfgImport:'Import config.xml', cfgXmlExported:'config.xml exported — drop it into ~/.pokerth/ on the desktop client', cfgXmlImported:'config.xml imported — shared settings applied', cfgXmlImportErr:'Import failed — not a valid PokerTH config.xml', cfgXmlReload:'Reload now to apply everything (themes, decks, names)?', advResetBtn:'Restore defaults',advResetConfirm:'Restore everything to factory defaults (options, styles, shortcuts, stats)? Nickname, avatar and account are kept. The app will reload.',
  ...
  sectionSeat: 'Seats',    guestHint:'🌐 Guest play on pokerth.net — no account needed.',
    ...
    liveTables:'{n} tables running', liveWaiting:'{n} players waiting',
    ...
    logPanelTitle:'Log', logCopied:'Log copied', logEmpty:'Log is empty', gnBtn:'Global notice (admin)',gnSent:'The global notice was sent to all players.',gnRejected:'The global notice was rejected by the server.',advChatClearLogin:'Clear the lobby chat when connecting', advGuardRaise:'Confirm a bet amount that was outside the allowed range', raiseAdjusted:'Amount adjusted — press again to confirm', advChatTrAlways:'Translation button always visible (otherwise only on the hovered or tapped line)', advCommunitySuggest:'Suggest players in my own community games', suggestPlayers:'Suggest players', kbHintExtra:'Alt+S opens the settings anywhere, as in the official client. Alt+T opens the statistics panel — a web addition, the official client has no shortcut for it.', advSearchPh:'Search settings…', advErrReport:"Report script errors to this server's admin (error details, browser and shortened IP address)", advOffByAdmin:'off (admin)', errJoinTimeout:'No reply from the server — check your connection.', avTabGallery:'Gallery', avTabCreate:'Create', avTabImport:'Import', avmRandom:'Random', avmMissing:'This combination is not in the catalogue yet', avmUse:'Use this avatar', avmGender:'Gender', avmAge:'Age', avmGlasses:'Glasses', avmFemale:'Woman', avmMale:'Man', avmYoung:'Young', avmAdult:'Adult', avmSenior:'Senior', avmWith:'With', avmWithout:'Without', avImportDrop:'Drop an image here', avImportOr:'or', avImportBtn:'Choose a file', avImportHint:'Any image works — it is cropped to a square and resized to 96×96 automatically. Visible to other players.', advAvatarCreate:'Show the “Create” portraits tab in the avatar window', avmBg:'Background', avmOutfit:'Outfit', avmSkin:'Skin', avmMarks:'Skin marks', avmHair:'Hair', avmHairColor:'Hair color', avmBeard:'Facial hair', avmEyeShape:'Eyes', avmEyeColor:'Eye color', avmMouth:'Mouth', avmShoulder:'Shoulder accessory', avmEarrings:'Earrings', avmNone:'None', avmSex:'Body type', avmFace:'Face shape', avmGrpFace:'Face', avmGrpHair:'Hair', avmGrpStyle:'Style', avmGrpExtra:'Extras', avmHat:'Hat', avmGrpBody:'Silhouette', avmReset:'Reset', avmNose:'Nose', betKeypad:'Number pad', logExportTitle:'Export log',
    ...
    dbgLogTitle:'Debug log', dbgLogOpen:'Show debug log', dbgLogCopy:'Copy', dbgLogEmpty:'No debug output yet.', dbgLogWrap:'Wrap lines',
    createPrefsSave:'💾 Save prefs', createPrefsSaveTip:'Save this form as my personal preferences', createPrefsSaved:'Preferences saved', createPrefsLoaded:'Preferences loaded', createPrefsNone:'No saved preferences yet',
    ...
    advSecLogSettings:'Log settings', advLogOn:'Enable logging', advLogInterval:'Log interval', advLogEveryAction:'action (high frequent disc access)', advLogEveryHand:'hand (medium disc access)', advLogEveryGame:'game (low disc access)',
    ...
    pvUpdated:'Last updated: September 10, 2026',
    ...
    pvLocal:'Your settings, statistics, achievements and logs are stored in your browser. They leave your device only in the cases listed below. You can clear them from your browser settings or with Restore defaults.',
    pvServerH:'What the server sees',
    pvSrv1:'Visit statistics: a random identifier created by your browser counts distinct devices and visits. The server stores only a hashed form of it, never with a name or an IP address. Daily figures are deleted after about 13 months, and so is the hashed identifier of any device not seen since. Browser, operating system and language are only counted as totals.',
    pvSrvSync:'Settings sync (registered accounts): when you log in with a registered pokerth.net account, your settings (the config.xml shared with the desktop client, plus web options such as theme, seats, shortcuts, language, avatar choice and ignore list) are stored on this server under your account name, so they follow you to other devices. On by default; it can be turned off in Advanced options.',
    pvSrvErr:'Error reports: when a script error occurs, the error message, page, client version, browser user agent and a shortened IP address are sent to the server admin to fix bugs. They are kept in memory only and erased when the server restarts. On by default; it can be turned off in Advanced options.',
    pvSrvVotes:'Polls and music votes: if you answer a poll or rate a track, your answer is stored with the hashed identifier so that each device counts once. Track plays are counted without any identifier.',
    pvSrv2:'Technical connection data: your IP address is needed to deliver and protect the service and may appear in the server logs for security (rate limiting, blocking abusive connections). It is used for nothing else.',
    pvSrv3:'Leaderboard: if you play on a LAN or private server through this client, your nickname, avatar choice and game statistics are stored for the leaderboard. Resetting your statistics removes the entry.',
    ...
    pvThirdTr:'Translation: when you tap the translate button (🌐) on a chat message or a forum post, the text is sent from your browser to Google Translate, or to MyMemory if that fails, or finally through this server to Google. Nothing is sent unless you tap, and the feature can be turned off in Advanced options.',
    pvThirdRadio:'Radios: when you play a radio station in the music player, your browser connects directly to that station.',
    pvThirdPdb:'Log analysis: if you use Analyse log file, the .pdb file is sent through this server to the pokerth.net log analysis service.',
    ...
    pvRights:'Under the GDPR you may request access to, correction of, or deletion of data concerning you (for example synced settings or a leaderboard entry). Please contact the pokerth.net administrators, whose details are on the pokerth.net Imprint page:',
    pvRightsGh:'For questions about the web client itself, you can also open an issue on GitHub:',
    ...
    "bakBannerTitle": "Local backup of your settings",
    "bakBannerBody": "This browser can save your settings to a folder of your choice, or restore them from an existing backup.",
    "bakBannerCreate": "Create a backup",
    "bakBannerRestore": "Restore a backup",
    "bakBannerLater": "Later",
    "bakBannerCreated": "Backup created.",
    "bakBannerExists": "A backup file already exists in this folder — use Restore.",
