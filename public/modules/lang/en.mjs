...
export const strings = {
  advCatUI:'User interface',advCatStyle:'Style',advCatSound:'Sound',advCatLocal:'Local game',advCatNetwork:'Network game',advCatInternet:'Internet game',advCatAvatar:'Nicknames / Avatars',advCatLog:'Log messages',advCatReset:'Restore defaults',
  ...
  sectionSeat: 'Seats', seatClassic: 'Classic', seatPlate: 'Plate',
    ...
    hintRaise:'R — Raise', hintRaiseAdjust:'R — Raise (adjust amount)', hintAllin:'A — All-In', hintBetConfirm:'R to bet', zoomIn:'Enlarge table', zoomOut:'Shrink table', emojiPickerTitle:'Insert emoji',
