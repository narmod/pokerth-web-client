...
export const strings = {
    ...
    kickTooltip:'Kick player', kickSubtitle:'Select a player to remove from the table', closeTableTooltip:'Close table', langTooltip:'Switch language', themeTooltip:'Theme', themeGreen:'Green', themeDark:'Dark', themePokerthOfficial:'PokerTH official', themePokerthOfficialLight:'PokerTH official (light)', tableTooltip:'Table', tableGreen:'Green', tableBlue:'Blue', tableBordeaux:'Burgundy', tableSlate:'Slate',tableSlate:'Slate', tablePhoto:'Textured', sectionPalette:'Palette', sectionTable:'Table', sectionPalette:'Palette', sectionTable:'Table', sectionDeck:'Cards', sectionButtons:'Buttons', sectionPucks:'Pucks', buttonsDefault:'Flat', buttonsGlossy:'Glossy', pucksDefault:'Chips', pucksPokerth:'PokerTH', deckClassic:'Classic', deckSvg:'PokerTH', sectionPresets:'Themes', sectionCustomize:'Customize', presetCasino:'Green Casino', presetOfficial:'PokerTH ver1.1.2', presetCustom:'Custom',
