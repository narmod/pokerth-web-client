...
export const strings = {
  ...
  sectionSeat: 'Seats', seatClassic: 'Classic', seatPlate: 'Plate',
    ...
    advSecLocalGame:'Training game', advCreateDialog:'Show the game settings screen on new game (off: start straight away with the saved settings)', advPauseHands:'Pause between hands (continue with the winner window)', nextHandBtn:'Next hand',
