...
export const strings = {
    ...
    kickTooltip:'Kick player', kickSubtitle:'Select a player to remove from the table', closeTableTooltip:'Close table', langTooltip:'Switch language', themeTooltip:'Theme', themeGreen:'Green', themeDark:'Dark', themeRed:'Red felt', tableTooltip:'Table', tableGreen:'Green', tableBlue:'Blue', tableBordeaux:'Burgundy', tableSlate:'Slate',tableSlate:'Slate', tablePhoto:'Textured', sectionPalette:'Palette', sectionTable:'Table', sectionPalette:'Palette', sectionTable:'Table', sectionDeck:'Cards', deckClassic:'Classic', deckSvg:'PokerTH', sectionPresets:'Themes', sectionCustomize:'Customize', presetCasino:'Casino vert', presetOfficial:'Official PokerTH', presetCustom:'Custom',
