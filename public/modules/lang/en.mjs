...
export const strings = {
  ...
  sectionSeat: 'Seats',    guestHint:'🌐 Guest play on pokerth.net — no account needed.',
    ...
    logPanelTitle:'Log', logCopied:'Log copied', logEmpty:'Log is empty', gnBtn:'Global notice (admin)',gnSent:'The global notice was sent to all players.',gnRejected:'The global notice was rejected by the server.',advChatClearLogin:'Clear the lobby chat when connecting', logExportTitle:'Export log',
