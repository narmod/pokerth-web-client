...
export const strings = {
  ...
  sectionSeat: 'Paikat',    botDifficulty:'Bottien vaikeus', botEasy:'Helppo', botMixed:'Sekoitettu', botNormal:'Normaali', botHard:'Vaikea',
    ...
    quickCreateBtn: 'Luo',
    logPanelTitle: 'Loki',
    logCopied:'Loki kopioitu', logEmpty:'Loki on tyhjä', gnBtn:'Yleistiedote (ylläpito)',gnSent:'Yleistiedote lähetettiin kaikille pelaajille.',gnRejected:'Palvelin hylkäsi yleistiedotteen.',advChatClearLogin:'Tyhjennä aulan keskustelu yhdistettäessä', logExportTitle:'Vie loki', chatClearTitle:'Tyhjennä chat',
