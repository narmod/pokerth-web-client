...
export const strings = {
  ...
  sectionSeat: 'Paikat',    botDifficulty:'Bottien vaikeus', botEasy:'Helppo', botMixed:'Sekoitettu', botNormal:'Normaali', botHard:'Vaikea',
    ...
    abWebBy:"Web-asiakasohjelma: Arnaud Obscur (narmod), yhteistyössä PokerTH-projektin kanssa.",
    ...
    abCred6:"thiger, dunkanx, BerndA, coldz: heidän erilaisista korjauksistaan",
