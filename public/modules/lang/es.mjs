...
export const strings = {
  ...
  sectionSeat: 'Asientos',    botDifficulty:'Dificultad de los bots', botEasy:'Fácil', botMixed:'Mixta', botNormal:'Normal', botHard:'Difícil',
    ...
    advIgnoredEmpty:'(ningún jugador ignorado)', advIgnoredRemove:'Quitar', advLobbyChat:'Mostrar el chat del lobby', advBackGuard:'El botón Atrás cierra las ventanas en lugar de salir de la partida (Android)', backAgainToExit:'Pulsa Atrás de nuevo para salir', advBrowserZoom:'Permitir el zoom del navegador (pellizco) en móvil / tableta', accessibilityTitle:'Accessibility', accessibilityInterfaceSize:'Interface size', accessibilityStandard:'Standard', accessibilityLarge:'Large', accessibilityExtraLarge:'Extra Large', accessibilityHighContrast:'High contrast', accessibilityReset:'Reset accessibility preferences', advTableZoom:'Activar el zoom de la mesa (botones lupa)',    advChatTranslate:'Traducción del chat (Google Translate, botón por mensaje)', chatTranslateUnsupported:'Este navegador no admite la traducción (se requiere Chrome/Edge reciente).', chatTranslateFailed:'Error de traducción',
