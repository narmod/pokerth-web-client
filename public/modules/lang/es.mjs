...
export const strings = {
  ...
  zoomOut: "Reducir la mesa",
    ...
    forumTabPosts:'Publicaciones', forumTabEvents:'Eventos', evUpcoming:'Próximamente', evResults:'Últimos resultados', evSignups:'Inscritos: {n}', evError:'No se pudieron cargar los eventos.', evNone:'No hay eventos próximos.', evOpenSite:'Abrir el sitio',
