...
export const strings = {
    ...
    ppLocalTab:'Local / Entrenamiento',
    // Session stats, behind a button on the player card.
    piShowStats:'Ver mis estadísticas', piHideStats:'Ocultar mis estadísticas',
    // Player profile window (parity: QML PokerthPlayerPage).
    rankingAvg:'Med', rankingLast5:'Últimas 5:', rankingRecentGames:'Partidas recientes', rankingSeasons:'Temporadas', rankingLastLogin:'Última conexión', ppOpen:'Perfil del jugador', ppTitle:'Perfil del jugador',
    // Private messages (parity: QML "Messages prives", 2.1.7+).
    pmTitle:'Mensajes privados', pmTooltip:'Mensajes privados', pmBtn:'Mensaje privado', pmSend:'Enviar', pmPlaceholder:'Mensaje…', pmDelete:'Eliminar esta conversación', pmDeleteConfirm:'¿Eliminar la conversación con {name}?', pmEmpty:'Aún no hay conversaciones.', pmNoConv:'Selecciona una conversación.', pmNoMsg:'Aún no hay mensajes.', pmMe:'Yo', pmNotFound:'Jugador no encontrado', pmSelf:'No puedes enviarte un mensaje privado a ti mismo.', pmOffline:'Sin conexión con el servidor', pmUsage:'Uso: /msg <apodo> <mensaje>', pmAtTable:'Los mensajes privados no están disponibles en la mesa.', pmRejected:'No se ha podido entregar el mensaje privado.', pmOfflinePartner:'No está en el lobby ahora mismo', pmGuest:'Los invitados no pueden enviar mensajes', pmNotInLobby:'no está en el lobby', pmPartnerGuest:'Los invitados no pueden recibir mensajes privados.',
    // Server timeout warning popup (parity: timeoutWarningPopup, pokerth.qml).
    timeoutWarnTitle:'Aviso de inactividad', timeoutWarnIdle:'Tu conexi\u00f3n se cerrar\u00e1 por inactividad en {s} segundos.', timeoutWarnAdmin:'Eres el administrador de una partida abierta que expirar\u00e1 en {s} segundos.', timeoutWarnAfk:'Hace tiempo que no juegas. Se te retirar\u00e1 de la partida en {s} segundos.', timeoutWarnExpired:'Tiempo agotado. Vas a ser desconectado.', timeoutWarnExpiredGame:'Tiempo agotado. Se te retira de la partida.', timeoutWarnHint:'\u00a1Pulsa \u00abOK\u00bb para detener la cuenta atr\u00e1s!', timeoutWarnOk:'OK', connLostTitle:'Conexión perdida',
  invScanQr: 'Escanea para unirte', invCopyLink: 'Copiar enlace', invShareVia: 'Compartir…', invitedBanner: 'Estás invitado a unirte a la mesa',
  abClTabWeb: 'Cliente web',
  abClTabUpstream: 'Clientes instalables',
  abTabChangelog: 'Registro de cambios',
  abClLoading: 'Cargando…',
  abClNew: 'Novedades', abClImprovements: 'Mejoras', abClBugfixes: 'Correcciones', abClError: 'El registro de cambios no está disponible.',
  ...
  jrImportDone: 'Importación: {ok} añadidos · {dup} ya presentes · {ko} ilegibles',

  jrUploadNet: 'Analizar en pokerth.net\u2026',
  jrUploadFail: 'Error al enviar a pokerth.net',
  ...
  pollTitle: "Encuesta",
  pollThanks: "¡Gracias por tu respuesta!",
  pollAnswers: "{n} respuesta(s)",
  pollErr: "No se pudo enviar tu respuesta.",
    // ── Stats / HUD / range (session) ──
    gipTabStats:"Estadísticas",
    ...
    hlStatsTitle:"Estadísticas",
    hlWon:"Ganadas",
    hlTrend:"Tendencia",
    hlScopeSession:"sesión",
    hlSeeRange:"Ver rango ▸",
    hlStyle:"Estilo",
    hlStyleVeryTight:"Muy conservador",
    hlStyleTightPassive:"Conservador-Pasivo",
    hlStyleTightAggr:"Conservador-Agresivo",
    hlStyleLoosePassive:"Suelto-Pasivo",
    hlStyleLooseAggr:"Suelto-Agresivo",
    hlStyleHyperAggr:"Hiperagresivo",
    hlStyleEstimate:"Estimación — menos de 25 manos",
  ...
  advSoon: "pronto",
  advAssistStyle:'Visualización de la asistencia', assistStyleSegs:'Segmentos', assistStyleBar:'Barra', advSeatLayout: "Disposición de asientos",
  ...
  piShowCups: "Ver copas", piHideCups: "Ocultar copas",
  ...
  zoomOut: "Reducir la mesa",
    ...
    forumTabPosts:'Publicaciones', forumTabEvents:'Eventos', evUpcoming:'Próximamente', evChampions:'Campeones del día', evResults:'Últimos resultados', evSignups:'Inscritos: {n}', evError:'No se pudieron cargar los eventos.', evNone:'No hay eventos próximos.', evOpenSite:'Abrir el sitio',
    forumTooltip:'Foro', forumTitle:'Novedades del foro', forumMarkRead:'Marcar todo como leído', forumOpen:'Abrir el foro', forumError:'No se pudo cargar el canal del foro.', advForumNews:'Botón del foro en la cabecera del lobby', forumOpenPost:'Abrir el mensaje', forumOpenInForum:'Abrir en el foro', forumTranslate:'Traducir el mensaje', forumShowOriginal:'Mostrar el mensaje original', forumTranslateFailed:'La traducción ha fallado.',
  ...
  sectionSeat: 'Asientos',    botDifficulty:'Dificultad de los bots', botEasy:'Fácil', botMixed:'Mixta', botNormal:'Normal', botHard:'Difícil',
    ...
    loginLead:'¿Cómo quieres jugar?',
    loginLeadSub:'Elige un modo para continuar.',
    loginNetTitle:'Internet',
    loginNetDesc:'Juega en línea, clasificado',
    loginOfflineTitle:'Local / entrenamiento',
    loginOfflineDesc:'Solo contra bots',
    loginLanTitle:'LAN / Servidor dedicado',
    loginLanDesc:'Servidor privado · red local',
    liveTables:'{n} mesas en juego', liveWaiting:'{n} jugadores esperando',
    liveOnline:'{n} jugadores conectados', liveToday:'{n} partidas hoy',
    loginChange:'Cambiar',
    ...
    reactionsLabel: 'Reacciones', reactionsMuteTitle: 'Activar / desactivar reacciones', reactionsPinTitle: 'Fijar: mantener la ventana abierta tras una reacción',
    gameOverMsg: '¡Fin de la partida!',
    tableClosedMsg: '🔒 Mesa cerrada.',
    noHandsPlayed: 'Aún no se han jugado manos',
    gtypeNormal: 'Normal',
    gtypeRegistered: 'Solo jugadores registrados',
    gtypeInvite: 'Solo jugadores invitados',
    ...
    reconnSeatKept:'Tu asiento en la mesa queda reservado durante unos minutos.',
    ...
    hsPair: '⚪ Pareja de {r}',
    hsHigh: '— Carta Alta {r}',
    whHigh: 'Carta alta {r}', whPair: 'Pareja de {r}', whTwoPair: 'Doble pareja, {a} y {b}', whThree: 'Trío de {r}', whStraight: 'Escalera al {r}', whFlush: 'Color al {r}', whFull: 'Full de {a} y {b}', whFour: 'Póker de {r}', whSF: 'Escalera de color al {r}', whRoyal: 'Escalera real',
    ...
    gameNormal: 'Normal',
    gameRegistered: 'Solo jugadores registrados',
    gameInvite: 'Solo jugadores invitados',
    nHands: 'N manos',
    nMinutes: 'N minutos',
    ...
    waitingHintSpectator: 'Estás mirando como espectador — la partida empezará en la próxima mano',
    waitingYou: 'Tú',
    ...
    gameNameRequired:'Por favor, introduce un nombre de partida.', guestGameName:'Partida de {name}',
    communityPreset:'Plantilla de la comunidad', ownSettings:'Configuración personalizada',
    ...
    createPrefsSave:'💾 Guardar prefs', createPrefsSaveTip:'Guardar este formulario como mis preferencias personales', createPrefsSaved:'Preferencias guardadas', createPrefsLoaded:'Preferencias cargadas', createPrefsNone:'Aún no hay preferencias guardadas',
    ...
    connectSlow:'La conexión tarda… inténtalo de nuevo si hace falta.', copyInviteLink:'Copiar enlace de invitación', copyInviteHint:'El destinatario se unirá directamente a esta mesa.',
    dbgLogTitle:'Registro de depuración', dbgLogOpen:'Mostrar registro de depuración', dbgLogCopy:'Copiar', dbgLogEmpty:'Aún no hay salida de depuración.', dbgLogWrap:'Ajustar líneas',
    ...
    modeManual:'Manual',
    plIgnore:'Ignorar', plStats:'Estadísticas del jugador', plNotPlaying:'No está jugando', plPlayingInFull:'%1 está jugando en «%2».', plNotPlayingFull:'%1 no está jugando en este momento.', plSortAlpha:'Ordenar alfabéticamente', plShowIdle:'Mostrar jugadores libres', plHideIdle:'Ocultar jugadores inactivos', liveIdlePlayer:'Actualmente inactivo', gameTimeLabel:'Tiempo', visRanked:'Clasificación', infoBlindsUp:'Subida de ciegas',
    ...
    advCfgSync:'Sincronizar automáticamente estos ajustes con mi cuenta (solo con sesión registrada — guardados en este servidor)', cfgSyncApplied:'Ajustes sincronizados desde tu cuenta',
    ...
    abWebBy:"Cliente web: Arnaud Obscur (narmod@pokerth.net), en colaboración con el proyecto PokerTH.",
    ...
    abLibChatTr:'traducción del chat (servicio en línea de Google)',
    abAuthors:"Autores:",
    ...
    pvUpdated:'Última actualización: 10 de septiembre de 2026',
    ...
    pvLocal:'Tus ajustes, estadísticas, logros y registros se guardan en tu navegador. Solo salen de tu dispositivo en los casos indicados abajo. Puedes borrarlos desde los ajustes del navegador o con «Restablecer valores predeterminados».',
    ...
    pvThirdTr:'Traducción: si tocas el botón de traducir (🌐) de un mensaje del chat o de una publicación del foro, el texto se envía desde tu navegador a Google Translate, a MyMemory si eso falla y, en último caso, a Google a través de este servidor. No se envía nada si no tocas, y la función se puede desactivar en Opciones avanzadas.',
    pvThirdRadio:'Radios: cuando escuchas una emisora en el reproductor de música, tu navegador se conecta directamente a esa emisora.',
    pvThirdPdb:'Análisis de registros: si usas «Analizar archivo de registro», el archivo .pdb se envía a través de este servidor al servicio de análisis de registros de pokerth.net.',
    ...
    pvRights:'Según el RGPD puedes solicitar el acceso, la rectificación o la supresión de los datos que te conciernen (por ejemplo, ajustes sincronizados o una entrada de la clasificación). Contacta con los administradores de pokerth.net, cuyos datos figuran en la página Imprint (aviso legal) de pokerth.net:',
    pvRightsGh:'Para preguntas sobre el propio cliente web, también puedes abrir una incidencia en GitHub:',
    abCredTracker:"por pokerth-tracker, que inspiró el HUD de estadísticas, la cuadrícula de rango y la exportación .pdb",
    ...
    abCred6:"thiger, dunkanx, BerndA, coldz, drull: por sus diversos parches",
    ...
    bootErrorMsg: "Conexión inestable: no se pudieron cargar algunos archivos.",
    bootMissing: "Archivos que faltan: {n}",
    advShowAppTitle: "Mostrar el título de PokerTH en la pantalla de inicio de sesión",
    assistPopOut: "Separar en una ventana aparte",
    assistDock: "Volver a acoplar al panel",
    advJournalOpen: "Gestionar registros…",
    advSecJournal: "Registros de sesión",
    advJournalDesc: "Consulta, exporta, analiza y elimina los registros de sesión, como el cliente oficial.",
    jrTitle: "Registros",
    jrGame: "Partida:",
    jrGameN: "Partida {n}",
    jrAllGames: "Todas las partidas",
    ...
    jrAnalyze: "Analizar archivo de registro…",
    jrAnalyzeLbl: "Registro de manos:",
    jrBack: "Volver a la vista previa",
    jrHand: "Mano",
    jrEmpty: "Aún no hay registros. Juega una mano y la sesión aparecerá aquí.",
    jrConfirmDelete: "¿Eliminar este registro?",
    jrConfirmDeleteAll: "¿Eliminar TODOS los registros? Esto no se puede deshacer.",
    jrRetention: "Conservar registros",
    jrKeepForever: "Para siempre",
    jrKeepDays: "{n} días",
    jrCurrent: "actual",
    jrImported:'importado',jrKeepMax:'Máximo',jrKeepAll:'Sin límite',jrKeepLogs:'{n} registros',jrResizeList:'Cambiar el ancho de la lista',jrSaveAsPrompt: "Nombre del archivo",
    jrNoSql: "Exportación PDB no disponible (sql.js no cargado)",
    srvSegNet: "Internet",
    ...
    removedReason_onRequest: "Has abandonado la partida.",
    removedReason_kicked: "Se te ha expulsado de la mesa.",
    removedReason_full: "La mesa está llena: no se te pudo sentar.",
    removedReason_running: "La partida ya está en curso.",
    removedReason_timeout: "Se te ha eliminado por inactividad (tu turno expiró demasiadas veces).",
    ...
    abbr_hf: "que te diviertas",
    abbr_glhf: "buena suerte, que te diviertas",
    abbr_nh: "buena mano",
    abbr_n1: "bien hecho",
    abbr_wp: "bien jugado",
    abbr_gj: "buen trabajo",
    abbr_wd: "bien hecho",
    abbr_ty: "gracias",
    abbr_thx: "gracias",
    abbr_np: "de nada",
    abbr_brb: "vuelvo enseguida",
    abbr_afk: "ausente del teclado",
    abbr_gtg: "me tengo que ir",
    abbr_ez: "fácil",
    abbr_allin: "all-in",
    ...
    abbr_str8: "escalera",
    abbr_aa: "pareja de ases",
    abbr_kk: "pareja de reyes",
    abbr_qq: "pareja de reinas",
    advConnPill: "Estado de conexión como ficha en el tapete (en vez del banner superior)",
    ...
    musicMoveUp: "Subir",
    musicMoveDown: "Bajar", musicRadios: "Radios", musicLike: "Me gusta", musicDislike: "No es para mí", musicIosVolume: "Volumen en la app (puede entrecortarse con CarPlay / Bluetooth)",
    ...
    plColCountry: "País",
    plColMe: "Yo",
    plColActions: "Acciones",
    abThanks1: "Gracias al equipo de PokerTH — Felix Hammer, Florian Thauer, Lothar May — y a todos los colaboradores del proyecto desde 2006.",
    // ── Succès / Achievements (mode entraînement) ──
    "ach_hands_100": "Centurión",
    "ach_hands_100_d": "Juega 100 manos",
    "ach_table_10": "Rey de la mesa",
    "ach_table_10_d": "Gana una partida de 10 jugadores",
    "ach_streak_3": "En racha",
    "ach_streak_3_d": "Gana tres manos seguidas",
    "ach_win_no_allin": "Frío como el hielo",
    "ach_win_no_allin_d": "Gana una partida sin ir all-in",
    "ach_nine_hard": "Modo difícil",
    "ach_nine_hard_d": "Gana contra nueve bots difíciles",
    "ach_three_schools": "Las tres escuelas",
    "ach_three_schools_d": "Vence a rivales fácil, normal y difícil",
    "ach_win_allin": "Todo o nada",
    "ach_win_allin_d": "Gana una mano tras ir all-in",
    "ach_bluff": "Zorro astuto",
    "ach_bluff_d": "Gana una mano de farol, sin showdown",
    "ach_pair_of_2": "Par de doses",
    "ach_pair_of_2_d": "Gana una mano con pareja de doses",
    "ach_after_midnight": "Ave nocturna",
    "ach_after_midnight_d": "Juega una partida después de medianoche",
    "achTitle": "Trofeos",
    "achProgress": "{n}/{total} desbloqueados",
    "achLocked": "Bloqueado",
    "achUnlocked": "¡Logro desbloqueado!",
    "achCatProgress": "Progreso",
    "achCatSkill": "Habilidad",
    "achCatStyle": "Estilo de juego",
    "achCatFun": "Diversión",
    "optAchievements": "Logros (entrenamiento)",
    "optAchievementsHint": "Registrar logros en partidas de entrenamiento sin conexión",
    // ── Succès lot 2 ──
    "ach_hands_500": "Veterano",
    "ach_hands_500_d": "Juega 500 manos",
    "ach_hands_1000": "Currante",
    "ach_hands_1000_d": "Juega 1000 manos",
    "ach_games_1": "Primera victoria",
    "ach_games_1_d": "Gana una partida",
    "ach_games_10": "Habitual",
    "ach_games_10_d": "Gana 10 partidas",
    "ach_games_50": "Campeón",
    "ach_games_50_d": "Gana 50 partidas",
    "ach_streak_5": "Imparable",
    "ach_streak_5_d": "Gana cinco manos seguidas",
    "ach_streak_7": "Intocable",
    "ach_streak_7_d": "Gana siete manos seguidas",
    "ach_comeback": "Remontada",
    "ach_comeback_d": "Gana una partida tras caer por debajo del 15 % de tu stack inicial",
    "ach_heads_up": "Duelista",
    "ach_heads_up_d": "Gana la última mano en mano a mano",
    "ach_patient": "Paciente",
    "ach_patient_d": "Gana una mano tras retirarte ocho manos preflop seguidas",
    ...
    "bakBannerCreate": "Crear una copia",
    "bakBannerRestore": "Restaurar una copia",
    "bakBannerLater": "Más tarde",
    "bakBannerCreated": "Copia creada.",
    "bakBannerExists": "Ya existe un archivo de copia de seguridad en esta carpeta — usa Restaurar.",
    ...
    "lsbClockYours": "Tu hora",
    "lsbClockSame": "Misma hora que el servidor",
    "lsbClockNote": "Los eventos de la comunidad (BBC, WEC, Monthly Cup) se programan en hora del servidor.",
    "advLobbyClock": "Hora del servidor en la barra de estado del lobby (pokerth.net)",
};
