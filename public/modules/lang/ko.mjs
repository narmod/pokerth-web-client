...
export const strings = {
  ...
  sectionSeat: '좌석',    botDifficulty:'봇 난이도', botEasy:'쉬움', botMixed:'혼합', botNormal:'보통', botHard:'어려움',
    ...
    quickCreateBtn:'만들기',
    logPanelTitle:'로그',
    logCopied:'로그가 복사되었습니다', logEmpty:'로그가 비어 있습니다', gnBtn:'전체 공지 (관리자)',gnSent:'전체 공지를 모든 플레이어에게 보냈습니다.',gnRejected:'서버가 전체 공지를 거부했습니다.',advChatClearLogin:'접속할 때 로비 채팅 지우기', advGuardRaise:'허용 범위를 벗어난 베팅 금액을 확인', raiseAdjusted:'금액이 조정됨 — 다시 눌러 확인', logExportTitle:'로그 내보내기', chatClearTitle:'채팅 지우기',
    jumpLatest:'최신으로 이동',
