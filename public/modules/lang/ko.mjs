...
export const strings = {
  ...
  sectionSeat: '좌석',    botDifficulty:'봇 난이도', botEasy:'쉬움', botMixed:'혼합', botNormal:'보통', botHard:'어려움',
    ...
    advTableZoom:'테이블 줌 활성화 (돋보기 버튼)', advChatTranslate:'채팅 번역 (Google 번역, 메시지별 버튼)', chatTranslateUnsupported:'이 브라우저는 번역을 지원하지 않습니다 (최신 Chrome/Edge 필요).', chatTranslateFailed:'번역 실패',
