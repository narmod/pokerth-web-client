...
export const strings = {
    ...
    kickTooltip:'Expulser le joueur', kickSubtitle:'Sélectionnez un joueur à expulser de la table', closeTableTooltip:'Fermer la table', langTooltip:'Changer de langue', themeTooltip:'Thème', themeGreen:'Casino vert', themeDark:'Sombre',
