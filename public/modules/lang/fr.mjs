...
export const strings = {
  ...
  sectionSeat: 'Sièges', seatClassic: 'Classic', seatPlate: 'Plate',
    ...
    botDifficulty:'Niveau des bots', botEasy:'Facile', botMixed:'Mixte', botNormal:'Normal', botHard:'Difficile',
    ...
    navBack:'Retour', createTableHdr:'Créer une table', gameNameLabel:'Nom de la partie', passwordLabel:'Mot de passe', startCash:'Capital de départ', blindsSettings:'Réglages des blindes', firstSmallBlind:'Première petite blinde', blindInterval:'Intervalle d\'augmentation des blindes', unitHands:'mains', unitMinutes:'minutes', blindsOrderLbl:'Ordre d\'augmentation des blindes', blindsAlwaysDouble:'toujours doubler les blindes', blindsManualOrder:'ordre manuel des blindes', blindsAddBtn:'+ Ajouter', blindsRemoveTip:'Retirer cette blinde', blindsAfterLbl:'Ensuite :', blindsAfterDouble:'doubler les blindes', blindsAfterRaiseBy:'augmenter les blindes de', blindsAfterKeep:'garder la dernière blinde', infoBlindsManual:'Blindes manuelles', timeLimits:'Limites de temps', actionTimeout:'Limite de temps par action', pauseBetweenHands:'Pause entre les mains',  gameStyle:'Style de partie',
    ...
    advSecLocalGame:'Partie d\'entraînement', advCreateDialog:'Afficher l\'écran de réglages à chaque nouvelle partie (décoché : démarrage direct avec les réglages sauvegardés)', advPauseHands:'Pause entre les mains (reprise via la fenêtre du gagnant)', nextHandBtn:'Main suivante',
    ...
    musicTooltip:'Sons & Musique', musicPanelTitle:'Lecteur de musique', musicNowPlaying:'Lecture en cours', musicNoTracks:'Aucune piste disponible', musicVolume:'Volume', musicPlay:'Lecture', musicPause:'Pause', musicStop:'Arrêter', musicNext:'Suivant', musicPrev:'Précédent', musicTrack:'Piste', musicRepeat:'Répétition', musicRepeatOne:'Répéter le titre', musicRepeatAll:'Répéter la playlist', musicRepeatOff:'Lire une fois', musicPlayer:'Lecteur',
    ...
    piCups:'Coupes',
    piShowCups:'Voir les coupes', piIgnore:'Ignorer', piUnignore:'Réafficher', piKickban:'Kickban total', kickbanConfirm:'Bannir {name} du serveur (kickban total) ?', kickbanOk:'{name} a été kickban', kickbanFail:'Échec du kickban',
