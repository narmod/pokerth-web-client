...
export const strings = {
  ...
  sectionSeat: 'Sièges', seatClassic: 'Classic', seatPlate: 'Plate',
    ...
    hintRaise:'R — Relancer', hintRaiseAdjust:'R — Relancer (ajustez le montant)', hintAllin:'A — Tapis', hintBetConfirm:'R pour miser', zoomIn:'Agrandir la table', zoomOut:'Réduire la table', zoomReset:'Réinitialiser la vue', emojiPickerTitle:'Insérer un emoji',
