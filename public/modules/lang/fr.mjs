...
export const strings = {
  ...
  sectionSeat: 'Sièges',    guestHint:'🌐 Partie en invité sur pokerth.net — sans compte.',
    ...
    advSecLogSettings:'Paramètres des journaux', advLogOn:'Activer la journalisation',
    ...
    advStatsExportSession:"Exporter la session", advStatsExportAll:"Exporter tout l'historique", advLogInterval:'Intervalle de journalisation', advLogEveryAction:'Chaque action', advLogEveryHand:'Chaque main',
