...
export const strings = {
  ...
  sectionSeat: 'Sièges', seatClassic: 'Classic', seatPlate: 'Plate',
    ...
    musicTooltip:'Sons & Musique', musicPanelTitle:'Sons & Musique', musicNowPlaying:'Lecture en cours', musicNoTracks:'Aucune piste disponible', musicVolume:'Volume', musicPlay:'Lecture', musicPause:'Pause', musicStop:'Arrêter', musicNext:'Suivant', musicPrev:'Précédent', musicTrack:'Piste', musicRepeat:'Répétition', musicRepeatOne:'Répéter le titre', musicRepeatAll:'Répéter la playlist', musicRepeatOff:'Lire une fois', musicPlayer:'Lecteur',
