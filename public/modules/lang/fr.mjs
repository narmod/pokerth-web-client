...
export const strings = {
  ...
  hdrWaitingPlayers:'En attente de joueurs', hdrSpectatingWait:'Spectateur \u2014 en attente de la prochaine main', wpWaitingPlayers:'En attente de joueurs …', wpFillBots:'Compléter avec des joueurs ordinateur', wpStartGame:'Démarrer la partie', wpLeaveGame:'Quitter la partie', wpInvite:'Inviter des amis', advInviteLink:'Afficher le bouton « Inviter des amis » dans le salon d’attente', sharedTableNotFound:'🔗 Table partagée introuvable — elle est peut-être déjà terminée.', invWarnInviteOnly:'Table sur invitation : le lien ne suffit pas — une fois ton ami connecté, invite-le depuis la liste des joueurs.', invWarnGuests:'Table réservée aux inscrits ou classée : un ami sans compte pokerth.net ne pourra pas la rejoindre.', invWarnLocalhost:'Adresse de serveur locale (localhost) : ce lien ne fonctionne que sur cet appareil.', sharedTableRunning:'🔗 La table partagée a déjà commencé — tu la regardes en spectateur.',
  ...
  sectionSeat: 'Sièges',    guestHint:'🌐 Partie en invité sur pokerth.net — sans compte.',
    ...
    forumTabPosts:'Posts', forumTabEvents:'Événements', evUpcoming:'À venir', evChampions:'Champions du jour', evResults:'Derniers résultats', evSignups:'Inscrits : {n}', evError:'Impossible de charger les événements.', evNone:'Aucun événement à venir.', evOpenSite:'Ouvrir le site',
    ...
    infoTypeLabel:'Type', infoCapitalLabel:'Capital de départ', infoPlayersInGame:'Joueurs dans la partie', plIgnore:'Ignorer', plStats:'Statistiques du joueur',
