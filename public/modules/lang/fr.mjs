...
export const strings = {
  ...
  sectionSeat: 'Sièges',    guestHint:'🌐 Partie en invité sur pokerth.net — sans compte.',
    ...
    musicTooltip:'Sons & Musique', musicPanelTitle:'Lecteur de musique', musicNowPlaying:'Lecture en cours', musicNoTracks:'Aucune piste disponible', musicVolume:'Volume', musicPlay:'Lecture', musicPause:'Pause', musicStop:'Arrêter', musicNext:'Suiv. ▶', musicPrev:'Précédent', musicTrack:'Piste', musicRepeat:'Répétition', musicRepeatOne:'Répéter le titre', musicRepeatAll:'Répéter la playlist', musicRepeatOff:'Lire une fois', musicPlayer:'Joueur', musicShuffle:'Aléatoire', musicPlaylist:'Playlist',
