...
export const strings = {
  ...
  sectionSeat: 'Sièges', seatClassic: 'Classic', seatPlate: 'Plate',
    ...
    musicTooltip:'Musique', musicPanelTitle:'Musique', musicNowPlaying:'Lecture en cours', musicNoTracks:'Aucune piste disponible', musicVolume:'Volume', musicPlay:'Lecture', musicPause:'Pause', musicStop:'Arrêter', musicNext:'Suivant', musicPrev:'Précédent', musicTrack:'Piste',
