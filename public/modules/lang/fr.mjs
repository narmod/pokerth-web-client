...
export const strings = {
  ...
  hdrWaitingPlayers:'En attente de joueurs', wpWaitingPlayers:'En attente de joueurs …', wpFillBots:'Compléter avec des joueurs ordinateur', wpStartGame:'Démarrer la partie', wpLeaveGame:'Quitter la partie',
