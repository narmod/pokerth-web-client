...
export const strings = {
  advCatUI:'Interface utilisateur',advCatStyle:'Style',advCatSound:'Son',advCatLocal:'Jeu local',advCatNetwork:'Jeu en réseau',advCatInternet:'Jeu Internet',advCatAvatar:'Pseudos / Avatars',advCatLog:'Messages de journal',advCatReset:'Paramètres par défaut',
