...
export const strings = {
  ...
  sectionSeat: 'Sièges',    guestHint:'🌐 Partie en invité sur pokerth.net — sans compte.',
    ...
    advBackGuard:'Le bouton Retour ferme les fenêtres au lieu de quitter la partie (Android)', backAgainToExit:'Appuyez à nouveau sur Retour pour quitter', advBrowserZoom:'Autoriser le zoom du navigateur (pincement) sur téléphone / tablette', accessibilityTitle:'Accessibility', accessibilityInterfaceSize:'Interface size', accessibilityStandard:'Standard', accessibilityLarge:'Large', accessibilityExtraLarge:'Extra Large', accessibilityHighContrast:'High contrast', accessibilityReset:'Reset accessibility preferences', advTableZoom:'Activer le zoom de la table (boutons loupe)',
