...
export const strings = {
    ...
    kickTooltip:'Expulser le joueur', kickSubtitle:'Sélectionnez un joueur à expulser de la table', closeTableTooltip:'Fermer la table', langTooltip:'Changer de langue', themeTooltip:'Thème', themeGreen:'Vert', themeDark:'Sombre', themePokerthOfficial:'PokerTH officiel', themePokerthOfficialLight:'PokerTH officiel (clair)', tableTooltip:'Tapis', tableGreen:'Vert', tableBlue:'Bleu', tableBordeaux:'Bordeaux', tableSlate:'Ardoise',tableSlate:'Ardoise', tablePokerthOfficial:'PokerTH', tablePhoto:'Texturé', sectionPalette:'Palette', sectionTable:'Tapis', sectionPalette:'Palette', sectionTable:'Tapis', sectionDeck:'Cartes', sectionButtons:'Boutons', sectionPucks:'Pucks', buttonsDefault:'Plat', buttonsGlossy:'Glossy', pucksDefault:'Jetons', pucksPokerth:'PokerTH', deckClassic:'Classique', deckSvg:'PokerTH', sectionPresets:'Thèmes', sectionCustomize:'Personnaliser', presetPokerthOfficial:'PokerTH officiel', presetPokerthOfficialLight:'PokerTH officiel (clair)', presetCasino:'Green Casino', presetOfficial:'PokerTH ver1.1.2', presetCustom:'Personnalisé',
