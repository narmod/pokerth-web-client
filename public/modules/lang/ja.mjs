...
export const strings = {
  ...
  zoomOut: "テーブルを縮小",
    ...
    forumTooltip:'フォーラム', forumTitle:'フォーラムニュース', forumMarkRead:'すべて既読にする', forumOpen:'フォーラムを開く', forumError:'フォーラムのフィードを読み込めませんでした。', advForumNews:'ロビーヘッダーのフォーラムボタン', forumOpenPost:'投稿を開く',
