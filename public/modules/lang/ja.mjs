...
export const strings = {
  ...
  sectionSeat: '座席',    botDifficulty:'ボットの難易度', botEasy:'やさしい', botMixed:'ミックス', botNormal:'ふつう', botHard:'むずかしい',
    ...
    advIgnoredRemove:'削除', advLobbyChat:'ロビーチャットを表示', advBackGuard:'戻るボタンはゲームを終了せずウィンドウを閉じます（Android）', backAgainToExit:'終了するにはもう一度戻るを押してください', advBrowserZoom:'スマートフォン / タブレットでブラウザのズーム（ピンチ）を許可', accessibilityTitle:'Accessibility', accessibilityInterfaceSize:'Interface size', accessibilityStandard:'Standard', accessibilityLarge:'Large', accessibilityExtraLarge:'Extra Large', accessibilityHighContrast:'High contrast', accessibilityReset:'Reset accessibility preferences', advTableZoom:'テーブルズームを有効化（拡大鏡ボタン）', advChatTranslate:'チャット翻訳（Google 翻訳、メッセージごとのボタン）', chatTranslateUnsupported:'このブラウザは翻訳に対応していません（最新の Chrome/Edge が必要）。',
