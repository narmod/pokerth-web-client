...
export const strings = {
  ...
  sectionSeat: '座席',    botDifficulty:'ボットの難易度', botEasy:'やさしい', botMixed:'ミックス', botNormal:'ふつう', botHard:'むずかしい',
    ...
    advIgnoredRemove:'削除', advLobbyChat:'ロビーチャットを表示', advBrowserZoom:'スマートフォン / タブレットでブラウザのズーム（ピンチ）を許可', advTableZoom:'テーブルズームを有効化（拡大鏡ボタン）', advChatTranslate:'チャット翻訳（Google 翻訳、メッセージごとのボタン）', chatTranslateUnsupported:'このブラウザは翻訳に対応していません（最新の Chrome/Edge が必要）。',
