...
export const strings = {
    ...
    timeoutWarnTitle:'\u30bf\u30a4\u30e0\u30a2\u30a6\u30c8\u306e\u8b66\u544a', timeoutWarnIdle:'\u64cd\u4f5c\u304c\u306a\u3044\u305f\u3081\u3001{s} \u79d2\u5f8c\u306b\u63a5\u7d9a\u304c\u5207\u65ad\u3055\u308c\u307e\u3059\u3002', timeoutWarnAdmin:'\u3042\u306a\u305f\u306f\u516c\u958b\u30b2\u30fc\u30e0\u306e\u7ba1\u7406\u8005\u3067\u3059\u3002\u3053\u306e\u30b2\u30fc\u30e0\u306f {s} \u79d2\u5f8c\u306b\u7d42\u4e86\u3057\u307e\u3059\u3002', timeoutWarnAfk:'\u3057\u3070\u3089\u304f\u30a2\u30af\u30b7\u30e7\u30f3\u304c\u3042\u308a\u307e\u305b\u3093\u3002{s} \u79d2\u5f8c\u306b\u30b2\u30fc\u30e0\u304b\u3089\u9000\u5834\u3055\u305b\u3089\u308c\u307e\u3059\u3002', timeoutWarnExpired:'\u6642\u9593\u5207\u308c\u3067\u3059\u3002\u63a5\u7d9a\u304c\u5207\u65ad\u3055\u308c\u307e\u3059\u3002', timeoutWarnExpiredGame:'\u6642\u9593\u5207\u308c\u3067\u3059\u3002\u30b2\u30fc\u30e0\u304b\u3089\u9000\u5834\u3057\u3066\u3044\u307e\u3059\u3002', timeoutWarnHint:'\u300cOK\u300d\u3092\u30af\u30ea\u30c3\u30af\u3057\u3066\u30ab\u30a6\u30f3\u30c8\u30c0\u30a6\u30f3\u3092\u6b62\u3081\u3066\u304f\u3060\u3055\u3044\u3002', timeoutWarnOk:'OK',
  ...
  sectionSeat: '座席',    botDifficulty:'ボットの難易度', botEasy:'やさしい', botMixed:'ミックス', botNormal:'ふつう', botHard:'むずかしい',
    ...
    pvLocal:'設定（テーマ、言語、テーブルスタイル、サウンドオプションなど）はブラウザにローカル保存され、端末の外に出ることはありません。ブラウザの設定からいつでも削除できます。',
    pvServerH:'サーバーが受け取るもの',
    pvSrv1:'匿名の訪問カウンター: ブラウザに保存されたランダムな識別子で、端末数と訪問数を数えます。この統計には名前も IP アドレスも含まれず、約 13 か月後に削除されます。',
    pvSrv2:'技術的な接続データ: 他のウェブサーバーと同様に、サービスの提供と保護に必要な接続データ（IP アドレスを含む）を受け取ります。それ以外には使用しません。',
    pvSrv3:'ゲームデータ: ランク付きサーバーでプレイする場合、選んだニックネームと結果がランキング表示のために記録されます。',
    pvThirdH:'第三者のサービス',
    ...
    pvThirdTr:'チャット翻訳：チャットメッセージの翻訳ボタン（🌐）をタップすると、そのメッセージのテキストが Google の翻訳サービス（Google 翻訳）に送信され、あなたの言語に翻訳されます。ボタンをタップしない限り何も送信されず、この機能は詳細オプションで無効にできます。',
