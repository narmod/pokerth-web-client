...
const LANG = {
  en: {
    ...
    leaveDialogTitle:'Leaving the game',
    leaveDialogBody:'Do you want to keep your seat so you can come back, or quit this table for good?',
    leaveKeep:'Keep my seat',
    leaveQuit:'Quit for good',
    leaveCancel:'Cancel',
    resumeBannerTitle:'Game in progress',
    resumeBannerSub:'You paused table \u201c{name}\u201d \u2014 you can come back',
    resumeBtn:'Resume',
    discardBtn:'Forget',
    rejoinSent:'Rejoining your table\u2026',
    rejoinFailedMsg:'Could not rejoin \u2014 the table may have ended or your seat may have timed out.',
},
  fr: {
    ...
    leaveDialogBody:'Voulez-vous garder votre place pour revenir, ou quitter d\u00e9finitivement cette table\u00a0?',
    leaveKeep:'Garder ma place',
    leaveQuit:'Quitter d\u00e9finitivement',
    leaveCancel:'Annuler',
    resumeBannerTitle:'Partie en cours',
    resumeBannerSub:'Vous avez mis la table \u00ab\u202f{name}\u202f\u00bb en pause \u2014 vous pouvez revenir',
    resumeBtn:'Reprendre',
    discardBtn:'Oublier',
    rejoinSent:'Reprise de votre table\u2026',
    rejoinFailedMsg:'Impossible de reprendre \u2014 la table a peut-\u00eatre termin\u00e9 ou votre place a expir\u00e9.',
}
};
