...
const LANG_MODULES = { en: enLang, fr: frLang, de: deLang, es: esLang, it: itLang, 'pt-BR': ptBrLang, 'pt-PT': ptPtLang, nl: nlLang, pl: plLang, ru: ruLang, zh: zhLang, tr: trLang, uk: ukLang, ja: jaLang, sv: svLang, nb: nbLang, da: daLang, fi: fiLang, cs: csLang, sk: skLang, ro: roLang, hu: huLang, el: elLang, bg: bgLang, hr: hrLang, sr: srLang, af: afLang, ca: caLang, gl: glLang, gd: gdLang, lt: ltLang, et: etLang, lv: lvLang, sl: slLang, ta: taLang, vi: viLang, ko: koLang, 'zh-TW': zhTwLang, hi: hiLang, ar: arLang, fa: faLang, he: heLang, ur: urLang, id: idLang, th: thLang, fil: filLang, bn: bnLang, sw: swLang };
