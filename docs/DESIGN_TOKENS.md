...
- [ ] **Lot 1 — Table de jeu** : sièges, barre d'action, status bar, pot, cartes
      communes, badges. (Conserver la fidélité QML : ne migrer que ce qui est déjà rem
      ou sans variante ; garder les px QML documentés.)
