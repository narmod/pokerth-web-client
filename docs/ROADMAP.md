...
- Theme panel fully localised in all 69 languages, with live switching and a live preview
  of each deck.
...
- Internationalisation in 69 languages, auto-detected and switchable on the fly.
...
- **Translating `/faq`** — `/rules` and `/faq` are done in all 69 languages
