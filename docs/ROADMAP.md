...
- Theme panel fully localised in all 82 languages, with live switching and a live preview
  of each deck.
...
- Internationalisation in 82 languages, auto-detected and switchable on the fly.
...
- **Translating `/faq`** — `/rules` and `/faq` are done in all 82 languages
...
- **Native review of the smaller languages** — the translations for Hindi,
  ...
  Gaelic, Icelandic, Uzbek, Burmese, Georgian, Kazakh, Sinhala, Azerbaijani, Armenian, Belarusian, Nepali, Basque, Welsh, Irish, Esperanto, Hausa, Yoruba, Zulu, Kyrgyz, Tajik, Turkmen and Mongolian were written without an established poker vocabulary to
