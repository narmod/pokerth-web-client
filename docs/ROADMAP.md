...
- **Native review of the smaller languages** — the translations for Hindi,
  ...
  Gaelic, Icelandic, Uzbek, Burmese, Georgian, Kazakh, Sinhala, Azerbaijani, Armenian, Belarusian, Nepali, Basque, Welsh, Irish, Esperanto, Hausa, Yoruba, Zulu and Kyrgyz were written without an established poker vocabulary to
