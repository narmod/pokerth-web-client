...
- Theme panel fully localised in all 78 languages, with live switching and a live preview
  of each deck.
...
- Internationalisation in 78 languages, auto-detected and switchable on the fly.
...
- **Translating `/faq`** — `/rules` and `/faq` are done in all 78 languages
