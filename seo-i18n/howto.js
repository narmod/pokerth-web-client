...
var PARTS = {
  ...
  fr: {
    ...
    faqP: function (h, c) { return "Aucun argent n’intervient jamais, dans aucun mode. Vos réglages, vos packs de style et votre progression hors ligne restent sur votre appareil. L’interface existe en 59 langues, tandis que les cinq mots d’action — Fold, Check, Call, Raise, All-In — restent en anglais, comme à toutes les tables du monde. La suite dans la <a href=\"{faq}\">FAQ</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  it: {
    ...
    faqP: function (h, c) { return "Non c’è mai denaro in gioco, in nessuna modalità. Le tue impostazioni, i pacchetti di stile e i progressi offline restano sul tuo dispositivo. L’interfaccia è disponibile in 59 lingue, mentre le cinque parole d’azione — Fold, Check, Call, Raise, All-In — restano in inglese, come a qualsiasi tavolo del mondo. Il resto nelle <a href=\"{faq}\">FAQ</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  pl: {
    ...
    faqP: function (h, c) { return "W żadnym trybie nie ma prawdziwych pieniędzy. Twoje ustawienia, paczki stylów i postępy offline zostają na twoim urządzeniu. Interfejs jest dostępny w 59 językach, a pięć słów akcji — Fold, Check, Call, Raise, All-In — pozostaje po angielsku, tak jak przy każdym stole na świecie. Więcej w <a href=\"{faq}\">FAQ</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  ru: {
    ...
    faqP: function (h, c) { return "Реальные деньги не участвуют ни в одном режиме. Ваши настройки, стилевые паки и офлайн-прогресс остаются на вашем устройстве. Интерфейс доступен на 59 языках, а пять слов действий — Fold, Check, Call, Raise, All-In — остаются английскими, как за любым столом в мире. Подробнее в <a href=\"{faq}\">FAQ</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  zh: {
    ...
    faqH2: "常见问题",
    faqP: function (h, c) { return "任何模式都不涉及金钱。你的设置、样式包和离线进度都保存在你自己的设备上。界面提供 59 种语言，而 Fold、Check、Call、Raise、All-In 这五个动作词保持英文，和全世界的牌桌一样。更多内容见<a href=\"{faq}\">常见问题</a>。".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  nl: {
    ...
    faqP: function (h, c) { return "Er komt in geen enkele modus geld aan te pas. Je instellingen, stijlpakketten en offline voortgang blijven op je eigen apparaat. De interface is beschikbaar in 59 talen, terwijl de vijf actiewoorden — Fold, Check, Call, Raise, All-In — in het Engels blijven, zoals aan elke tafel ter wereld. Meer in de <a href=\"{faq}\">veelgestelde vragen</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  uk: {
    ...
    faqP: function (h, c) { return "Справжні гроші не беруть участі в жодному режимі. Ваші налаштування, набори стилів і офлайн-прогрес лишаються на вашому пристрої. Інтерфейс доступний 59 мовами, а п’ять слів дій — Fold, Check, Call, Raise, All-In — лишаються англійськими, як за будь-яким столом у світі. Докладніше в <a href=\"{faq}\">FAQ</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  ja: {
    ...
    faqH2: "よくある質問",
    faqP: function (h, c) { return "どのモードでもお金は一切関係ありません。設定、スタイルパック、オフラインの進行状況はすべて自分の端末に残ります。インターフェイスは59言語で利用でき、5つのアクション用語——Fold、Check、Call、Raise、All-In——は世界中のテーブルと同じく英語のままです。詳しくは<a href=\"{faq}\">よくある質問</a>をご覧ください。".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  ko: {
    ...
    faqH2: "자주 묻는 질문",
    faqP: function (h, c) { return "어떤 모드에서도 돈이 오가지 않습니다. 설정, 스타일 팩, 오프라인 진행 상황은 모두 본인 기기에 남습니다. 인터페이스는 59개 언어로 제공되며, 다섯 개의 액션 단어 — Fold, Check, Call, Raise, All-In — 는 전 세계 어느 테이블에서나 그렇듯 영어 그대로입니다. 자세한 내용은 <a href=\"{faq}\">자주 묻는 질문</a>에 있습니다.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  id: {
    ...
    faqP: function (h, c) { return "Tidak ada uang yang terlibat, di mode mana pun. Pengaturan, paket gaya, dan kemajuan offline Anda tetap di perangkat sendiri. Antarmukanya tersedia dalam 59 bahasa, sementara lima kata aksi — Fold, Check, Call, Raise, All-In — tetap dalam bahasa Inggris, seperti di meja mana pun di dunia. Selengkapnya di <a href=\"{faq}\">tanya jawab</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  fa: {
    ...
    faqP: function (h, c) { return "در هیچ حالتی پول واقعی در کار نیست. تنظیمات، بسته‌های ظاهری و پیشرفت آفلاین شما روی دستگاه خودتان می‌ماند. رابط کاربری به ۵۹ زبان در دسترس است، در حالی که پنج واژهٔ کنش — Fold، Check، Call، Raise، All-In — مانند هر میز دیگری در جهان انگلیسی می‌مانند. بیشتر در <a href=\"{faq}\">پرسش‌های پرتکرار</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  he: {
    ...
    faqH2: "שאלות נפוצות",
    faqP: function (h, c) { return "כסף אמיתי אינו מעורב בשום מצב. ההגדרות שלכם, חבילות העיצוב וההתקדמות הלא מקוונת נשארות במכשיר שלכם. הממשק זמין ב־59 שפות, בעוד חמש מילות הפעולה — Fold, Check, Call, Raise, All-In — נשארות באנגלית, כמו בכל שולחן בעולם. עוד ב<a href=\"{faq}\">שאלות הנפוצות</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  ur: {
    ...
    faqH2: "عام سوالات",
    faqP: function (h, c) { return "کسی بھی طریقے میں اصلی پیسہ شامل نہیں ہوتا۔ آپ کی ترتیبات، اسٹائل پیک اور آف لائن پیش رفت آپ ہی کے آلے پر رہتی ہیں۔ انٹرفیس 59 زبانوں میں دستیاب ہے، جبکہ پانچ ایکشن الفاظ — Fold، Check، Call، Raise، All-In — دنیا کی ہر میز کی طرح انگریزی ہی میں رہتے ہیں۔ مزید <a href=\"{faq}\">عام سوالات</a> میں۔".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  hi: {
    ...
    faqH2: "आम सवाल",
    faqP: function (h, c) { return "किसी भी मोड में पैसा शामिल नहीं होता। आपकी सेटिंग्स, स्टाइल पैक और ऑफ़लाइन प्रगति आपके ही डिवाइस पर रहती हैं। इंटरफ़ेस 59 भाषाओं में उपलब्ध है, जबकि पाँच एक्शन शब्द — Fold, Check, Call, Raise, All-In — दुनिया की हर मेज़ की तरह अंग्रेज़ी में ही रहते हैं। और जानकारी <a href=\"{faq}\">आम सवालों</a> में।".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  th: {
    ...
    faqP: function (h, c) { return "ไม่มีเงินจริงเข้ามาเกี่ยวข้องในโหมดใดเลย การตั้งค่า ชุดตกแต่ง และความคืบหน้าแบบออฟไลน์ของคุณอยู่บนเครื่องของคุณเอง ส่วนติดต่อผู้ใช้มีให้เลือก 59 ภาษา ขณะที่คำสั่งห้าคำ — Fold, Check, Call, Raise, All-In — ยังคงเป็นภาษาอังกฤษ เหมือนโต๊ะโป๊กเกอร์ทุกแห่งในโลก อ่านเพิ่มเติมได้ที่<a href=\"{faq}\">คำถามที่พบบ่อย</a>".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  bn: {
    ...
    faqH2: "সাধারণ প্রশ্ন",
    faqP: function (h, c) { return "কোনো ধরনেই আসল টাকা জড়িত নয়। আপনার সেটিংস, স্টাইল প্যাক আর অফলাইন অগ্রগতি আপনার নিজের যন্ত্রেই থাকে। ইন্টারফেস ৫৯টি ভাষায় পাওয়া যায়, আর পাঁচটি অ্যাকশন শব্দ — Fold, Check, Call, Raise, All-In — দুনিয়ার যেকোনো টেবিলের মতোই ইংরেজিতে থাকে। আরও জানুন <a href=\"{faq}\">সাধারণ প্রশ্নে</a>।".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  'zh-TW': {
    ...
    faqH2: "常見問題",
    faqP: function (h, c) { return "任何模式都不涉及金錢。你的設定、樣式包和離線進度都保存在你自己的裝置上。介面提供 59 種語言，而 Fold、Check、Call、Raise、All-In 這五個動作詞維持英文，和全世界的牌桌一樣。更多內容見<a href=\"{faq}\">常見問題</a>。".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  sv: {
    ...
    faqP: function (h, c) { return "Inga pengar är någonsin inblandade, i något läge. Dina inställningar, stilpaket och offlineframsteg stannar på din egen enhet. Gränssnittet finns på 59 språk, medan de fem åtgärdsorden — Fold, Check, Call, Raise, All-In — förblir på engelska, precis som vid alla bord i världen. Mer i <a href=\"{faq}\">vanliga frågor</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  da: {
    ...
    faqP: function (h, c) { return "Der er aldrig penge involveret, i nogen tilstand. Dine indstillinger, stilpakker og offlinefremskridt bliver på din egen enhed. Brugerfladen findes på 59 sprog, mens de fem handlingsord — Fold, Check, Call, Raise, All-In — forbliver på engelsk, ligesom ved ethvert bord i verden. Mere i <a href=\"{faq}\">ofte stillede spørgsmål</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  nb: {
    ...
    faqP: function (h, c) { return "Det er aldri penger inne i bildet, i noen modus. Innstillingene dine, stilpakkene og offlinefremgangen blir liggende på din egen enhet. Grensesnittet finnes på 59 språk, mens de fem handlingsordene — Fold, Check, Call, Raise, All-In — forblir på engelsk, som ved ethvert bord i verden. Mer i <a href=\"{faq}\">vanlige spørsmål</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
    ...
    faqP: function (h, c) { return "Rahaa ei ole missään pelimuodossa mukana. Asetuksesi, tyylipaketit ja offline-edistyminen pysyvät omalla laitteellasi. Käyttöliittymä on saatavilla 59 kielellä, kun taas viisi toimintosanaa — Fold, Check, Call, Raise, All-In — pysyvät englanniksi, kuten jokaisessa pöydässä maailmassa. Lisää <a href=\"{faq}\">usein kysytyissä kysymyksissä</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  sk: {
    ...
    faqH2: "Časté otázky",
    faqP: function (h, c) { return "V žiadnom režime nie sú v hre skutočné peniaze. Vaše nastavenia, štýlové balíčky aj offline postup zostávajú vo vašom zariadení. Rozhranie je k dispozícii v 59 jazykoch, zatiaľ čo päť akčných slov — Fold, Check, Call, Raise, All-In — zostáva po anglicky, ako pri každom stole na svete. Viac v <a href=\"{faq}\">častých otázkach</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  bs: {
    ...
    faqH2: "Česta pitanja",
    faqP: function (h, c) { return "Ni u jednom načinu nema pravog novca. Tvoje postavke, paketi stilova i offline napredak ostaju na tvom uređaju. Interfejs je dostupan na 59 jezika, dok pet riječi za radnje — Fold, Check, Call, Raise, All-In — ostaju na engleskom, kao za svakim stolom na svijetu. Više u <a href=\"{faq}\">čestim pitanjima</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  ca: {
    ...
    faqP: function (h, c) { return "No hi ha mai diners pel mig, en cap mode. La teva configuració, els paquets d’estil i el progrés fora de línia es queden al teu propi dispositiu. La interfície està disponible en 59 idiomes, mentre que les cinc paraules d’acció — Fold, Check, Call, Raise, All-In — es mantenen en anglès, com a qualsevol taula del món. Més a les <a href=\"{faq}\">preguntes freqüents</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  lt: {
    ...
    faqP: function (h, c) { return "Nė viename režime tikri pinigai nedalyvauja. Jūsų nustatymai, stiliaus paketai ir pažanga neprisijungus lieka jūsų pačių įrenginyje. Sąsaja pateikiama 59 kalbomis, o penki veiksmų žodžiai — Fold, Check, Call, Raise, All-In — lieka angliški, kaip ir prie bet kurio stalo pasaulyje. Daugiau <a href=\"{faq}\">dažnuose klausimuose</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  et: {
    ...
    faqP: function (h, c) { return "Üheski režiimis ei ole mängus päris raha. Sinu seaded, stiilipakid ja võrguvaba edenemine jäävad sinu enda seadmesse. Liides on saadaval 59 keeles ja viis käigusõna — Fold, Check, Call, Raise, All-In — jäävad inglise keelde, nagu igas lauas üle maailma. Rohkem <a href=\"{faq}\">korduvates küsimustes</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  lv: {
    ...
    faqP: function (h, c) { return "Nevienā režīmā spēlē nav īstas naudas. Tavi iestatījumi, stilu komplekti un bezsaistes progress paliek tavā paša ierīcē. Saskarne ir pieejama 59 valodās, bet pieci darbību vārdi — Fold, Check, Call, Raise, All-In — paliek angliski, tāpat kā pie ikviena galda pasaulē. Vairāk <a href=\"{faq}\">biežāk uzdotajos jautājumos</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  ms: {
    ...
    faqH2: "Soalan Lazim",
    faqP: function (h, c) { return "Tiada wang sebenar dalam mana-mana mod. Tetapan, pakej gaya dan kemajuan luar talian anda kekal pada peranti anda. Antara muka tersedia dalam 59 bahasa, sementara lima perkataan tindakan — Fold, Check, Call, Raise, All-In — kekal dalam bahasa Inggeris, seperti di setiap meja di dunia. Lebih lanjut dalam <a href=\"{faq}\">soalan lazim</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  sq: {
    ...
    faqP: function (h, c) { return "Në asnjë modalitet s’ka para të vërteta. Cilësimet e tua, paketat e stileve dhe përparimi offline mbeten në pajisjen tënde. Ndërfaqja është e disponueshme në 59 gjuhë, ndërsa pesë fjalët e veprimeve — Fold, Check, Call, Raise, All-In — mbeten në anglisht, si te çdo tavolinë në botë. Më shumë te <a href=\"{faq}\">pyetjet e shpeshta</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  pa: {
    ...
    faqP: function (h, c) { return "ਕਿਸੇ ਵੀ ਮੋਡ ਵਿੱਚ ਅਸਲੀ ਪੈਸਾ ਨਹੀਂ। ਤੁਹਾਡੀਆਂ ਸੈਟਿੰਗਾਂ, ਸ਼ੈਲੀ ਪੈਕ ਅਤੇ ਆਫਲਾਈਨ ਪ੍ਰਗਤੀ ਤੁਹਾਡੇ ਯੰਤਰ \u2019ਤੇ ਰਹਿੰਦੇ ਹਨ। ਇੰਟਰਫੇਸ 59 ਭਾਸ਼ਾਵਾਂ ਵਿੱਚ ਉਪਲਬਧ ਹੈ, ਜਦਕਿ ਪੰਜ ਕਾਰਵਾਈ ਸ਼ਬਦ — Fold, Check, Call, Raise, All-In — ਦੁਨੀਆ ਦੇ ਹਰ ਟੇਬਲ ਵਾਂਗ ਅੰਗਰੇਜ਼ੀ ਵਿੱਚ ਰਹਿੰਦੇ ਹਨ। ਹੋਰ <a href=\"{faq}\">ਅਕਸਰ ਪੁੱਛੇ ਜਾਂਦੇ ਸਵਾਲਾਂ</a> ਵਿੱਚ।".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  am: {
  ...
  te: {
    ...
    faqP: function (h, c) { return "ఏ మోడ్‌లోనూ, ఎప్పుడూ డబ్బు ప్రమేయం ఉండదు. మీ సెట్టింగ్‌లు, స్టైల్ ప్యాక్‌లు మరియు ఆఫ్‌లైన్ పురోగతి మీ పరికరంలోనే ఉంటాయి. ఇంటర్‌ఫేస్ 59 భాషల్లో ఉంది, అయితే ఐదు చర్య పదాలు — Fold, Check, Call, Raise, All-In — ప్రపంచంలోని ప్రతి టేబుల్ వద్ద లాగే ఇంగ్లీష్‌లోనే ఉంటాయి. మరిన్ని వివరాలు <a href=\"{faq}\">FAQ</a> లో.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ml: {
  ...
  mr: {
    ...
    faqP: function (h, c) { return "कोणत्याही मोडमध्ये, कधीही पैशांचा संबंध येत नाही. तुमची सेटिंग्ज, स्टाईल पॅक्स आणि ऑफलाइन प्रगती तुमच्या उपकरणावरच राहते. इंटरफेस 59 भाषांमध्ये आहे, पण पाच कृती शब्द — Fold, Check, Call, Raise, All-In — जगातल्या प्रत्येक टेबलप्रमाणे इंग्रजीतच राहतात. अधिक माहिती <a href=\"{faq}\">FAQ</a> मध्ये.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  kn: {
    ...
    faqP: function (h, c) { return "ಯಾವ ಮೋಡ್‌ನಲ್ಲೂ, ಎಂದಿಗೂ ಹಣದ ಸಂಬಂಧವಿಲ್ಲ. ನಿಮ್ಮ ಸೆಟ್ಟಿಂಗ್‌ಗಳು, ಸ್ಟೈಲ್ ಪ್ಯಾಕ್‌ಗಳು ಮತ್ತು ಆಫ್‌ಲೈನ್ ಪ್ರಗತಿ ನಿಮ್ಮ ಸಾಧನದಲ್ಲೇ ಉಳಿಯುತ್ತವೆ. ಇಂಟರ್‌ಫೇಸ್ 59 ಭಾಷೆಗಳಲ್ಲಿದೆ, ಆದರೆ ಐದು ಕ್ರಿಯಾ ಪದಗಳು — Fold, Check, Call, Raise, All-In — ಜಗತ್ತಿನ ಪ್ರತಿ ಟೇಬಲ್‌ನಲ್ಲಿರುವಂತೆ ಇಂಗ್ಲಿಷ್‌ನಲ್ಲೇ ಉಳಿಯುತ್ತವೆ. ಹೆಚ್ಚಿನ ವಿವರ <a href=\"{faq}\">FAQ</a> ನಲ್ಲಿ.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
   ...
   af: {
    ...
    faqH2: "Algemene vrae",
    faqP: function (h, c) { return "Daar is nooit geld ter sprake nie, in geen modus nie. Jou instellings, stylpakkette en vanlyn vordering bly op jou eie toestel. Die koppelvlak is in 59 tale beskikbaar, terwyl die vyf aksiewoorde — Fold, Check, Call, Raise, All-In — in Engels bly, soos aan enige tafel ter wêreld. Meer by die <a href=\"{faq}\">algemene vrae</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  fil: {
    ...
    faqP: function (h, c) { return "Walang perang kasangkot, sa alinmang mode. Nananatili sa sarili mong device ang mga setting, style pack at offline na progreso mo. Available ang interface sa 59 wika, samantalang ang limang salitang aksyon — Fold, Check, Call, Raise, All-In — ay nananatiling Ingles, gaya sa anumang mesa sa mundo. Higit pa sa <a href=\"{faq}\">karaniwang tanong</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  sw: {
    ...
    faqP: function (h, c) { return "Hakuna pesa halisi zinazohusika, katika hali yoyote ile. Mipangilio yako, vifurushi vya mtindo na maendeleo yako ya nje ya mtandao hubaki kwenye kifaa chako mwenyewe. Kiolesura kinapatikana katika lugha 59, huku maneno matano ya vitendo — Fold, Check, Call, Raise, All-In — yakibaki Kiingereza, kama ilivyo kwenye kila meza duniani. Zaidi katika <a href=\"{faq}\">maswali ya kawaida</a>.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  },
  ...
  ta: {
    ...
    faqP: function (h, c) { return "எந்த முறையிலும் பணம் சம்பந்தப்படுவதில்லை. உங்கள் அமைப்புகள், தோற்றத் தொகுப்புகள், இணையமில்லா முன்னேற்றம் அனைத்தும் உங்கள் சாதனத்திலேயே இருக்கும். இடைமுகம் 59 மொழிகளில் கிடைக்கிறது; ஐந்து செயல் சொற்கள் — Fold, Check, Call, Raise, All-In — உலகின் எந்த மேசையிலும் போலவே ஆங்கிலத்திலேயே இருக்கும். மேலும் <a href=\"{faq}\">அடிக்கடி கேட்கப்படுபவை</a> பக்கத்தில்.".replace('{rules}', h('rules', c)).replace('{hands}', h('hands', c)).replace('{faq}', h('faq', c)); }
  }
