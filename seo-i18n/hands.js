...
var PARTS = {
  ...
  ga: {
    ...
    desc: "Na deich lámh pócair Texas Hold’em in ord ón sruth ríoga go dtí an cárta ard, le samplaí, dóchúlacht gach ceann acu agus conas a réitítear comhionannais.",
    ldHeadline: "Lámha pócair — Texas Hold’em",
    ldDesc: "Na deich lámh Texas Hold’em in ord, le samplaí, minicíochtaí agus rialacha comhionannais.",
    h1: "Lámha pócair",
    lead: "In Texas Hold’em rangaítear na lámha ón gceann is láidre go dtí an ceann is laige mar seo a leanas. Bíonn lámh i gcónaí díreach cúig chárta, roghnaithe ó na seacht gcinn a fheiceann tú: do dhá chárta phríobháideacha agus na cúig chárta phobail ar an mbord.",
    names: [
      "Sruth ríoga",
      "Sruth datha",
      "Ceathair den saghas céanna",
      "Teach lán",
      "Dath",
      "Sruth",
      "Trí den saghas céanna",
      "Dhá phéire",
      "Péire",
      "Cárta ard",
    ],
    texts: [
      "A K Q J 10, iad uile den chulaith chéanna. An lámh is fearr is féidir; ní féidir í a bhualadh, ach í a mheaitseáil amháin.",
      "Cúig chárta i ndiaidh a chéile, iad uile den chulaith chéanna. Idir dhá shruth datha, buann an ceann leis an gcárta uachtair is airde.",
      "Ceithre chárta den luach céanna. Réitíonn an cúigiú cárta (an kicker) an comhionannas annamh idir dhá cheathair den saghas céanna comhionanna ar an mbord.",
      "Trí den saghas céanna agus péire. Cuirtear an chuid trí chárta i gcomparáid ar dtús, ansin an péire.",
      "Cúig chárta den chulaith chéanna, nach bhfuil i ndiaidh a chéile. Cuirtear i gcomparáid iad cárta ar chárta ón mbarr; níl culaith ar bith níos airde ná culaith eile.",
      "Cúig chárta i ndiaidh a chéile, culaithe measctha. Imríonn an tAon ard (10-J-Q-K-A) nó íseal (A-2-3-4-5), riamh an dá rud ag an am céanna.",
      "Trí chárta den luach céanna, agus dhá chárta gan bhaint.",
      "Dhá phéire éagsúla agus cúigiú cárta. Cuirtear an péire ard i gcomparáid ar dtús, ansin an péire íseal, ansin an kicker.",
      "Dhá chárta den luach céanna agus trí chárta gan bhaint, curtha i gcomparáid in ord.",
      "Dada díobh sin thuas. Socraíonn an cárta is airde, ansin an chéad cheann eile, agus mar sin de.",
    ],
    dealt: "le feiceáil i %s de lámha seacht gcárta",
    tiesH2: "Conas a réitítear comhionannais",
    tiesP: "Cuirtear an chatagóir i gcomparáid ar dtús: buaileann aon dath aon sruth, is cuma cad iad na cártaí. Más ionann an chatagóir, cuirtear i gcomparáid luach ar luach ón mbarr. Tugtar an <em>kicker</em> ar an méid a fhanann tar éis na teaglama, agus socraíonn sé i bhfad níos mó lámh ná mar a shíleann tosaitheoirí: déanann A♠ K♦ agus A♣ 7♥ araon péire aonta ar bhord A-9-4, ach buaileann an Rí an seacht ar an kicker. Ní shocraíonn culaithe dada riamh in Hold’em — roinneann beirt imreoirí leis na cúig luach chéanna an pota go dtí an sceallóg dheireanach.",
    wrongH2: "Míthuiscintí coitianta",
    wrong: [
      "Is é an tAon an cárta is airde agus is ísle i sruth: is é A-K-Q-J-10 an ceann is fearr, agus is é A-2-3-4-5 (an <em>roth</em>) an ceann is laige. Ní chasann an t-ord timpeall — ní dada é Q-K-A-2-3.",
      "Is é dath cúig chárta den chulaith chéanna, ní ceithre cinn. Níl ceithre chroí idir do lámh agus an bord fiú dada iontu féin.",
      "Tugtar <em>set</em> ar thrí den saghas céanna ó phéire póca agus cárta ar an mbord; ó chárta amháin i do lámh agus péire ar an mbord, <em>trips</em>. An rangú céanna, neart an-difriúil, mar go bhfeiceann gach duine na trips.",
      "Ní chomhairtear ach na cúig chárta is fearr. Le dhá phéire i do lámh agus tríú péire ar an mbord, tá dhá phéire agat, ní trí.",
...
,
  ...
  yo: {
    ...
    desc: "Ọwọ́ poker mẹ́wàá ti Texas Hold’em ní ìtòlẹ́sẹẹsẹ láti Royal Flush dé High Card, pẹ̀lú àpẹẹrẹ, àǹfààní ọ̀kọ̀ọ̀kan àti bí a ṣe ń yanjú ọwọ́ tí ó dọ́gba.",
    ldHeadline: "Àwọn ọwọ́ poker — Texas Hold’em",
    ldDesc: "Ọwọ́ mẹ́wàá ti Texas Hold’em ní ìtòlẹ́sẹẹsẹ, pẹ̀lú àpẹẹrẹ, bí wọ́n ṣe máa ń ṣẹlẹ̀ tó àti òfin ìdọ́gba.",
    h1: "Àwọn ọwọ́ poker",
    lead: "Nínú Texas Hold’em, a ń to àwọn ọwọ́ láti alágbára jù sí aláìlágbára jù báyìí. Ọwọ́ kan máa ń jẹ́ káàdì márùn-ún gangan, tí a yàn láti inú méje tí o rí: káàdì àṣírí rẹ méjì àti káàdì gbangba márùn-ún lórí tábìlì.",
    names: [
      "Royal Flush",
      "Straight Flush",
      "Four of a Kind",
    ...
    texts: [
      "A K Q J 10, gbogbo wọn àwọ̀ kan náà. Ọwọ́ tó dára jù tí ó ṣeé ṣe; a kò lè borí rẹ̀, àfi kí a dọ́gba pẹ̀lú rẹ̀.",
      "Káàdì márùn-ún tẹ̀léra, gbogbo wọn àwọ̀ kan náà. Láàárín Straight Flush méjì, èyí tí ó ní káàdì tó ga jù lókè ló ń borí.",
      "Káàdì mẹ́rin tí iye wọn jọra. Káàdì karùn-ún (kicker) ń yanjú ìdọ́gba tí kò wọ́pọ̀ láàárín Four of a Kind kan náà méjì lórí tábìlì.",
      "Three of a Kind pẹ̀lú pair. A kọ́kọ́ ń fi apá káàdì mẹ́ta wéra, lẹ́yìn náà pair.",
      "Káàdì márùn-ún àwọ̀ kan náà, tí kò tẹ̀léra. A ń fi wọ́n wéra ní káàdì kọ̀ọ̀kan láti òkè; kò sí àwọ̀ tí ó ga ju òmíràn lọ.",
      "Káàdì márùn-ún tẹ̀léra, àwọ̀ oríṣiríṣi. Ace ń ṣeré gẹ́gẹ́ bí èyí tó ga (10-J-Q-K-A) tàbí tó kéré (A-2-3-4-5), kì í ṣe méjèèjì lẹ́ẹ̀kan náà.",
      "Káàdì mẹ́ta tí iye wọn jọra, pẹ̀lú káàdì méjì tí kò ní í ṣe pẹ̀lú wọn.",
      "Pair méjì ọ̀tọ̀ọ̀tọ̀ àti káàdì karùn-ún. A kọ́kọ́ ń fi pair tó ga wéra, lẹ́yìn náà pair tó kéré, lẹ́yìn náà kicker.",
      "Káàdì méjì tí iye wọn jọra àti káàdì mẹ́ta tí kò ní í ṣe pẹ̀lú wọn, tí a fi wéra ní ìtòlẹ́sẹẹsẹ.",
      "Kò sí ọ̀kankan nínú àwọn tí ó wà lókè. Káàdì tó ga jù ló ń pinnu, lẹ́yìn náà èyí tó kàn, bẹ́ẹ̀ bẹ́ẹ̀ lọ.",
    ],
    dealt: "ó ń hàn nínú %s àwọn ọwọ́ káàdì méje",
    tiesH2: "Bí a ṣe ń yanjú ìdọ́gba",
    tiesP: "A kọ́kọ́ ń fi ẹ̀ka wéra: Flush èyíkéyìí ń borí Straight èyíkéyìí, láìka àwọn káàdì sí. Bí ẹ̀ka bá jẹ́ ọ̀kan náà, a ń fi iye wéra ní ọ̀kọ̀ọ̀kan láti òkè. Ohun tí ó kù lẹ́yìn àkópọ̀ ni a ń pè ní <em>kicker</em>, ó sì ń pinnu ọwọ́ ju bí àwọn olùbẹ̀rẹ̀ ṣe ń retí lọ: A♠ K♦ àti A♣ 7♥ méjèèjì ń ṣe pair Ace lórí tábìlì A-9-4, ṣùgbọ́n Ọba ń borí méje lórí kicker. Àwọn àwọ̀ kì í pinnu nǹkan kan nínú Hold’em rárá — òṣèré méjì tí wọ́n ní iye márùn-ún kan náà ń pín pot títí dé chip ìkẹyìn.",
    wrongH2: "Àṣìṣe òye tí ó wọ́pọ̀",
    wrong: [
      "Ace ni káàdì tó ga jù àti tó kéré jù nínú Straight: A-K-Q-J-10 ló dára jù, A-2-3-4-5 (<em>wheel</em>) ni aláìlágbára jù. Ìtẹ̀léra kì í yípo — Q-K-A-2-3 kì í ṣe nǹkan kan.",
      "Flush jẹ́ káàdì márùn-ún àwọ̀ kan náà, kì í ṣe mẹ́rin. Ọkàn mẹ́rin láàárín ọwọ́ rẹ àti tábìlì kò ní iye fúnra wọn.",
      "Three of a Kind láti pair àpò àti káàdì kan lórí tábìlì ni a ń pè ní <em>set</em>; láti káàdì kan lọ́wọ́ rẹ àti pair lórí tábìlì, <em>trips</em>. Ipò kan náà ni, ṣùgbọ́n agbára yàtọ̀ gan-an, nítorí gbogbo ènìyàn ń rí trips.",
      "Káàdì márùn-ún tó dára jù nìkan ni a ń kà. Pẹ̀lú pair méjì lọ́wọ́ rẹ àti pair kẹta lórí tábìlì, o ní Two Pair, kì í ṣe mẹ́ta.",
  ...
  zu: {
    ...
    desc: "Izandla eziyishumi ze-poker ze-Texas Hold’em ngokulandelana kusukela ku-Royal Flush kuya ku-High Card, nezibonelo, amathuba esandla ngasinye nendlela okuxazululwa ngayo ukulingana.",
    ldHeadline: "Izandla ze-poker — Texas Hold’em",
    ldDesc: "Izandla eziyishumi ze-Texas Hold’em ngokulandelana, nezibonelo, ukuvama kwazo nemithetho yokulingana.",
    h1: "Izandla ze-poker",
    lead: "Ku-Texas Hold’em izandla zilandelana kanje kusukela koqine kakhulu kuya kobuthakathaka kakhulu. Isandla sihlala singamakhadi amahlanu ngqo, akhethwe kwayisikhombisa owabonayo: amakhadi akho amabili ayimfihlo namakhadi omphakathi amahlanu etafuleni.",
    names: [
      "Royal Flush",
      "Straight Flush",
      "Four of a Kind",
    ...
    texts: [
      "A K Q J 10, konke umbala ofanayo. Isandla esingcono kakhulu esingenzeka; asinakuhlulwa, singalinganiswa kuphela.",
      "Amakhadi amahlanu alandelanayo, onke anombala ofanayo. Phakathi kwama-Straight Flush amabili, lelo elinekhadi eliphezulu phezulu liyawina.",
      "Amakhadi amane anenani elifanayo. Ikhadi lesihlanu (i-kicker) lixazulula ukulingana okungavamile phakathi kwama-Four of a Kind afanayo amabili etafuleni.",
      "Three of a Kind kanye ne-pair. Kuqala kuqhathaniswa ingxenye yamakhadi amathathu, bese kuba yi-pair.",
      "Amakhadi amahlanu anombala ofanayo, angalandelani. Aqhathaniswa ikhadi ngekhadi kusukela phezulu; awukho umbala ophakeme kunomunye.",
      "Amakhadi amahlanu alandelanayo, imibala exubile. I-Ace idlala iphezulu (10-J-Q-K-A) noma iphansi (A-2-3-4-5), hhayi kokubili ngesikhathi esisodwa.",
      "Amakhadi amathathu anenani elifanayo, namakhadi amabili angahlobene.",
      "Ama-pair amabili ahlukene nekhadi lesihlanu. Kuqala kuqhathaniswa i-pair ephezulu, bese kuba i-pair ephansi, bese kuba yi-kicker.",
      "Amakhadi amabili anenani elifanayo namakhadi amathathu angahlobene, aqhathaniswa ngokulandelana.",
      "Akukho kokungenhla. Ikhadi eliphezulu liyanquma, bese kuba elilandelayo, njalonjalo.",
    ],
    dealt: "ivela ku-%s wezandla zamakhadi ayisikhombisa",
    tiesH2: "Indlela okuxazululwa ngayo ukulingana",
    tiesP: "Kuqala kuqhathaniswa isigaba: noma iyiphi i-Flush ihlula noma iyiphi i-Straight, noma ngabe amakhadi anjani. Uma isigaba sifana, amanani aqhathaniswa ngalinye kusukela phezulu. Okusele ngemuva kwenhlanganisela kubizwa ngokuthi yi-<em>kicker</em>, futhi kunquma izandla kaningi kunalokho abasaqalayo abakulindele: A♠ K♦ no-A♣ 7♥ kokubili kwenza i-pair yama-Ace etafuleni elingu-A-9-4, kodwa iKhosi lihlula isikhombisa ku-kicker. Imibala ayinqumi lutho neze ku-Hold’em — abadlali ababili abanamanani amahlanu afanayo bahlukanisa i-pot kuze kube yi-chip yokugcina.",
    wrongH2: "Ukungaqondi okuvamile",
    wrong: [
      "I-Ace iyikhadi eliphezulu kakhulu neliphansi kakhulu ku-Straight: A-K-Q-J-10 ingcono kakhulu, A-2-3-4-5 (i-<em>wheel</em>) ibuthakathaka kakhulu. Ukulandelana akujikelezi — Q-K-A-2-3 akulutho.",
      "I-Flush ingamakhadi amahlanu anombala ofanayo, hhayi amane. Izinhliziyo ezine phakathi kwesandla sakho netafula azinalo inani ngokwazo.",
      "Three of a Kind evela ku-pair yephakethe nekhadi etafuleni ibizwa ngokuthi yi-<em>set</em>; evela ekhadini elilodwa esandleni sakho ne-pair etafuleni, yi-<em>trips</em>. Izinga liyafana, kodwa amandla ahluke kakhulu, ngoba wonke umuntu uyazibona izi-trips.",
      "Amakhadi amahlanu angcono kakhulu kuphela ayabalwa. Uma unama-pair amabili esandleni sakho ne-pair yesithathu etafuleni, une-Two Pair, hhayi ezintathu.",
  ...
  tk: {
    ...
    desc: "Texas Hold’em-iň on poker kombinasiýasy roýal-fleşden uly karta çenli tertipde, mysallar, her biriniň ähtimallygy we deňligiň nähili çözülýändigi bilen.",
    ldHeadline: "Poker kombinasiýalary — Texas Hold’em",
    ldDesc: "Texas Hold’em-iň on kombinasiýasy tertip boýunça, mysallar, ýygylyk we deňlik düzgünleri bilen.",
    h1: "Poker kombinasiýalary",
    lead: "Texas Hold’em-de kombinasiýalar iň güýçliden iň gowşaga şeýle tertiplenýär. Kombinasiýa hemişe takyk bäş kart bolup, gören ýedi kartyňyzdan saýlanýar: iki şahsy kartyňyz we stoldaky bäş umumy kart.",
    names: ["Roýal-fleş", "Strit-fleş", "Kare", "Full-haus", "Fleş", "Strit", "Üçlük", "Iki jübüt", "Jübüt", "Uly kart"],
    texts: [
      "A K Q J 10, hemmesi bir masty. Mümkin bolan iň gowy kombinasiýa; ony ýeňip bolmaýar, diňe deňleşip bolýar.",
      "Yzygiderli bäş kart, hemmesi bir masty. Iki strit-fleşiň arasynda iň ýokarky karty uly bolany utýar.",
      "Birmeňzeş bahaly dört kart. Bäşinji kart (kiker) stoldaky birmeňzeş iki kareniň arasyndaky seýrek deňligi çözýär.",
      "Üçlük we jübüt. Ilki üç kartly bölegi, soňra jübüt deňeşdirilýär.",
      "Bir mastdaky bäş kart, yzygiderli däl. Olar ýokardan başlap kart-kart deňeşdirilýär; hiç bir mast beýlekisinden ýokary däl.",
      "Yzygiderli bäş kart, dürli mastlar. Tuz ýokary (10-J-Q-K-A) ýa-da aşaky (A-2-3-4-5) bolup oýnaýar, ikisi birden däl.",
      "Birmeňzeş bahaly üç kart we baglanyşyksyz iki kart.",
      "Iki dürli jübüt we bäşinji kart. Ilki ýokary jübüt, soňra aşaky jübüt, soňra kiker deňeşdirilýär.",
      "Birmeňzeş bahaly iki kart we tertip boýunça deňeşdirilýän baglanyşyksyz üç kart.",
      "Ýokardakylaryň hiç biri ýok. Iň uly kart çözýär, soňra indikisi we şuňa meňzeşler.",
    ],
    dealt: "ýedi kartly elleriň %s-inde duş gelýär",
    tiesH2: "Deňlik nähili çözülýär",
    tiesP: "Ilki kategoriýa deňeşdirilýär: islendik fleş islendik striti ýeňýär, kartlar nähili bolsa-da. Kategoriýa birmeňzeş bolsa, bahalar ýokardan başlap birme-bir deňeşdirilýär. Kombinasiýadan soň galan zada <em>kiker</em> diýilýär we ol täze başlaýanlaryň garaşýanyndan has köp eli çözýär: A♠ K♦ we A♣ 7♥ ikisi hem A-9-4 stolunda tuz jübütini düzýär, ýöne kiker boýunça korol ýedini ýeňýär. Hold’em-de mastlar hiç haçan hiç zady çözmeýär — bäş bahasy birmeňzeş iki oýunçy banky soňky çipe çenli bölüşýär.",
    wrongH2: "Ýaýran ýalňyş düşünjeler",
    wrong: [
      "Tuz stritde hem iň uly, hem iň kiçi kart: A-K-Q-J-10 iň gowusy, A-2-3-4-5 (<em>tigir</em>) bolsa iň gowşagy. Hatar aýlanmaýar — Q-K-A-2-3 hiç zat däl.",
      "Fleş bir mastdaky bäş kart, dört däl. Eliňiz bilen stoluň arasyndaky dört gyzyl ýürek özbaşdak hiç zat däl.",
      "Şahsy jübütden we stoldaky kartdan düzülen üçlüge <em>set</em> diýilýär; eliňizdäki bir kartdan we stoldaky jübütden — <em>trips</em>. Derejesi birmeňzeş, ýöne güýji düýbünden başga, sebäbi tripsi hemmeler görýär.",
      "Diňe iň gowy bäş kart hasaplanýar. Eliňizde iki jübüt we stolda üçünji jübüt bolsa, sizde iki jübüt bar, üç däl.",
  ...
  eo: {
    ...
    desc: "La dek manoj de Texas Hold’em pokero ordigitaj de la reĝa samkolora vico ĝis la alta karto, kun ekzemploj, la probablo de ĉiu kaj kiel egalecoj estas decidataj.",
    ldHeadline: "Pokeraj manoj — Texas Hold’em",
    ldDesc: "La dek manoj de Texas Hold’em laŭorde, kun ekzemploj, oftecoj kaj reguloj pri egaleco.",
    h1: "Pokeraj manoj",
    lead: "En Texas Hold’em la manoj estas rangigitaj de la plej forta al la plej malforta jene. Mano ĉiam konsistas el ĝuste kvin kartoj, elektitaj el la sep kiujn vi vidas: viaj du privataj kartoj kaj la kvin komunaj kartoj sur la tablo.",
    names: [
      "Reĝa samkolora vico",
      "Samkolora vico",
      "Kvaropo",
    ...
    texts: [
      "A K Q J 10, ĉiuj samkoloraj. La plej bona ebla mano; ĝi ne estas venkebla, nur egalebla.",
      "Kvin sinsekvaj kartoj, ĉiuj samkoloraj. Inter du samkoloraj vicoj gajnas tiu kun la pli alta supra karto.",
      "Kvar kartoj de sama valoro. La kvina karto (la kicker) decidas la maloftan egalecon inter du identaj kvaropoj sur la tablo.",
      "Triopo plus paro. Unue oni komparas la trikartan parton, poste la paron.",
      "Kvin samkoloraj kartoj, ne sinsekvaj. Ili estas komparataj karto post karto de supre; neniu koloro estas super alia.",
      "Kvin sinsekvaj kartoj, miksitaj koloroj. La Aso ludas alte (10-J-Q-K-A) aŭ malalte (A-2-3-4-5), neniam ambaŭ samtempe.",
      "Tri kartoj de sama valoro, plus du nerilataj kartoj.",
      "Du malsamaj paroj plus kvina karto. Unue la alta paro, poste la malalta paro, poste la kicker estas komparataj.",
      "Du kartoj de sama valoro plus tri nerilataj kartoj, komparataj laŭorde.",
      "Nenio el la supraj. Decidas la plej alta karto, poste la sekva, kaj tiel plu.",
    ],
    dealt: "aperas en %s de sepkartaj manoj",
    tiesH2: "Kiel egalecoj estas decidataj",
    tiesP: "Unue oni komparas la kategorion: ajna samkoloro batas ajnan vicon, negrave kiuj estas la kartoj. Se la kategorio estas la sama, oni komparas valoron post valoro de supre. Kio restas post la kombinaĵo nomiĝas la <em>kicker</em>, kaj ĝi decidas multe pli da manoj ol komencantoj supozas: A♠ K♦ kaj A♣ 7♥ ambaŭ faras paron de Asoj sur tablo A-9-4, sed la Reĝo batas la sepon per la kicker. Koloroj neniam decidas ion ajn en Hold’em — du ludantoj kun la samaj kvin valoroj dividas la poton ĝis la lasta ĵetono.",
    wrongH2: "Oftaj miskomprenoj",
    wrong: [
      "La Aso estas kaj la plej alta kaj la plej malalta karto de vico: A-K-Q-J-10 estas la plej bona, A-2-3-4-5 (la <em>rado</em>) la plej malforta. La sinsekvo ne rondiras — Q-K-A-2-3 estas nenio.",
      "Samkoloro estas kvin kartoj de sama koloro, ne kvar. Kvar koroj inter via mano kaj la tablo valoras nenion per si mem.",
      "Triopo el poŝparo plus karto sur la tablo nomiĝas <em>set</em>; el unu karto en via mano plus paro sur la tablo, <em>trips</em>. Sama rango, tre malsama forto, ĉar ĉiuj vidas trips.",
      "Nur la plej bonaj kvin kartoj kalkuliĝas. Kun du paroj en la mano kaj tria paro sur la tablo, vi havas du parojn, ne tri.",
  ...
  tg: {
    ...
    desc: "Даҳ комбинатсияи покери Texas Hold’em бо тартиб аз роял-флеш то корти баланд, бо мисолҳо, эҳтимолияти ҳар кадом ва тарзи ҳалли баробарӣ.",
    ldHeadline: "Комбинатсияҳои покер — Texas Hold’em",
    ldDesc: "Даҳ комбинатсияи Texas Hold’em бо тартиб, бо мисолҳо, басомад ва қоидаҳои баробарӣ.",
    h1: "Комбинатсияҳои покер",
    lead: "Дар Texas Hold’em комбинатсияҳо аз қавитарин то заифтарин чунин ҷойгир мешаванд. Комбинатсия ҳамеша маҳз панҷ корт аст, ки аз ҳафт корти дидаатон интихоб мешавад: ду корти шахсии шумо ва панҷ корти умумӣ дар миз.",
    names: ["Роял-флеш", "Стрит-флеш", "Каре", "Фулл-хаус", "Флеш", "Стрит", "Сеягӣ", "Ду ҷуфт", "Ҷуфт", "Корти баланд"],
    texts: [
      "A K Q J 10, ҳама як либос. Беҳтарин комбинатсияи имконпазир; онро мағлуб кардан мумкин нест, танҳо баробар шудан мумкин аст.",
      "Панҷ корти пай дар пай, ҳама як либос. Аз ду стрит-флеш ҳамон мебарад, ки корти болоиаш баландтар аст.",
      "Чор корти якарзиш. Корти панҷум (кикер) баробарии нодирро байни ду карени якхела дар миз ҳал мекунад.",
      "Сеягӣ ва ҷуфт. Аввал қисми секорта, сипас ҷуфт муқоиса карда мешавад.",
      "Панҷ корти як либос, на пай дар пай. Онҳо аз боло корт ба корт муқоиса карда мешаванд; ҳеҷ либос аз дигаре баландтар нест.",
      "Панҷ корти пай дар пай, либосҳои гуногун. Туз ҳамчун баланд (10-J-Q-K-A) ё паст (A-2-3-4-5) бозӣ мекунад, на ҳарду якбора.",
      "Се корти якарзиш ва ду корти ба ҳам алоқаманд набуда.",
      "Ду ҷуфти гуногун ва корти панҷум. Аввал ҷуфти баландтар, сипас ҷуфти пасттар, сипас кикер муқоиса карда мешавад.",
      "Ду корти якарзиш ва се корти ба ҳам алоқаманд набуда, ки бо тартиб муқоиса мешаванд.",
      "Ҳеҷ яке аз болоӣ. Корти баландтарин ҳал мекунад, сипас навбатӣ ва ҳоказо.",
    ],
    dealt: "дар %s-и дастҳои ҳафткорта пайдо мешавад",
    tiesH2: "Баробарӣ чӣ тавр ҳал мешавад",
    tiesP: "Аввал категория муқоиса карда мешавад: ҳар флеш ҳар стритро мағлуб мекунад, новобаста аз кортҳо. Агар категория якхела бошад, арзишҳо аз боло як-як муқоиса карда мешаванд. Он чӣ пас аз комбинатсия мемонад, <em>кикер</em> ном дорад ва он дастҳоро бештар аз оне ки навкорон интизоранд, ҳал мекунад: A♠ K♦ ва A♣ 7♥ ҳарду дар мизи A-9-4 ҷуфти туз месозанд, вале шоҳ аз рӯи кикер ҳафтро мағлуб мекунад. Дар Hold’em либосҳо ҳеҷ гоҳ чизеро ҳал намекунанд — ду бозингари дорои панҷ арзиши якхела банкро то чипи охирин тақсим мекунанд.",
    wrongH2: "Хатоҳои маъмул",
    wrong: [
      "Туз дар стрит ҳам корти баландтарин ва ҳам пасттарин аст: A-K-Q-J-10 беҳтарин, A-2-3-4-5 (<em>чарх</em>) заифтарин. Қатор давр намезанад — Q-K-A-2-3 ҳеҷ чиз нест.",
      "Флеш панҷ корти як либос аст, на чор. Чор дил байни дасти шумо ва миз худ аз худ арзише надорад.",
      "Сеягӣ аз ҷуфти шахсӣ ва корти миз <em>сет</em> ном дорад; аз як корт дар дасти шумо ва ҷуфт дар миз — <em>трипс</em>. Дараҷа якхела аст, вале қувва хеле фарқ мекунад, зеро трипсро ҳама мебинанд.",
      "Танҳо беҳтарин панҷ корт ҳисоб мешавад. Бо ду ҷуфт дар даст ва ҷуфти сеюм дар миз, шумо ду ҷуфт доред, на се.",
  ...
  mn: {
    ...
    desc: "Texas Hold’em-ийн арван покерын хослол роял флэшээс өндөр хөзөр хүртэл эрэмбээр, жишээ, тус бүрийн магадлал болон тэнцээг хэрхэн шийддэг тухай.",
    ldHeadline: "Покерын хослол — Texas Hold’em",
    ldDesc: "Texas Hold’em-ийн арван хослол эрэмбээр, жишээ, давтамж болон тэнцээний дүрэмтэй.",
    h1: "Покерын хослол",
    lead: "Texas Hold’em-д хослолыг хамгийн хүчтэйгээс хамгийн сул хүртэл ингэж эрэмбэлнэ. Хослол үргэлж яг таван хөзөр бөгөөд таны харж буй долоогоос сонгогдоно: хоёр хувийн хөзөр болон ширээн дээрх таван нийтийн хөзөр.",
    names: ["Роял флэш", "Стрейт флэш", "Каре", "Фулл хаус", "Флэш", "Стрейт", "Гурвал", "Хоёр хос", "Хос", "Өндөр хөзөр"],
    texts: [
      "A K Q J 10, бүгд нэг зүс. Боломжит хамгийн сайн хослол; түүнийг ялах боломжгүй, зөвхөн тэнцэж болно.",
      "Дараалсан таван хөзөр, бүгд нэг зүс. Хоёр стрейт флэшийн дотроос дээд хөзөр нь өндөр нь хожно.",
      "Ижил утгатай дөрвөн хөзөр. Тав дахь хөзөр (кикер) ширээн дээрх ижил хоёр карены ховор тэнцээг шийднэ.",
      "Гурвал ба хос. Эхлээд гурван хөзрийн хэсгийг, дараа нь хосыг харьцуулна.",
      "Нэг зүстэй таван хөзөр, дараалаагүй. Дээрээс нь эхлэн хөзөр хөзрөөр харьцуулна; ямар ч зүс нөгөөгөөсөө дээгүүр биш.",
      "Дараалсан таван хөзөр, холимог зүс. Тамга өндөр (10-J-Q-K-A) эсвэл нам (A-2-3-4-5) болж тоглох ба хоёуланг нь зэрэг биш.",
      "Ижил утгатай гурван хөзөр ба хамааралгүй хоёр хөзөр.",
      "Өөр өөр хоёр хос ба тав дахь хөзөр. Эхлээд өндөр хос, дараа нь нам хос, дараа нь кикерийг харьцуулна.",
      "Ижил утгатай хоёр хөзөр ба дарааллаар нь харьцуулдаг хамааралгүй гурван хөзөр.",
      "Дээрхийн аль нь ч биш. Хамгийн өндөр хөзөр шийдэх ба дараа нь дараагийнх гэх мэт.",
    ],
    dealt: "долоон хөзрийн гарын %s-д гардаг",
    tiesH2: "Тэнцээг хэрхэн шийддэг вэ",
    tiesP: "Эхлээд ангиллыг харьцуулна: ямар ч флэш ямар ч стрейтийг ялна, хөзөр ямар ч байсан. Ангилал ижил бол утгыг дээрээс нь нэг нэгээр харьцуулна. Хослолын дараа үлдсэн хөзрийг <em>кикер</em> гэдэг бөгөөд шинэхэн тоглогчдын бодсоноос олон гарыг шийддэг: A♠ K♦ болон A♣ 7♥ хоёулаа A-9-4 ширээн дээр тамганы хос бүрдүүлэх боловч кикерээр ноён долоог ялна. Hold’em-д зүс хэзээ ч юуг ч шийддэггүй — таван утга нь ижил хоёр тоглогч банкыг сүүлийн чип хүртэл хуваана.",
    wrongH2: "Түгээмэл буруу ойлголт",
    wrong: [
      "Тамга стрейтэд хамгийн өндөр ч, хамгийн нам ч хөзөр: A-K-Q-J-10 хамгийн сайн, A-2-3-4-5 (<em>дугуй</em>) хамгийн сул. Дараалал эргэлддэггүй — Q-K-A-2-3 юу ч биш.",
      "Флэш бол нэг зүстэй таван хөзөр, дөрөв биш. Гар болон ширээний хоорондох дөрвөн гурвалжин өөрөө ямар ч үнэ цэнэгүй.",
      "Хувийн хос ба ширээн дээрх хөзрөөс бүтсэн гурвалыг <em>сет</em> гэнэ; гартаа байгаа нэг хөзөр ба ширээн дээрх хосоос бүтсэнийг <em>трипс</em> гэнэ. Эрэмбэ нь ижил ч хүч нь эрс өөр, учир нь трипсийг бүгд хардаг.",
      "Зөвхөн хамгийн сайн таван хөзрийг тооцно. Гартаа хоёр хос, ширээн дээр гурав дахь хос байвал танд хоёр хос байна, гурав биш.",
  ...
  ha: {
    ...
    desc: "Hannaye goma na poker na Texas Hold’em bisa tsari daga Royal Flush zuwa High Card, tare da misalai, yiwuwar kowane da yadda ake warware kunnen doki.",
    ldHeadline: "Hannayen poker — Texas Hold’em",
    ldDesc: "Hannaye goma na Texas Hold’em bisa tsari, tare da misalai, yawan faruwa da ƙa'idojin kunnen doki.",
    h1: "Hannayen poker",
    lead: "A Texas Hold’em ana jera hannaye daga mafi ƙarfi zuwa mafi rauni kamar haka. Hannu koyaushe katuna biyar ne daidai, da aka zaɓa daga bakwai da kake gani: katunanka biyu na sirri da katunan jama'a biyar a tebur.",
    names: [
      "Royal Flush",
      "Straight Flush",
      "Four of a Kind",
    ...
    texts: [
      "A K Q J 10, duka launi ɗaya. Mafi kyawun hannu da ake iya samu; ba za a iya doke shi ba, sai dai a yi daidai da shi.",
      "Katuna biyar a jere, duka launi ɗaya. Tsakanin Straight Flush biyu, wanda ke da kati mafi girma a sama ne ke cin nasara.",
      "Katuna huɗu masu ƙima ɗaya. Kati na biyar (kicker) yana warware kunnen doki da ba a saba gani ba tsakanin Four of a Kind biyu iri ɗaya a tebur.",
      "Three of a Kind da pair. Ana kwatanta sashen katuna uku da farko, sannan pair.",
      "Katuna biyar masu launi ɗaya, ba a jere ba. Ana kwatanta su kati bayan kati daga sama; babu launin da ya fi wani.",
      "Katuna biyar a jere, launuka gauraye. Ace yana wasa babba (10-J-Q-K-A) ko ƙarami (A-2-3-4-5), ba duka biyu a lokaci ɗaya ba.",
      "Katuna uku masu ƙima ɗaya, da katuna biyu da ba su da alaƙa.",
      "Pair biyu daban-daban da kati na biyar. Ana kwatanta babban pair da farko, sannan ƙaramin pair, sannan kicker.",
      "Katuna biyu masu ƙima ɗaya da katuna uku da ba su da alaƙa, ana kwatanta su bisa tsari.",
      "Babu ɗaya daga cikin na sama. Kati mafi girma ne ke yanke hukunci, sannan na gaba, da sauransu.",
    ],
    dealt: "yana bayyana a %s na hannayen katuna bakwai",
    tiesH2: "Yadda ake warware kunnen doki",
    tiesP: "Ana kwatanta rukuni da farko: kowane Flush yana doke kowane Straight, komai katunan. Idan rukuni ɗaya ne, ana kwatanta ƙima bayan ƙima daga sama. Abin da ya rage bayan haɗuwar ana kiransa <em>kicker</em>, kuma yana yanke hukuncin hannaye fiye da yadda sababbin 'yan wasa ke tsammani: A♠ K♦ da A♣ 7♥ duka suna yin pair na Ace a tebur na A-9-4, amma Sarki yana doke bakwai a kan kicker. Launuka ba sa taɓa yanke hukunci a Hold’em — 'yan wasa biyu masu ƙima biyar iri ɗaya suna raba pot har zuwa chip na ƙarshe.",
    wrongH2: "Kuskuren fahimta da aka saba",
    wrong: [
      "Ace shi ne kati mafi girma kuma mafi ƙanƙanta a Straight: A-K-Q-J-10 shi ne mafi kyau, A-2-3-4-5 (<em>wheel</em>) shi ne mafi rauni. Jerin ba ya zagayowa — Q-K-A-2-3 ba komai ba ne.",
      "Flush katuna biyar ne masu launi ɗaya, ba huɗu ba. Zuciya huɗu tsakanin hannunka da tebur ba su da daraja da kansu.",
      "Three of a Kind daga pair na aljihu da kati a tebur ana kiransa <em>set</em>; daga kati ɗaya a hannunka da pair a tebur, <em>trips</em>. Matsayi ɗaya ne, amma ƙarfi ya bambanta sosai, saboda kowa yana ganin trips.",
      "Mafi kyawun katuna biyar ne kawai ake ƙirgawa. Da pair biyu a hannunka da pair na uku a tebur, kana da Two Pair, ba uku ba.",
  ...
  ky: {
    ...
    desc: "Texas Hold’em'дин он покер комбинациясы роял-флештен жогорку картага чейинки тартипте, мисалдар, ар биринин ыктымалдыгы жана теңдик кантип чечилери менен.",
    ldHeadline: "Покер комбинациялары — Texas Hold’em",
    ldDesc: "Texas Hold’em'дин он комбинациясы тартиби менен, мисалдар, жыштык жана теңдик эрежелери менен.",
    h1: "Покер комбинациялары",
    lead: "Texas Hold’em'де комбинациялар эң күчтүүдөн эң алсызга карай мындай тизилет. Комбинация дайыма так беш карта, сиз көргөн жетөөнөн тандалат: эки жеке картаңыз жана үстөлдөгү беш жалпы карта.",
    names: ["Роял-флеш", "Стрит-флеш", "Каре", "Фулл-хаус", "Флеш", "Стрит", "Үчтүк", "Эки жуп", "Жуп", "Жогорку карта"],
    texts: [
      "A K Q J 10, баары бир масть. Мүмкүн болгон эң мыкты комбинация; аны жеңүүгө болбойт, ага теңелүүгө гана болот.",
      "Удаама беш карта, баары бир масть. Эки стрит-флештин ичинен эң жогорку картасы жогору тургансы утат.",
      "Бирдей мааниде төрт карта. Бешинчи карта (кикер) үстөлдөгү бирдей эки каренин ортосундагы сейрек теңдикти чечет.",
      "Үчтүк плюс жуп. Адегенде үч карталык бөлүгү салыштырылат, андан кийин жуп.",
      "Бир масттагы беш карта, удаама эмес. Алар жогорудан баштап карта-карта менен салыштырылат; бир да масть башкасынан жогору эмес.",
      "Удаама беш карта, ар кандай масть. Туз жогорку (10-J-Q-K-A) же төмөнкү (A-2-3-4-5) болуп ойнойт, бир эле учурда экөө тең эмес.",
      "Бирдей мааниде үч карта жана байланышы жок эки карта.",
      "Эки башка жуп жана бешинчи карта. Адегенде жогорку жуп, андан кийин төмөнкү жуп, андан кийин кикер салыштырылат.",
      "Бирдей мааниде эки карта жана тартиби менен салыштырылган байланышы жок үч карта.",
      "Жогорудагылардын бири да жок. Эң жогорку карта чечет, андан кийин кийинкиси жана ушул сыяктуу.",
    ],
    dealt: "жети карталык колдордун %s-ында кездешет",
    tiesH2: "Теңдик кантип чечилет",
    tiesP: "Адегенде категория салыштырылат: ар кандай флеш ар кандай стритти жеңет, карталар кандай болбосун. Категория бирдей болсо, маанилер жогорудан баштап бирден салыштырылат. Комбинациядан кийин калганы <em>кикер</em> деп аталат жана ал жаңы баштагандар күткөндөн көп колдорду чечет: A♠ K♦ жана A♣ 7♥ экөө тең A-9-4 үстөлүндө туздар жубун түзөт, бирок кикер боюнча король жетини жеңет. Hold’em'де масттар эч качан эч нерсени чечпейт — беш мааниси бирдей эки оюнчу банкты акыркы чипке чейин бөлүшөт.",
    wrongH2: "Кеңири тараган жаңылыштыктар",
    wrong: [
      "Туз стритте эң жогорку да, эң төмөнкү да карта: A-K-Q-J-10 эң мыкты, ал эми A-2-3-4-5 (<em>дөңгөлөк</em>) эң алсыз. Катар айланбайт — Q-K-A-2-3 эч нерсе эмес.",
      "Флеш — бир масттагы беш карта, төрт эмес. Колуңуз менен үстөлдүн ортосундагы төрт чырга өз алдынча эч нерсе эмес.",
      "Жеке жуп менен үстөлдөгү картадан түзүлгөн үчтүк <em>сет</em> деп аталат; колуңуздагы бир карта менен үстөлдөгү жуптан — <em>трипс</em>. Даражасы бирдей, бирок күчү такыр башка, анткени трипсти баары көрөт.",
      "Эң мыкты беш карта гана эсептелет. Колуңузда эки жуп жана үстөлдө үчүнчү жуп болсо, сизде эки жуп бар, үч эмес.",
