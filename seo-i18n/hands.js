...
,
  ...
  cy: {
    ...
    desc: "Deg llaw pocer Texas Hold’em mewn trefn o'r fflysh brenhinol i'r cerdyn uchel, gydag enghreifftiau, tebygolrwydd pob un a sut mae canlyniadau cyfartal yn cael eu datrys.",
    ldHeadline: "Dwylo pocer — Texas Hold’em",
    ldDesc: "Deg llaw Texas Hold’em yn eu trefn, gydag enghreifftiau, amlder a rheolau ar gyfer canlyniadau cyfartal.",
    h1: "Dwylo pocer",
    lead: "Yn Texas Hold’em mae'r dwylo'n cael eu trefnu o'r cryfaf i'r gwannaf fel a ganlyn. Mae llaw bob amser yn union bum cerdyn, wedi'u dewis o'r saith rydych chi'n eu gweld: eich dau gerdyn preifat a'r pum cerdyn cymunedol ar y bwrdd.",
    names: [
      "Fflysh brenhinol",
      "Fflysh syth",
      "Pedwar o’r un fath",
    ...
    texts: [
      "A K Q J 10, i gyd o'r un siwt. Y llaw orau bosibl; ni ellir ei churo, dim ond ei chyfateb.",
      "Pum cerdyn yn olynol, i gyd o'r un siwt. Rhwng dau fflysh syth, yr un â'r cerdyn uchaf uwch sy'n ennill.",
      "Pedwar cerdyn o'r un gwerth. Mae'r pumed cerdyn (y kicker) yn datrys y canlyniad cyfartal prin rhwng dau bedwar o’r un fath union yr un fath ar y bwrdd.",
      "Tri o’r un fath ynghyd â phâr. Mae'r rhan dri cherdyn yn cael ei chymharu gyntaf, yna'r pâr.",
      "Pum cerdyn o'r un siwt, nid yn olynol. Maen nhw'n cael eu cymharu fesul cerdyn o'r brig; does dim siwt yn uwch nag un arall.",
      "Pum cerdyn yn olynol, siwtiau cymysg. Mae'r As yn chwarae'n uchel (10-J-Q-K-A) neu'n isel (A-2-3-4-5), byth y ddau ar unwaith.",
      "Tri cherdyn o'r un gwerth, ynghyd â dau gerdyn digyswllt.",
      "Dau bâr gwahanol ynghyd â phumed cerdyn. Mae'r pâr uchaf yn cael ei gymharu gyntaf, yna'r pâr isaf, yna'r kicker.",
      "Dau gerdyn o'r un gwerth ynghyd â thri cherdyn digyswllt, wedi'u cymharu yn eu trefn.",
      "Dim un o'r uchod. Y cerdyn uchaf sy'n penderfynu, yna'r nesaf, ac yn y blaen.",
    ],
    dealt: "yn ymddangos mewn %s o ddwylo saith cerdyn",
    tiesH2: "Sut mae canlyniadau cyfartal yn cael eu datrys",
    tiesP: "Mae'r categori'n cael ei gymharu gyntaf: mae unrhyw fflysh yn curo unrhyw syth, beth bynnag yw'r cardiau. Os yr un categori, mae'r cymharu'n mynd fesul gwerth o'r brig. Yr enw ar yr hyn sy'n weddill ar ôl y cyfuniad yw'r <em>kicker</em>, ac mae'n penderfynu llawer mwy o ddwylo nag y mae dechreuwyr yn ei ddisgwyl: mae A♠ K♦ ac A♣ 7♥ ill dau'n gwneud pâr o Asau ar fwrdd A-9-4, ond mae'r Brenin yn curo'r saith ar y kicker. Nid yw siwtiau byth yn penderfynu dim yn Hold’em — mae dau chwaraewr gyda'r un pum gwerth yn rhannu'r pot hyd at y sglodyn olaf.",
    wrongH2: "Camsyniadau cyffredin",
    wrong: [
      "Yr As yw'r cerdyn uchaf a'r isaf mewn syth: A-K-Q-J-10 yw'r gorau, A-2-3-4-5 (yr <em>olwyn</em>) yw'r gwannaf. Nid yw'r dilyniant yn troi'n ôl — nid yw Q-K-A-2-3 yn ddim.",
      "Pum cerdyn o'r un siwt yw fflysh, nid pedwar. Nid yw pedair calon rhwng eich llaw a'r bwrdd yn werth dim ar eu pen eu hunain.",
      "Yr enw ar dri o’r un fath o bâr poced ynghyd â cherdyn ar y bwrdd yw <em>set</em>; o un cerdyn yn eich llaw ynghyd â phâr ar y bwrdd, <em>trips</em>. Yr un safle, cryfder gwahanol iawn, oherwydd bod pawb yn gallu gweld trips.",
      "Dim ond y pum cerdyn gorau sy'n cyfrif. Gyda dau bâr yn eich llaw a thrydydd pâr ar y bwrdd, mae gennych ddau bâr, nid tri.",
